...
class ExceptionCode
{
    ...
    public const RECURRING_ORDER_FAILED_TO_FIND_RECURRING_ORDER = 3005;
    public const RECURRING_ORDER_FAILED_TO_FIND_CART = 3006;
    public const RECURRING_ORDER_FAILED_TO_DUPLICATE_CART = 3007;
    public const RECURRING_ORDER_FAILED_TO_FIND_RECURRING_ORDER_PRODUCT = 3008;
    ...
    public const RECURRING_ORDER_FAILED_TO_FIND_CUSTOMER = 3012;
    public const RECURRING_ORDER_FAILED_TO_FIND_PRODUCT = 3013;
    public const RECURRING_ORDER_FAILED_TO_FIND_CURRENCY = 3014;
