...
export function PaymentMethodSettings({ method, onUpdateSettings }: PaymentMethodSettingsProps) {
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm">Enable payment method</p>
              </div>
            </div>
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(mollieComponents) => onUpdateSettings({ mollieComponents })}
                    className="w-10" // Made toggle switch wider
                  />
                </div>
                <p className="text-sm">Enable Mollie Components</p>
              </div>
            </div>
          </div>
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(oneClickPayments) => onUpdateSettings({ oneClickPayments })}
                  />
                </div>
                <p className="text-sm">Use one-click payments</p>
              </div>
            </div>
          </div>
        </div>
