...
export function PaymentMethodSettings({ method, countries, carriers, customerGroups, languages, onUpdateSettings, onSaveSettings, isSaving = false }: PaymentMethodSettingsProps) {
