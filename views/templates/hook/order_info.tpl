    ...
    window.MollieModule.app.default.transactionInfo().then(function (fn) {
      fn.default(
              ...
              },
              {
                ...
                reviewRefundProducts: '{l s='Please review the products included in your refund. You can remove items or change quantity if needed.' mod='mollie' js=1}',
                reviewCancel: '{l s='Review cancellation' mod='mollie' js=1}',
                reviewCancelProducts: '{l s='Please review the products included in your cancellation. You can remove items or change quantity if needed.' mod='mollie' js=1}',
