{block name='page_content'}
  <div id="mollie-qr-code" style="width: 100%; height: 280px; align-content: center; text-align: center">
    ...
    <div id="mollie-qr-image-container" style="text-align: center">
      ...
      <img id="mollie-qr-image" width="320" height="320"
           style="height: 240px; width: 240px; margin: 0 auto; visibility: hidden">
    </div>
  </div>
{/block}
  ...
  (function () {
    function pollStatus(idTransaction) {
      setTimeout(function () {
        ...
        {*request.open('GET', '{$link->getModuleLink('mollie', 'qrcode17', ['ajax' => '1', 'action' => 'qrCodeStatus'], Tools::usingSecureMode())|escape:'javscript':'UTF-8'}' + '&transaction_id=' + idTransaction, true);*}
        {*request.open('GET', '{url entity='module' name='mollie' controller='qrcode17' params = ['ajax' => '1', 'action' => 'qrCodeStatus']}' + '&transaction_id=' + idTransaction);*}
        request.open('GET', linkQrCodeStatus + '&transaction_id=' + idTransaction, true)
    ...
    function initQrImage() {
      ...
      var request = new XMLHttpRequest();
      {*request.open('GET', '{$link->getModuleLink('mollie', 'qrcode17', ['ajax' => '1', 'action' => 'qrCodeNew'])|escape:'javascript':'UTF-8'}', true);*}
      {*request.open('GET', '{url entity='module' name='mollie' controller='qrcode17' params = ['ajax' => '1', 'action' => 'qrCodeNew']}', true);*}
      request.open('GET', linkQrCodeNew, true);
