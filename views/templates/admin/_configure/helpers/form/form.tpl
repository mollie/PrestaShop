                            ...
                            <div class="col-lg-8">
                                {foreach from=$languages item=language}
                                    {if $languages|count > 1}
                                        ...
                                        <div class="col-lg-4">
                                    {/if}
                                    <input type="text" name="MOLLIE_METHOD_TITLE_{$paymentMethod.id|escape:'html':'UTF-8'}[{$language.id_lang}]" value="{$methodObj->title[$language.id_lang]|default:$paymentMethod.name|escape:'html':'UTF-8'}">
                                    {if $languages|count > 1}
                                        </div>
                                        <div class="col-lg-2">
