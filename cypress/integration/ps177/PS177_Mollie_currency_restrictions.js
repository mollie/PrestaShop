...
it.only('DE / 100 EUR / 3 Klarna Payments should be visible', () => {
      ...
      cy.visit('https://mollie1770test.invertusdemo.com/fr/home/20-test1.html')
      cy.get('[class="material-icons"]').click()
      cy.get('[type="email"]').first().type((Cypress.env('FO_username')), {log: false})
      cy.get('[type="password"]').first().type((Cypress.env('FO_password')), {log: false})
      cy.get('#submit-login').click()
      cy.visit('https://mollie1770test.invertusdemo.com/fr/home/20-test1.html')
      cy.get('.add > .btn > .material-icons').click()
