...
it('DE / 100 EUR / 3 Klarna Payments should be visible', () => {
      ...
      cy.session (LoginFO, () => {
      cy.visit('http://172.17.0.1:8001/en/men/1-1-hummingbird-printed-t-shirt.html#/1-size-s/8-color-white')
...
it('DE / <45 EUR / Klarna Slice It. should not be visible', () => {
      ...
      fasterLogin('LoginFO')
      cy.visit('http://172.17.0.1:8001/en/art/3-13-the-best-is-yet-to-come-framed-poster.html#/19-dimension-40x60cm')
      cy.get('.add > .btn').click()
      cy.get('.cart-content-btn > .btn-primary').click()
      cy.get('.text-sm-center > .btn').click()
      cy.contains('Germany').click()
...
it('DE / >10000 EUR / Klarna Slice It, Klarna Pay Later, iDEAL, Bancontact, Belfius Direct Net, KBC/CBC, Credit card, SOFORT Banking, SOFORT Banking, sps, paysafecard, Przelewy 24, Gift cards should not be visible', () => {
      ...
      fasterLogin('LoginFO')
      cy.visit('http://172.17.0.1:8001/en/women/2-9-brown-bear-printed-sweater.html#/1-size-s')
...
it('FR / <35 EUR / Klarna Pay Later should not be visible', () => {
      ...
      fasterLogin('LoginFO')
      cy.visit('http://172.17.0.1:8001/en/home-accessories/6-mug-the-best-is-yet-to-come.html')
      cy.get('.add > .btn').click()
      cy.get('.cart-content-btn > .btn-primary').click()
      cy.get('.text-sm-center > .btn').click()
