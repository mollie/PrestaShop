...
it.only('04 Checking the Advanced Settings tab, verifying the front-end', () => {
      ...
      cy.get('[name="MOLLIE_MAIL_WHEN_PAID"]').should('be.visible')
      cy.get('[name="MOLLIE_MAIL_WHEN_COMPLETED"]').should('be.visible')
      cy.get('[name="MOLLIE_STATUS_COMPLETED"]').should('be.visible')
      cy.get('[name="MOLLIE_MAIL_WHEN_CANCELED""]').should('be.visible')
      cy.get('[name="MOLLIE_STATUS_CANCELED"]').should('be.visible')
      cy.get('[name="MOLLIE_MAIL_WHEN_EXPIRED"]').should('be.visible')
      cy.get('[name="MOLLIE_STATUS_EXPIRED"]').should('be.visible')
      cy.get('[name="MOLLIE_MAIL_WHEN_REFUNDED"]').should('be.visible')
      cy.get('[name="MOLLIE_STATUS_REFUNDED"]').should('be.visible')
      cy.get('[name="MOLLIE_STATUS_OPEN"]').should('be.visible')
      cy.get('[name="MOLLIE_MAIL_WHEN_SHIPPING"]').should('be.visible')
      cy.get('[name="MOLLIE_STATUS_SHIPPING"]').should('be.visible')
      cy.get('[name="MOLLIE_STATUS_PARTIAL_REFUND"]').should('be.visible')
      cy.get('[name="MOLLIE_IMAGES"]').should('be.visible')
      cy.get('[name="MOLLIE_CSS"]').should('be.visible')
      cy.get('[id="MOLLIE_TRACKING_URLS__container"]').should('be.visible')
      cy.get('[id="MOLLIE_AS_MAIN_info"]').should('be.visible')
      cy.get('[id="MOLLIE_AS_STATUSES_info"]').should('be.visible')
      cy.get('[name="MOLLIE_DISPLAY_ERRORS"]').should('be.visible')
      cy.get('[name="MOLLIE_DEBUG_LOG"]').should('be.visible')
