...
run-ps-for-tests:
	...
	docker exec -it some-prestashop-1.7.8-7.4 sh -c "cd /var/www/html/modules/mollie && php vendor/bin/phpunit -c tests/phpunit.xml --debug --verbose --no-output-buffering"
