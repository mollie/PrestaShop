...
class MollieQrcodeModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        /*$linkQrCodeNew = $this->context->link->getModuleLink('mollie', 'qrcode17', ['ajax' => '1', 'action' => 'qrCodeNew']);
        $linkQrCodeStatus = $this->context->link->getModuleLink('mollie', 'qrcode17', ['ajax' => '1', 'action' => 'qrCodeStatus'], Tools::usingSecureMode());

        $this->context->smarty->assign(
            array(
                'linkQrCodeNew' => $linkQrCodeNew,
                'linkQrCodeStatus' => $linkQrCodeStatus,
            )
        );*/

        $linkQrCodeNewlink = new Link;
        $linkQrCodeNewparameters = array('ajax' => '1', 'action' => 'qrCodeNew');
        $linkQrCodeNew = $linkQrCodeNewlink->getModuleLink('mollie', 'qrcode17', $linkQrCodeNewparameters);

        $linkQrCodeStatuslink = new Link;
        $linkQrCodeStatusparameters = array('ajax' => '1', 'action' => 'qrCodeStatus');
        $linkQrCodeStatus = $linkQrCodeStatuslink->getModuleLink('mollie', 'qrcode17', $linkQrCodeStatusparameters);
