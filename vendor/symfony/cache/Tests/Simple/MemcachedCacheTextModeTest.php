...
class MemcachedCacheTextModeTest extends \_PhpScoper5eddef0da618a\Symfony\Component\Cache\Tests\Simple\MemcachedCacheTest
{
    public function createSimpleCache($defaultLifetime = 0)
    {
        $client = \_PhpScoper5eddef0da618a\Symfony\Component\Cache\Adapter\AbstractAdapter::createConnection('memcached://' . \getenv('MEMCACHED_HOST'), ['binary_protocol' => \false]);
