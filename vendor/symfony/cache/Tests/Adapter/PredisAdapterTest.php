...
class PredisAdapterTest extends \_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Tests\Adapter\AbstractRedisAdapterTest
{
    ...
    public function testCreateConnection()
    {
        ...
        $redis = \_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\RedisAdapter::createConnection('redis://' . $redisHost . '/1', ['class' => \_PhpScoper5ea00cc67502b\Predis\Client::class, 'timeout' => 3]);
        $this->assertInstanceOf(\_PhpScoper5ea00cc67502b\Predis\Client::class, $redis);
        $connection = $redis->getConnection();
        $this->assertInstanceOf(\_PhpScoper5ea00cc67502b\Predis\Connection\StreamConnection::class, $connection);
