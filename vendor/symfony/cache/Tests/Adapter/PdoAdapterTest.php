 ...
 */
class PdoAdapterTest extends \MolliePrefix\Symfony\Component\Cache\Tests\Adapter\AdapterTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        $pool = new \MolliePrefix\Symfony\Component\Cache\Adapter\PdoAdapter('sqlite:' . self::$dbFile);
        $pool->createTable();
    }
    ...
    {
        return new \MolliePrefix\Symfony\Component\Cache\Adapter\PdoAdapter('sqlite:' . self::$dbFile, 'ns', $defaultLifetime);
    }
