 ...
 */
class PdoAdapterTest extends \_PhpScoper5ece82d7231e4\Symfony\Component\Cache\Tests\Adapter\AdapterTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        $pool = new \_PhpScoper5ece82d7231e4\Symfony\Component\Cache\Adapter\PdoAdapter('sqlite:' . self::$dbFile);
        $pool->createTable();
    }
    ...
    {
        return new \_PhpScoper5ece82d7231e4\Symfony\Component\Cache\Adapter\PdoAdapter('sqlite:' . self::$dbFile, 'ns', $defaultLifetime);
    }
