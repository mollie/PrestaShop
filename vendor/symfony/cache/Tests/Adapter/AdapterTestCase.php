...
use _PhpScoper5eddef0da618a\Cache\IntegrationTests\CachePoolTest;
...
abstract class AdapterTestCase extends \_PhpScoper5eddef0da618a\Cache\IntegrationTests\CachePoolTest
{
    protected function setUp()
    {
        ...
        if (!\array_key_exists('testPrune', $this->skippedTests) && !$this->createCachePool() instanceof \_PhpScoper5eddef0da618a\Symfony\Component\Cache\PruneableInterface) {
    ...
    public function testNotUnserializable()
    {
        ...
        $cache->save($item->set(new \_PhpScoper5eddef0da618a\Symfony\Component\Cache\Tests\Adapter\NotUnserializable()));
        $item = $cache->getItem('foo');
        $this->assertFalse($item->isHit());
