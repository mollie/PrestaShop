...
use _PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\MemcachedAdapter;
class MemcachedAdapterTest extends \_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Tests\Adapter\AdapterTestCase
{
    ...
    {
        if (!\_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\MemcachedAdapter::isSupported()) {
            self::markTestSkipped('Extension memcached >=2.2.0 required.');
        }
        self::$client = \_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\AbstractAdapter::createConnection('memcached://' . \getenv('MEMCACHED_HOST'), ['binary_protocol' => \false]);
        self::$client->get('foo');
    ...
    {
        $client = $defaultLifetime ? \_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\AbstractAdapter::createConnection('memcached://' . \getenv('MEMCACHED_HOST')) : self::$client;
        return new \_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\MemcachedAdapter($client, \str_replace('\\', '.', __CLASS__), $defaultLifetime);
    }
    public function testOptions()
    {
        $client = \_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\MemcachedAdapter::createConnection([], ['libketama_compatible' => \false, 'distribution' => 'modula', 'compression' => \true, 'serializer' => 'php', 'hash' => 'md5']);
    ...
    public function testBadOptions($name, $value)
    {
        ...
        \_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\MemcachedAdapter::createConnection([], [$name => $value]);
    }
    ...
    {
        $this->assertTrue(\_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\MemcachedAdapter::isSupported());
        $client = \_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\MemcachedAdapter::createConnection([]);
        $this->assertTrue($client->getOption(\_PhpScoper5ea00cc67502b\Memcached::OPT_COMPRESSION));
        $this->assertSame(1, $client->getOption(\_PhpScoper5ea00cc67502b\Memcached::OPT_BINARY_PROTOCOL));
        $this->assertSame(1, $client->getOption(\_PhpScoper5ea00cc67502b\Memcached::OPT_TCP_NODELAY));
    ...
    public function testOptionSerializer()
    {
        ...
        new \_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\MemcachedAdapter(\_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\MemcachedAdapter::createConnection([], ['serializer' => 'json']));
    }
    /**
    ...
    {
        $client1 = \_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\MemcachedAdapter::createConnection($dsn);
        $client2 = \_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\MemcachedAdapter::createConnection([$dsn]);
        $client3 = \_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\MemcachedAdapter::createConnection([[$host, $port]]);
    ...
    {
        $client = \_PhpScoper5ea00cc67502b\Symfony\Component\Cache\Adapter\MemcachedAdapter::createConnection($dsn, $options);
    ...
    {
        if (!\class_exists('_PhpScoper5ea00cc67502b\\Memcached')) {
            self::markTestSkipped('Extension memcached required.');
        }
        (yield ['memcached://localhost:11222?retry_timeout=10', [\_PhpScoper5ea00cc67502b\Memcached::OPT_RETRY_TIMEOUT => 8], [\_PhpScoper5ea00cc67502b\Memcached::OPT_RETRY_TIMEOUT => 10]]);
        (yield ['memcached://localhost:11222?socket_recv_size=1&socket_send_size=2', [\_PhpScoper5ea00cc67502b\Memcached::OPT_RETRY_TIMEOUT => 8], [\_PhpScoper5ea00cc67502b\Memcached::OPT_SOCKET_RECV_SIZE => 1, \_PhpScoper5ea00cc67502b\Memcached::OPT_SOCKET_SEND_SIZE => 2, \_PhpScoper5ea00cc67502b\Memcached::OPT_RETRY_TIMEOUT => 8]]);
    }
