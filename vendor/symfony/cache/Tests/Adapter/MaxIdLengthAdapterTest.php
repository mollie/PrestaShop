...
class MaxIdLengthAdapterTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    public function testLongKey()
    {
        $cache = $this->getMockBuilder(\_PhpScoper5ece82d7231e4\Symfony\Component\Cache\Tests\Adapter\MaxIdLengthAdapter::class)->setConstructorArgs([\str_repeat('-', 10)])->setMethods(['doHave', 'doFetch', 'doDelete', 'doSave', 'doClear'])->getMock();
    ...
    {
        $cache = $this->getMockBuilder(\_PhpScoper5ece82d7231e4\Symfony\Component\Cache\Tests\Adapter\MaxIdLengthAdapter::class)->setConstructorArgs([\str_repeat('-', 26)])->getMock();
        $cache->method('doFetch')->willReturn(['2:']);
        $reflectionClass = new \ReflectionClass(\_PhpScoper5ece82d7231e4\Symfony\Component\Cache\Adapter\AbstractAdapter::class);
    ...
    public function testTooLongNamespace()
    {
        ...
        $this->getMockBuilder(\_PhpScoper5ece82d7231e4\Symfony\Component\Cache\Tests\Adapter\MaxIdLengthAdapter::class)->setConstructorArgs([\str_repeat('-', 40)])->getMock();
    }
}
abstract class MaxIdLengthAdapter extends \_PhpScoper5ece82d7231e4\Symfony\Component\Cache\Adapter\AbstractAdapter
{
