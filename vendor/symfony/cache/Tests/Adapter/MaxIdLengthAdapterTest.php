...
class MaxIdLengthAdapterTest extends TestCase
{
    ...
    {
        $cache = $this->getMockBuilder(MaxIdLengthAdapter::class)->setConstructorArgs([str_repeat('-', 10)])->setMethods(['doHave', 'doFetch', 'doDelete', 'doSave', 'doClear'])->getMock();
    ...
    {
        $cache = $this->getMockBuilder(MaxIdLengthAdapter::class)->setConstructorArgs([str_repeat('-', 26)])->getMock();
    ...
    public function testTooLongNamespace()
    {
        ...
        $this->getMockBuilder(MaxIdLengthAdapter::class)->setConstructorArgs([str_repeat('-', 40)])->getMock();
    }
}
