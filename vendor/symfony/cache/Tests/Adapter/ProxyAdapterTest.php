 ...
 */
class ProxyAdapterTest extends \_PhpScoper5eddef0da618a\Symfony\Component\Cache\Tests\Adapter\AdapterTestCase
{
    ...
    {
        return new \_PhpScoper5eddef0da618a\Symfony\Component\Cache\Adapter\ProxyAdapter(new \_PhpScoper5eddef0da618a\Symfony\Component\Cache\Adapter\ArrayAdapter(), '', $defaultLifetime);
    }
    public function testProxyfiedItem()
    {
        ...
        $pool = new \_PhpScoper5eddef0da618a\Symfony\Component\Cache\Adapter\ProxyAdapter(new \_PhpScoper5eddef0da618a\Symfony\Component\Cache\Tests\Adapter\TestingArrayAdapter($item));
        $proxyItem = $pool->getItem('foo');
        $this->assertNotSame($item, $proxyItem);
        $pool->save($proxyItem->set('bar'));
    }
}
class TestingArrayAdapter extends \_PhpScoper5eddef0da618a\Symfony\Component\Cache\Adapter\ArrayAdapter
{
    private $item;
    public function __construct(\_PhpScoper5eddef0da618a\Psr\Cache\CacheItemInterface $item)
    {
        $this->item = $item;
    }
