 ...
 */
class ArrayCache implements \_PhpScoper5ece82d7231e4\Psr\SimpleCache\CacheInterface, \_PhpScoper5ece82d7231e4\Psr\Log\LoggerAwareInterface, \_PhpScoper5ece82d7231e4\Symfony\Component\Cache\ResettableInterface
{
    use ArrayTrait {
    ...
    public function setMultiple($values, $ttl = null)
    {
        ...
        foreach ($values as $key => $value) {
            \is_int($key) || \_PhpScoper5ece82d7231e4\Symfony\Component\Cache\CacheItem::validateKey($key);
