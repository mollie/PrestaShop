 ...
 */
class PhpArrayCache implements \MolliePrefix\Psr\SimpleCache\CacheInterface, \MolliePrefix\Symfony\Component\Cache\PruneableInterface, \MolliePrefix\Symfony\Component\Cache\ResettableInterface
{
    use PhpArrayTrait;
    /**
     ...
     */
    public function __construct($file, \MolliePrefix\Psr\SimpleCache\CacheInterface $fallbackPool)
    {
        $this->file = $file;
     ...
     */
    public static function create($file, \MolliePrefix\Psr\SimpleCache\CacheInterface $fallbackPool)
    {
