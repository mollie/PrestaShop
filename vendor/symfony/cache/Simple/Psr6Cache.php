...
use _PhpScoper5eddef0da618a\Psr\Cache\CacheException as Psr6CacheException;
use _PhpScoper5eddef0da618a\Psr\Cache\CacheItemPoolInterface;
use _PhpScoper5eddef0da618a\Psr\SimpleCache\CacheException as SimpleCacheException;
 ...
 */
class Psr6Cache implements \_PhpScoper5eddef0da618a\Psr\SimpleCache\CacheInterface, \_PhpScoper5eddef0da618a\Symfony\Component\Cache\PruneableInterface, \_PhpScoper5eddef0da618a\Symfony\Component\Cache\ResettableInterface
{
    use ProxyTrait;
    private $createCacheItem;
    private $cacheItemPrototype;
    public function __construct(\_PhpScoper5eddef0da618a\Psr\Cache\CacheItemPoolInterface $pool)
    {
        $this->pool = $pool;
        if (!$pool instanceof \_PhpScoper5eddef0da618a\Symfony\Component\Cache\Adapter\AdapterInterface) {
            return;
        }
        $cacheItemPrototype =& $this->cacheItemPrototype;
        $createCacheItem = \Closure::bind(static function ($key, $value, $allowInt = \false) use(&$cacheItemPrototype) {
            $item = clone $cacheItemPrototype;
            $item->key = $allowInt && \is_int($key) ? (string) $key : \_PhpScoper5eddef0da618a\Symfony\Component\Cache\CacheItem::validateKey($key);
            $item->value = $value;
            $item->isHit = \false;
            return $item;
    ...
    public function get($key, $default = null)
    {
        ...
        } catch (\_PhpScoper5eddef0da618a\Psr\SimpleCache\CacheException $e) {
            throw $e;
        } catch (\_PhpScoper5eddef0da618a\Psr\Cache\CacheException $e) {
            throw new \_PhpScoper5eddef0da618a\Symfony\Component\Cache\Exception\InvalidArgumentException($e->getMessage(), $e->getCode(), $e);
        }
        if (null === $this->cacheItemPrototype) {
