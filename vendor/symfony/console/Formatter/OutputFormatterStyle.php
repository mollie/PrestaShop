 ...
 */
class OutputFormatterStyle implements \MolliePrefix\Symfony\Component\Console\Formatter\OutputFormatterStyleInterface
{
    ...
    public function setForeground($color = null)
    {
        ...
        if (!isset(static::$availableForegroundColors[$color])) {
            throw new \MolliePrefix\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('Invalid foreground color specified: "%s". Expected one of (%s).', $color, \implode(', ', \array_keys(static::$availableForegroundColors))));
        }
    ...
    public function setBackground($color = null)
    {
        ...
        if (!isset(static::$availableBackgroundColors[$color])) {
            throw new \MolliePrefix\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('Invalid background color specified: "%s". Expected one of (%s).', $color, \implode(', ', \array_keys(static::$availableBackgroundColors))));
        }
    ...
    public function setOption($option)
    {
        if (!isset(static::$availableOptions[$option])) {
            throw new \MolliePrefix\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('Invalid option specified: "%s". Expected one of (%s).', $option, \implode(', ', \array_keys(static::$availableOptions))));
        }
