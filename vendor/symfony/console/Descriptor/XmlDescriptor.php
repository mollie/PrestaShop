 ...
 * @internal
 */
class XmlDescriptor extends \MolliePrefix\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * @return \DOMDocument
     */
    public function getInputDefinitionDocument(\MolliePrefix\Symfony\Component\Console\Input\InputDefinition $definition)
    {
     ...
     * @return \DOMDocument
     */
    public function getCommandDocument(\MolliePrefix\Symfony\Component\Console\Command\Command $command)
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
     ...
     * @return \DOMDocument
     */
    public function getApplicationDocument(\MolliePrefix\Symfony\Component\Console\Application $application, $namespace = null)
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
        ...
        $description = new \MolliePrefix\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
     ...
     * @return \DOMDocument
     */
    private function getInputArgumentDocument(\MolliePrefix\Symfony\Component\Console\Input\InputArgument $argument)
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
     ...
     * @return \DOMDocument
     */
    private function getInputOptionDocument(\MolliePrefix\Symfony\Component\Console\Input\InputOption $option)
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
