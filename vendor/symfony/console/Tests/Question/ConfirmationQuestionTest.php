...
class ConfirmationQuestionTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $sut = new \MolliePrefix\Symfony\Component\Console\Question\ConfirmationQuestion('A question', $default);
