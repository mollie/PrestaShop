...
class NullOutputTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    ...
    {
        $output = new \MolliePrefix\Symfony\Component\Console\Output\NullOutput();
        $this->assertSame(\MolliePrefix\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET, $output->getVerbosity(), '->getVerbosity() returns VERBOSITY_QUIET for NullOutput by default');
        $output->setVerbosity(\MolliePrefix\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_VERBOSE);
        $this->assertSame(\MolliePrefix\Symfony\Component\Console\Output\OutputInterface::VERBOSITY_QUIET, $output->getVerbosity(), '->getVerbosity() always returns VERBOSITY_QUIET for NullOutput');
    }
    ...
    public function testSetVerbosity()
    {
        ...
        $this->assertEquals(\MolliePrefix\Symfony\Component\Console\Output\Output::VERBOSITY_QUIET, $output->getVerbosity());
    }
