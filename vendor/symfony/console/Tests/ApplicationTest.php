 ...
 */
namespace MolliePrefix\Symfony\Component\Console\Tests;
...
use MolliePrefix\Symfony\Component\Console\Event\ConsoleCommandEvent;
use MolliePrefix\Symfony\Component\Console\Event\ConsoleErrorEvent;
use MolliePrefix\Symfony\Component\Console\Event\ConsoleExceptionEvent;
...
use MolliePrefix\Symfony\Component\Console\Tester\ApplicationTester;
use MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder;
use MolliePrefix\Symfony\Component\EventDispatcher\EventDispatcher;
class ApplicationTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
     ...
     */
    protected function ensureStaticCommandHelp(\MolliePrefix\Symfony\Component\Console\Application $application)
    {
    ...
    {
        $application = new \MolliePrefix\Symfony\Component\Console\Application('foo', 'bar');
    ...
    public function testAll()
    {
        ...
        $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Console\\Command\\HelpCommand', $commands['help'], '->all() returns the registered commands');
    ...
    public function testAllWithCommandLoader()
    {
        ...
        $commands = $application->all('foo');
        $this->assertCount(1, $commands, '->all() takes a namespace as its first argument');
        $application->setCommandLoader(new \MolliePrefix\Symfony\Component\Console\CommandLoader\FactoryCommandLoader(['foo:bar1' => function () {
            return new \MolliePrefix\Foo1Command();
        }]));
        $commands = $application->all('foo');
        $this->assertCount(2, $commands, '->all() takes a namespace as its first argument');
        $this->assertInstanceOf(\MolliePrefix\FooCommand::class, $commands['foo:bar'], '->all() returns the registered commands');
        $this->assertInstanceOf(\MolliePrefix\Foo1Command::class, $commands['foo:bar1'], '->all() returns the registered commands');
    }
    ...
    {
        $code = function (\MolliePrefix\Symfony\Component\Console\Input\InputInterface $input, \MolliePrefix\Symfony\Component\Console\Output\OutputInterface $output) {
            $output->writeln('It works!');
        };
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->setAutoExit(\false);
        $application->register('test-foo')->setAliases(['test'])->setCode($code);
        $application->register('test-bar')->setCode($code);
        $tester = new \MolliePrefix\Symfony\Component\Console\Tester\ApplicationTester($application);
        $tester->run(['test']);
        $this->assertStringContainsString('It works!', $tester->getDisplay(\true));
    }
    public function testAdd()
    {
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->add($foo = new \MolliePrefix\FooCommand());
        $commands = $application->all();
        $this->assertEquals($foo, $commands['foo:bar'], '->add() registers a command');
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->addCommands([$foo = new \MolliePrefix\FooCommand(), $foo1 = new \MolliePrefix\Foo1Command()]);
        $commands = $application->all();
    ...
    public function testAddCommandWithEmptyConstructor()
    {
        ...
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->add(new \MolliePrefix\Foo5Command());
    }
    public function testHasGet()
    {
        ...
        $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Console\\Command\\HelpCommand', $command, '->get() returns the help command if --help is provided as the input');
    }
    public function testHasGetWithCommandLoader()
    {
        ...
        $this->assertInstanceOf(\MolliePrefix\Foo1Command::class, $foo1 = $application->get('foo:bar1'), '->get() returns a command by name from the command loader');
    ...
    public function testGetNamespaces()
    {
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->add(new \MolliePrefix\FooCommand());
        $application->add(new \MolliePrefix\Foo1Command());
    ...
    public function testFindNamespace()
    {
        ...
        $application->add(new \MolliePrefix\Foo2Command());
        $this->assertEquals('foo', $application->findNamespace('foo'), '->findNamespace() returns the given namespace if it exists');
    }
    public function testFindNamespaceWithSubnamespaces()
    {
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->add(new \MolliePrefix\FooSubnamespaced1Command());
        $application->add(new \MolliePrefix\FooSubnamespaced2Command());
    ...
    {
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->add(new \MolliePrefix\BarBucCommand());
        $application->add(new \MolliePrefix\FooCommand());
        $application->add(new \MolliePrefix\Foo2Command());
        $expectedMsg = "The namespace \"f\" is ambiguous.\nDid you mean one of these?\n    foo\n    foo1";
        $this->expectException(\MolliePrefix\Symfony\Component\Console\Exception\CommandNotFoundException::class);
    ...
    {
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->add(new \MolliePrefix\TestAmbiguousCommandRegistering());
        $application->add(new \MolliePrefix\TestAmbiguousCommandRegistering2());
    ...
    public function testFind()
    {
        ...
        $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Console\\Command\\HelpCommand', $application->find('h'), '->find() returns a command if its name exists');
    ...
    {
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->add(new \MolliePrefix\FooSameCaseUppercaseCommand());
        $application->add(new \MolliePrefix\FooSameCaseLowercaseCommand());
    ...
    {
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->setCommandLoader(new \MolliePrefix\Symfony\Component\Console\CommandLoader\FactoryCommandLoader(['foo:bar' => $f = function () {
            return new \MolliePrefix\FooCommand();
        }]));
        $this->assertInstanceOf('FooCommand', $application->find('foo:bar'), '->find() returns a command if its name exists');
        $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Console\\Command\\HelpCommand', $application->find('h'), '->find() returns a command if its name exists');
        $this->assertInstanceOf('FooCommand', $application->find('f:bar'), '->find() returns a command if the abbreviation for the namespace exists');
    ...
    {
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->add(new \MolliePrefix\Foo3Command());
        $application->add(new \MolliePrefix\Foo4Command());
    ...
    public function testFindCommandWithAmbiguousNamespacesButUniqueName()
    {
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->add(new \MolliePrefix\FooCommand());
        $application->add(new \MolliePrefix\FoobarCommand());
    ...
    public function testFindAlternativeExceptionMessageMultiple()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Console\\Exception\\CommandNotFoundException', $e, '->find() throws a CommandNotFoundException if command does not exist, with alternatives');
        ...
        try {
            ...
            $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Console\\Exception\\CommandNotFoundException', $e);
    ...
    public function testFindAlternativeCommands()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Console\\Exception\\CommandNotFoundException', $e, '->find() throws a CommandNotFoundException if command does not exist');
    ...
    {
        $fooCommand = new \MolliePrefix\FooCommand();
        $fooCommand->setAliases(['foo2']);
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->setCommandLoader(new \MolliePrefix\Symfony\Component\Console\CommandLoader\FactoryCommandLoader(['foo3' => static function () use($fooCommand) {
            return $fooCommand;
        }]));
    ...
    public function testFindAlternativeNamespace()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Console\\Exception\\CommandNotFoundException', $e, '->find() throws a CommandNotFoundException if namespace does not exist');
            $this->assertSame([], $e->getAlternatives());
    ...
    public function testFindAlternativesOutput()
    {
        ...
        $application->add(new \MolliePrefix\Foo2Command());
        $application->add(new \MolliePrefix\Foo3Command());
        $application->add(new \MolliePrefix\FooHiddenCommand());
        ...
        try {
            ...
            $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Console\\Exception\\CommandNotFoundException', $e, '->find() throws a CommandNotFoundException if command is not defined');
    ...
    {
        $application = $this->getMockBuilder('MolliePrefix\\Symfony\\Component\\Console\\Application')->setMethods(['getNamespaces'])->getMock();
        $application->expects($this->once())->method('getNamespaces')->willReturn(['foo:sublong', 'bar:sub']);
    ...
    public function testRenderException()
    {
        ...
        $tester->run(['command' => 'foo'], ['decorated' => \false, 'verbosity' => \MolliePrefix\Symfony\Component\Console\Output\Output::VERBOSITY_VERBOSE, 'capture_stderr_separately' => \true]);
        ...
        $tester->run(['command' => 'foo3:bar'], ['decorated' => \false, 'verbosity' => \MolliePrefix\Symfony\Component\Console\Output\Output::VERBOSITY_VERBOSE]);
    ...
    {
        $application = $this->getMockBuilder('MolliePrefix\\Symfony\\Component\\Console\\Application')->setMethods(['getTerminalWidth'])->getMock();
        $application->setAutoExit(\false);
        $application->expects($this->any())->method('getTerminalWidth')->willReturn(120);
        $application->register('foo')->setCode(function () {
    ...
    public function testRenderExceptionStackTraceContainsRootException()
    {
        ...
        $tester = new \MolliePrefix\Symfony\Component\Console\Tester\ApplicationTester($application);
        $tester->run(['command' => 'foo'], ['decorated' => \false, 'verbosity' => \MolliePrefix\Symfony\Component\Console\Output\Output::VERBOSITY_VERBOSE]);
    ...
    public function testRun()
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->add($command = new \MolliePrefix\Foo1Command());
        $_SERVER['argv'] = ['cli.php', 'foo:bar1'];
        \ob_start();
        $application->run();
        \ob_end_clean();
        $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Console\\Input\\ArgvInput', $command->input, '->run() creates an ArgvInput by default if none is given');
        $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Console\\Output\\ConsoleOutput', $command->output, '->run() creates a ConsoleOutput by default if none is given');
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        ...
        $this->assertSame(\MolliePrefix\Symfony\Component\Console\Output\Output::VERBOSITY_VERBOSE, $tester->getOutput()->getVerbosity(), '->run() sets the output to verbose if --verbose is passed');
        $tester->run(['command' => 'list', '--verbose' => 1]);
        $this->assertSame(\MolliePrefix\Symfony\Component\Console\Output\Output::VERBOSITY_VERBOSE, $tester->getOutput()->getVerbosity(), '->run() sets the output to verbose if --verbose=1 is passed');
        $tester->run(['command' => 'list', '--verbose' => 2]);
        $this->assertSame(\MolliePrefix\Symfony\Component\Console\Output\Output::VERBOSITY_VERY_VERBOSE, $tester->getOutput()->getVerbosity(), '->run() sets the output to very verbose if --verbose=2 is passed');
        $tester->run(['command' => 'list', '--verbose' => 3]);
        $this->assertSame(\MolliePrefix\Symfony\Component\Console\Output\Output::VERBOSITY_DEBUG, $tester->getOutput()->getVerbosity(), '->run() sets the output to debug if --verbose=3 is passed');
        $tester->run(['command' => 'list', '--verbose' => 4]);
        $this->assertSame(\MolliePrefix\Symfony\Component\Console\Output\Output::VERBOSITY_VERBOSE, $tester->getOutput()->getVerbosity(), '->run() sets the output to verbose if unknown --verbose level is passed');
        $tester->run(['command' => 'list', '-v' => \true]);
        $this->assertSame(\MolliePrefix\Symfony\Component\Console\Output\Output::VERBOSITY_VERBOSE, $tester->getOutput()->getVerbosity(), '->run() sets the output to verbose if -v is passed');
        $tester->run(['command' => 'list', '-vv' => \true]);
        $this->assertSame(\MolliePrefix\Symfony\Component\Console\Output\Output::VERBOSITY_VERY_VERBOSE, $tester->getOutput()->getVerbosity(), '->run() sets the output to verbose if -v is passed');
        $tester->run(['command' => 'list', '-vvv' => \true]);
        $this->assertSame(\MolliePrefix\Symfony\Component\Console\Output\Output::VERBOSITY_DEBUG, $tester->getOutput()->getVerbosity(), '->run() sets the output to verbose if -v is passed');
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->add(new \MolliePrefix\FooCommand());
    ...
    public function testRunWithGlobalOptionAndNoCommand()
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->getDefinition()->addOption(new \MolliePrefix\Symfony\Component\Console\Input\InputOption('foo', 'f', \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_OPTIONAL));
        $output = new \MolliePrefix\Symfony\Component\Console\Output\StreamOutput(\fopen('php://memory', 'w', \false));
    ...
    public function testVerboseValueNotBreakArguments()
    {
        ...
        $application->add(new \MolliePrefix\FooCommand());
        $output = new \MolliePrefix\Symfony\Component\Console\Output\StreamOutput(\fopen('php://memory', 'w', \false));
        $input = new \MolliePrefix\Symfony\Component\Console\Input\ArgvInput(['cli.php', '-v', 'foo:bar']);
        $application->run($input, $output);
        $this->addToAssertionCount(1);
        $input = new \MolliePrefix\Symfony\Component\Console\Input\ArgvInput(['cli.php', '--verbose', 'foo:bar']);
        $application->run($input, $output);
        $this->addToAssertionCount(1);
    }
    public function testRunReturnsIntegerExitCode()
    {
        ...
        $application = $this->getMockBuilder('MolliePrefix\\Symfony\\Component\\Console\\Application')->setMethods(['doRun'])->getMock();
        $application->setAutoExit(\false);
        $application->expects($this->once())->method('doRun')->willThrowException($exception);
        $exitCode = $application->run(new \MolliePrefix\Symfony\Component\Console\Input\ArrayInput([]), new \MolliePrefix\Symfony\Component\Console\Output\NullOutput());
    ...
    public function testRunDispatchesIntegerExitCode()
    {
        ...
        $dispatcher->addListener('console.terminate', function (\MolliePrefix\Symfony\Component\Console\Event\ConsoleTerminateEvent $event) use(&$passedRightValue) {
            $passedRightValue = 4 === $event->getExitCode();
        });
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->setDispatcher($dispatcher);
        $application->setAutoExit(\false);
        $application->register('test')->setCode(function (\MolliePrefix\Symfony\Component\Console\Input\InputInterface $input, \MolliePrefix\Symfony\Component\Console\Output\OutputInterface $output) {
    ...
    public function testAddingOptionWithDuplicateShortcut()
    {
        ...
        $application->setCatchExceptions(\false);
        $application->setDispatcher($dispatcher);
        $application->getDefinition()->addOption(new \MolliePrefix\Symfony\Component\Console\Input\InputOption('--env', '-e', \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Environment'));
        $application->register('foo')->setAliases(['f'])->setDefinition([new \MolliePrefix\Symfony\Component\Console\Input\InputOption('survey', 'e', \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'My option with a shortcut.')])->setCode(function (\MolliePrefix\Symfony\Component\Console\Input\InputInterface $input, \MolliePrefix\Symfony\Component\Console\Output\OutputInterface $output) {
        });
        $input = new \MolliePrefix\Symfony\Component\Console\Input\ArrayInput(['command' => 'foo']);
        $output = new \MolliePrefix\Symfony\Component\Console\Output\NullOutput();
        $application->run($input, $output);
    }
    /**
    ...
    public function testAddingAlreadySetDefinitionElementData($def)
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->register('foo')->setDefinition([$def])->setCode(function (\MolliePrefix\Symfony\Component\Console\Input\InputInterface $input, \MolliePrefix\Symfony\Component\Console\Output\OutputInterface $output) {
        });
        $input = new \MolliePrefix\Symfony\Component\Console\Input\ArrayInput(['command' => 'foo']);
        $output = new \MolliePrefix\Symfony\Component\Console\Output\NullOutput();
        $application->run($input, $output);
    ...
    {
        return [[new \MolliePrefix\Symfony\Component\Console\Input\InputArgument('command', \MolliePrefix\Symfony\Component\Console\Input\InputArgument::REQUIRED)], [new \MolliePrefix\Symfony\Component\Console\Input\InputOption('quiet', '', \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_NONE)], [new \MolliePrefix\Symfony\Component\Console\Input\InputOption('query', 'q', \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_NONE)]];
    }
    ...
    public function testAddingSingleHelperSetOverwritesDefaultValues()
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->setHelperSet(new \MolliePrefix\Symfony\Component\Console\Helper\HelperSet([new \MolliePrefix\Symfony\Component\Console\Helper\FormatterHelper()]));
        $helperSet = $application->getHelperSet();
        $this->assertTrue($helperSet->has('formatter'));
    ...
    {
        $application = new \MolliePrefix\Symfony\Component\Console\Tests\CustomApplication();
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->setHelperSet(new \MolliePrefix\Symfony\Component\Console\Helper\HelperSet([new \MolliePrefix\Symfony\Component\Console\Helper\FormatterHelper()]));
        $helperSet = $application->getHelperSet();
    ...
    public function testSettingCustomInputDefinitionOverwritesDefaultValues()
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->setDefinition(new \MolliePrefix\Symfony\Component\Console\Input\InputDefinition([new \MolliePrefix\Symfony\Component\Console\Input\InputOption('--custom', '-c', \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Set the custom input definition.')]));
        $inputDefinition = $application->getDefinition();
        // check whether the default arguments and options are not returned any more
        $this->assertFalse($inputDefinition->hasArgument('command'));
        $this->assertFalse($inputDefinition->hasOption('help'));
    ...
    public function testRunWithDispatcher()
    {
        ...
        $application->register('foo')->setCode(function (\MolliePrefix\Symfony\Component\Console\Input\InputInterface $input, \MolliePrefix\Symfony\Component\Console\Output\OutputInterface $output) {
            $output->write('foo.');
        });
        $tester = new \MolliePrefix\Symfony\Component\Console\Tester\ApplicationTester($application);
    ...
    public function testRunWithError()
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->register('dym')->setCode(function (\MolliePrefix\Symfony\Component\Console\Input\InputInterface $input, \MolliePrefix\Symfony\Component\Console\Output\OutputInterface $output) {
            $output->write('dym.');
    ...
    {
        $dispatcher = $this->getDispatcher();
        $dispatcher->addListener('console.error', function (\MolliePrefix\Symfony\Component\Console\Event\ConsoleErrorEvent $event) {
        ...
        $this->assertEquals(\MolliePrefix\Symfony\Component\Console\Event\ConsoleCommandEvent::RETURN_CODE_DISABLED, $tester->getStatusCode());
    }
    public function testConsoleErrorEventIsTriggeredOnCommandNotFound()
    {
        ...
        $dispatcher->addListener('console.error', function (\MolliePrefix\Symfony\Component\Console\Event\ConsoleErrorEvent $event) {
            ...
            $this->assertInstanceOf(\MolliePrefix\Symfony\Component\Console\Exception\CommandNotFoundException::class, $event->getError());
    ...
    {
        $dispatcher = $this->getDispatcher();
        $dispatcher->addListener('console.exception', function (\MolliePrefix\Symfony\Component\Console\Event\ConsoleExceptionEvent $event) {
    ...
    public function testErrorIsRethrownIfNotHandledByConsoleErrorEvent()
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->setDispatcher(new \MolliePrefix\Symfony\Component\EventDispatcher\EventDispatcher());
    ...
    public function testRunWithErrorFailingStatusCode()
    {
        ...
        $application->setDispatcher($this->getDispatcher());
        $application->setAutoExit(\false);
        $application->register('dus')->setCode(function (\MolliePrefix\Symfony\Component\Console\Input\InputInterface $input, \MolliePrefix\Symfony\Component\Console\Output\OutputInterface $output) {
            $output->write('dus.');
    ...
    public function testRunWithDispatcherSkippingCommand()
    {
        ...
        $this->assertEquals(\MolliePrefix\Symfony\Component\Console\Event\ConsoleCommandEvent::RETURN_CODE_DISABLED, $exitCode);
    }
    public function testRunWithDispatcherAccessingInputOptions()
    {
        ...
        $quietValue = null;
        $dispatcher = $this->getDispatcher();
        $dispatcher->addListener('console.command', function (\MolliePrefix\Symfony\Component\Console\Event\ConsoleCommandEvent $event) use(&$noInteractionValue, &$quietValue) {
    ...
    public function testRunWithDispatcherAddingInputOptions()
    {
        $extraValue = null;
        $dispatcher = $this->getDispatcher();
        $dispatcher->addListener('console.command', function (\MolliePrefix\Symfony\Component\Console\Event\ConsoleCommandEvent $event) use(&$extraValue) {
            $definition = $event->getCommand()->getDefinition();
            $input = $event->getInput();
            $definition->addOption(new \MolliePrefix\Symfony\Component\Console\Input\InputOption('extra', null, \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED));
    ...
    {
        $command = new \MolliePrefix\FooCommand();
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->setAutoExit(\false);
        ...
        $application = new \MolliePrefix\Symfony\Component\Console\Tests\CustomDefaultCommandApplication();
        $application->setAutoExit(\false);
        $tester = new \MolliePrefix\Symfony\Component\Console\Tester\ApplicationTester($application);
        $tester->run([], ['interactive' => \false]);
        $this->assertEquals('called' . \PHP_EOL, $tester->getDisplay(), 'Application runs the default set command if different from \'list\' command');
    ...
    {
        $command = new \MolliePrefix\FooOptCommand();
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->setAutoExit(\false);
        $application->add($command);
        $application->setDefaultCommand($command->getName());
    ...
    public function testRunLazyCommandService()
    {
        ...
        $container->addCompilerPass(new \MolliePrefix\Symfony\Component\Console\DependencyInjection\AddConsoleCommandPass());
        $container->register('lazy-command', \MolliePrefix\Symfony\Component\Console\Tests\LazyCommand::class)->addTag('console.command', ['command' => 'lazy:command'])->addTag('console.command', ['command' => 'lazy:alias'])->addTag('console.command', ['command' => 'lazy:alias2']);
        $container->compile();
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
    ...
    public function testGetDisabledLazyCommand()
    {
        $this->expectException('MolliePrefix\\Symfony\\Component\\Console\\Exception\\CommandNotFoundException');
        $application = new \MolliePrefix\Symfony\Component\Console\Application();
        $application->setCommandLoader(new \MolliePrefix\Symfony\Component\Console\CommandLoader\FactoryCommandLoader(['disabled' => function () {
            return new \MolliePrefix\Symfony\Component\Console\Tests\DisabledCommand();
        }]));
    ...
    public function testFindAlternativesDoesNotLoadSameNamespaceCommandsOnExactMatch()
    {
        ...
        $application->setAutoExit(\false);
        $loaded = [];
        $application->setCommandLoader(new \MolliePrefix\Symfony\Component\Console\CommandLoader\FactoryCommandLoader(['foo:bar' => function () use(&$loaded) {
            $loaded['foo:bar'] = \true;
            return (new \MolliePrefix\Symfony\Component\Console\Command\Command('foo:bar'))->setCode(function () {
            });
        }, 'foo' => function () use(&$loaded) {
            $loaded['foo'] = \true;
            return (new \MolliePrefix\Symfony\Component\Console\Command\Command('foo'))->setCode(function () {
            });
        }]));
        $application->run(new \MolliePrefix\Symfony\Component\Console\Input\ArrayInput(['command' => 'foo']), new \MolliePrefix\Symfony\Component\Console\Output\NullOutput());
        $this->assertSame(['foo' => \true], $loaded);
    }
    protected function getDispatcher($skipCommand = \false)
    {
        $dispatcher = new \MolliePrefix\Symfony\Component\EventDispatcher\EventDispatcher();
        $dispatcher->addListener('console.command', function (\MolliePrefix\Symfony\Component\Console\Event\ConsoleCommandEvent $event) use($skipCommand) {
            $event->getOutput()->write('before.');
            if ($skipCommand) {
                $event->disableCommand();
            }
        });
        $dispatcher->addListener('console.terminate', function (\MolliePrefix\Symfony\Component\Console\Event\ConsoleTerminateEvent $event) use($skipCommand) {
            $event->getOutput()->writeln('after.');
            if (!$skipCommand) {
                $event->setExitCode(\MolliePrefix\Symfony\Component\Console\Event\ConsoleCommandEvent::RETURN_CODE_DISABLED);
            }
        });
        $dispatcher->addListener('console.error', function (\MolliePrefix\Symfony\Component\Console\Event\ConsoleErrorEvent $event) {
    ...
    public function testCommandNameMismatchWithCommandLoaderKeyThrows()
    {
        ...
        $loader = new \MolliePrefix\Symfony\Component\Console\CommandLoader\FactoryCommandLoader(['test' => static function () {
            return new \MolliePrefix\Symfony\Component\Console\Command\Command('test-command');
        }]);
        $app->setCommandLoader($loader);
        $app->get('test');
    }
}
class CustomApplication extends \MolliePrefix\Symfony\Component\Console\Application
{
    /**
    ...
    {
        return new \MolliePrefix\Symfony\Component\Console\Input\InputDefinition([new \MolliePrefix\Symfony\Component\Console\Input\InputOption('--custom', '-c', \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Set the custom input definition.')]);
    }
    /**
    ...
    {
        return new \MolliePrefix\Symfony\Component\Console\Helper\HelperSet([new \MolliePrefix\Symfony\Component\Console\Helper\FormatterHelper()]);
    }
}
class CustomDefaultCommandApplication extends \MolliePrefix\Symfony\Component\Console\Application
{
    /**
...
class LazyCommand extends \MolliePrefix\Symfony\Component\Console\Command\Command
{
    public function execute(\MolliePrefix\Symfony\Component\Console\Input\InputInterface $input, \MolliePrefix\Symfony\Component\Console\Output\OutputInterface $output)
    {
        $output->writeln('lazy-command called');
    }
}
class DisabledCommand extends \MolliePrefix\Symfony\Component\Console\Command\Command
{
