...
class StringInputTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $input = new \MolliePrefix\Symfony\Component\Console\Input\StringInput($input);
        $r = new \ReflectionClass('MolliePrefix\\Symfony\\Component\\Console\\Input\\ArgvInput');
    ...
    {
        $definition = new \MolliePrefix\Symfony\Component\Console\Input\InputDefinition([new \MolliePrefix\Symfony\Component\Console\Input\InputOption('foo', null, \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED)]);
        // call to bind
        $input = new \MolliePrefix\Symfony\Component\Console\Input\StringInput('--foo=bar');
    ...
    {
        $input = new \MolliePrefix\Symfony\Component\Console\Input\StringInput('-f foo');
        $this->assertEquals('-f foo', (string) $input);
        $input = new \MolliePrefix\Symfony\Component\Console\Input\StringInput('-f --bar=foo "a b c d"');
        $this->assertEquals('-f --bar=foo ' . \escapeshellarg('a b c d'), (string) $input);
        $input = new \MolliePrefix\Symfony\Component\Console\Input\StringInput('-f --bar=foo \'a b c d\' ' . "'A\nB\\'C'");
