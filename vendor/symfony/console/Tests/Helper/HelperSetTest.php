...
class HelperSetTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $mock_helper = $this->getGenericMockHelper('fake_helper');
        $helperset = new \MolliePrefix\Symfony\Component\Console\Helper\HelperSet(['fake_helper_alias' => $mock_helper]);
    ...
    {
        $helperset = new \MolliePrefix\Symfony\Component\Console\Helper\HelperSet();
    ...
    {
        $helperset = new \MolliePrefix\Symfony\Component\Console\Helper\HelperSet(['fake_helper_alias' => $this->getGenericMockHelper('fake_helper')]);
    ...
    public function testGet()
    {
        ...
        $helperset = new \MolliePrefix\Symfony\Component\Console\Helper\HelperSet(['fake_helper_01_alias' => $helper_01, 'fake_helper_02_alias' => $helper_02]);
        ...
        try {
            ...
            $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Console\\Exception\\ExceptionInterface', $e, '->get() throws domain specific exception when helper not found');
    ...
    {
        $cmd_01 = new \MolliePrefix\Symfony\Component\Console\Command\Command('foo');
        $cmd_02 = new \MolliePrefix\Symfony\Component\Console\Command\Command('bar');
        $helperset = new \MolliePrefix\Symfony\Component\Console\Helper\HelperSet();
    ...
    {
        $cmd = new \MolliePrefix\Symfony\Component\Console\Command\Command('foo');
        $helperset = new \MolliePrefix\Symfony\Component\Console\Helper\HelperSet();
    ...
    private function getGenericMockHelper($name, \MolliePrefix\Symfony\Component\Console\Helper\HelperSet $helperset = null)
    {
        $mock_helper = $this->getMockBuilder('MolliePrefix\\Symfony\\Component\\Console\\Helper\\HelperInterface')->getMock();
