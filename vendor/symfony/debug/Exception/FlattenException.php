...
use MolliePrefix\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface;
use MolliePrefix\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface;
/**
...
class FlattenException
{
    ...
    public static function create(\Exception $exception, $statusCode = null, array $headers = [])
    {
        ...
        if ($exception instanceof \MolliePrefix\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \MolliePrefix\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        ...
        if ($previous instanceof \Exception) {
            ...
            $e->setPrevious(static::create(new \MolliePrefix\Symfony\Component\Debug\Exception\FatalThrowableError($previous)));
        }
        return $e;
    }
