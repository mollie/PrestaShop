 ...
 * @internal
 */
class UnaryNode extends \_PhpScoper5ece82d7231e4\Symfony\Component\ExpressionLanguage\Node\Node
{
    private static $operators = ['!' => '!', 'not' => '!', '+' => '+', '-' => '-'];
    public function __construct($operator, \_PhpScoper5ece82d7231e4\Symfony\Component\ExpressionLanguage\Node\Node $node)
    {
