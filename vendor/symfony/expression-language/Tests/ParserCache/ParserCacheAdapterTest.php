 ...
 * @group legacy
 */
class ParserCacheAdapterTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    public function testGetItem()
    {
        $poolMock = $this->getMockBuilder('_PhpScoper5ece82d7231e4\\Symfony\\Component\\ExpressionLanguage\\ParserCache\\ParserCacheInterface')->getMock();
        $key = 'key';
        $value = 'value';
        $parserCacheAdapter = new \_PhpScoper5ece82d7231e4\Symfony\Component\ExpressionLanguage\ParserCache\ParserCacheAdapter($poolMock);
    ...
    public function testSave()
    {
        ...
        $key = 'key';
        $value = new \_PhpScoper5ece82d7231e4\Symfony\Component\ExpressionLanguage\ParsedExpression('1 + 1', new \_PhpScoper5ece82d7231e4\Symfony\Component\ExpressionLanguage\Node\Node([], []));
        $parserCacheAdapter = new \_PhpScoper5ece82d7231e4\Symfony\Component\ExpressionLanguage\ParserCache\ParserCacheAdapter($poolMock);
