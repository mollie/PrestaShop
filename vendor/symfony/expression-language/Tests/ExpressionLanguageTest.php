...
use _PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ExpressionFunction;
use _PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ExpressionLanguage;
use _PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ParsedExpression;
use _PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\Tests\Fixtures\TestProvider;
class ExpressionLanguageTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    public function testCachedParse()
    {
        $cacheMock = $this->getMockBuilder('_PhpScoper5eddef0da618a\\Psr\\Cache\\CacheItemPoolInterface')->getMock();
        $cacheItemMock = $this->getMockBuilder('_PhpScoper5eddef0da618a\\Psr\\Cache\\CacheItemInterface')->getMock();
        $savedParsedExpression = null;
        $expressionLanguage = new \_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ExpressionLanguage($cacheMock);
        ...
        $cacheItemMock->expects($this->exactly(1))->method('set')->with($this->isInstanceOf(\_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ParsedExpression::class))->willReturnCallback(function ($parsedExpression) use(&$savedParsedExpression) {
    ...
    {
        $cacheMock = $this->getMockBuilder('_PhpScoper5eddef0da618a\\Symfony\\Component\\ExpressionLanguage\\ParserCache\\ParserCacheInterface')->getMock();
        $savedParsedExpression = null;
        $expressionLanguage = new \_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ExpressionLanguage($cacheMock);
        $cacheMock->expects($this->exactly(1))->method('fetch')->with('1%20%2B%201%2F%2F')->willReturn($savedParsedExpression);
        $cacheMock->expects($this->exactly(1))->method('save')->with('1%20%2B%201%2F%2F', $this->isInstanceOf(\_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ParsedExpression::class))->willReturnCallback(function ($key, $expression) use(&$savedParsedExpression) {
    ...
    public function testWrongCacheImplementation()
    {
        ...
        $cacheMock = $this->getMockBuilder('_PhpScoper5eddef0da618a\\Psr\\Cache\\CacheItemSpoolInterface')->getMock();
        new \_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ExpressionLanguage($cacheMock);
    }
    public function testConstantFunction()
    {
        $expressionLanguage = new \_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ExpressionLanguage();
    ...
    {
        $expressionLanguage = new \_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ExpressionLanguage(null, [new \_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\Tests\Fixtures\TestProvider()]);
    ...
    public function testRegisterAfterParse($registerCallback)
    {
        ...
        $el = new \_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ExpressionLanguage();
        $el->parse('1 + 1', []);
        $registerCallback($el);
    }
    /**
    ...
    {
        return [[function (\_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ExpressionLanguage $el) {
            $el->register('fn', function () {
            }, function () {
            });
        }], [function (\_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ExpressionLanguage $el) {
            $el->addFunction(new \_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ExpressionFunction('fn', function () {
            }, function () {
            }));
        }], [function (\_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\ExpressionLanguage $el) {
            $el->registerProvider(new \_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\Tests\Fixtures\TestProvider());
        }]];
    }
}
