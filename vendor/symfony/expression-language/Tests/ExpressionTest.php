...
class ExpressionTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    public function testSerialization()
    {
        $expression = new \_PhpScoper5ece82d7231e4\Symfony\Component\ExpressionLanguage\Expression('kernel.boot()');
