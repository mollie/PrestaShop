 ...
 */
class TypedReference extends \MolliePrefix\Symfony\Component\DependencyInjection\Reference
{
    private $type;
     ...
     */
    public function __construct($id, $type, $requiringClass = '', $invalidBehavior = \MolliePrefix\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE)
    {
