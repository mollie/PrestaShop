...
class ChildDefinitionTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $def = new \MolliePrefix\Symfony\Component\DependencyInjection\ChildDefinition('foo');
    ...
    {
        $this->assertInstanceOf(\MolliePrefix\Symfony\Component\DependencyInjection\ChildDefinition::class, new \MolliePrefix\Symfony\Component\DependencyInjection\DefinitionDecorator('foo'));
    }
    public function testCannotCallSetAutoconfigured()
    {
        $this->expectException('MolliePrefix\\Symfony\\Component\\DependencyInjection\\Exception\\BadMethodCallException');
        $def = new \MolliePrefix\Symfony\Component\DependencyInjection\ChildDefinition('foo');
    ...
    public function testCannotCallSetInstanceofConditionals()
    {
        $this->expectException('MolliePrefix\\Symfony\\Component\\DependencyInjection\\Exception\\BadMethodCallException');
        $def = new \MolliePrefix\Symfony\Component\DependencyInjection\ChildDefinition('foo');
        $def->setInstanceofConditionals(['Foo' => new \MolliePrefix\Symfony\Component\DependencyInjection\ChildDefinition('')]);
    }
}
