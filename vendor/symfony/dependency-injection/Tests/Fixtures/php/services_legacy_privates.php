 ...
 */
class Symfony_DI_PhpDumper_Test_Legacy_Privates extends \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Container
{
    private $parameters = [];
    private $targetDirs = [];
 ...
 * @final since Symfony 3.3
 */
\class_alias('_PhpScoper5ece82d7231e4\\Symfony_DI_PhpDumper_Test_Legacy_Privates', 'Symfony_DI_PhpDumper_Test_Legacy_Privates', \false);
