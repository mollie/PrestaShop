...
namespace MolliePrefix\Symfony\Component\DependencyInjection\Dump;
 ...
 */
class Container extends \MolliePrefix\Symfony\Component\DependencyInjection\Dump\AbstractContainer
{
    private $parameters = [];
    private $targetDirs = [];
