...
class ProjectServiceContainer extends \MolliePrefix\Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return ['MolliePrefix\\Psr\\Container\\ContainerInterface' => \true, 'MolliePrefix\\Symfony\\Component\\DependencyInjection\\ContainerInterface' => \true, 'baz_service' => \true, 'translator.loader_1_locator' => \true, 'translator.loader_2_locator' => \true, 'translator.loader_3_locator' => \true];
    }
    ...
    {
        return $this->services['foo_service'] = new \MolliePrefix\Symfony\Component\DependencyInjection\ServiceLocator(['bar' => function () {
    ...
    {
        return $this->services['translator_1'] = new \MolliePrefix\Symfony\Component\DependencyInjection\Tests\Fixtures\StubbedTranslator(new \MolliePrefix\Symfony\Component\DependencyInjection\ServiceLocator(['translator.loader_1' => function () {
    ...
    {
        $this->services['translator_2'] = $instance = new \MolliePrefix\Symfony\Component\DependencyInjection\Tests\Fixtures\StubbedTranslator(new \MolliePrefix\Symfony\Component\DependencyInjection\ServiceLocator(['translator.loader_2' => function () {
    ...
    {
        $this->services['translator_3'] = $instance = new \MolliePrefix\Symfony\Component\DependencyInjection\Tests\Fixtures\StubbedTranslator(new \MolliePrefix\Symfony\Component\DependencyInjection\ServiceLocator(['translator.loader_3' => function () {
