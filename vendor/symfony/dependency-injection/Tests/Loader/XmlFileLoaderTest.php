...
class XmlFileLoaderTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    ...
    {
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder(), new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/ini'));
        try {
            $loader->load('foo.xml');
    ...
    public function testParseFile()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Exception\\InvalidArgumentException', $e, '->parseFileToDOM() throws an InvalidArgumentException if the loaded file is not a valid XML file');
        ...
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder(), new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/xml'));
        try {
            ...
            $this->assertInstanceOf('_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Exception\\InvalidArgumentException', $e, '->parseFileToDOM() throws an InvalidArgumentException if the loaded file does not validate the XSD');
    ...
    public function testLoadWithExternalEntitiesDisabled()
    {
        ...
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader($containerBuilder, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/xml'));
    ...
    public function testLoadParameters()
    {
        ...
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/xml'));
        $loader->load('services2.xml');
    ...
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $resolver = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Loader\LoaderResolver([new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\IniFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/ini')), new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\YamlFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/yml')), $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/xml'))]);
    ...
    public function testLoadAnonymousServices()
    {
        ...
        $this->assertInstanceOf('_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Reference', $args[0], '->load() converts anonymous services to references to "normal" services');
        ...
        $this->assertInstanceOf('_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Reference', $property, '->load() converts anonymous services to references to "normal" services');
    ...
    public function testLoadAnonymousNestedServices()
    {
        ...
        $this->assertInstanceOf(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference::class, \array_shift($arguments));
    }
    public function testLoadServices()
    {
        ...
        $this->assertEquals([['setBar', []], ['setBar', [new \_PhpScoper5ece82d7231e4\Symfony\Component\ExpressionLanguage\Expression('service("foo").foo() ~ (container.hasParameter("foo") ? parameter("foo") : "default")')]]], $services['method_call1']->getMethodCalls(), '->load() parses the method_call tag');
    ...
    public function testConvertDomElementToArray()
    {
        ...
        $this->assertEquals('bar', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader::convertDomElementToArray($doc->documentElement), '::convertDomElementToArray() converts a \\DomElement to an array');
        $doc = new \DOMDocument('1.0');
        $doc->loadXML('<foo foo="bar" />');
        $this->assertEquals(['foo' => 'bar'], \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader::convertDomElementToArray($doc->documentElement), '::convertDomElementToArray() converts a \\DomElement to an array');
        $doc = new \DOMDocument('1.0');
        $doc->loadXML('<foo><foo>bar</foo></foo>');
        $this->assertEquals(['foo' => 'bar'], \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader::convertDomElementToArray($doc->documentElement), '::convertDomElementToArray() converts a \\DomElement to an array');
        $doc = new \DOMDocument('1.0');
        $doc->loadXML('<foo><foo>bar<foo>bar</foo></foo></foo>');
        $this->assertEquals(['foo' => ['value' => 'bar', 'foo' => 'bar']], \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader::convertDomElementToArray($doc->documentElement), '::convertDomElementToArray() converts a \\DomElement to an array');
        $doc = new \DOMDocument('1.0');
        $doc->loadXML('<foo><foo></foo></foo>');
        $this->assertEquals(['foo' => null], \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader::convertDomElementToArray($doc->documentElement), '::convertDomElementToArray() converts a \\DomElement to an array');
        $doc = new \DOMDocument('1.0');
        $doc->loadXML('<foo><foo><!-- foo --></foo></foo>');
        $this->assertEquals(['foo' => null], \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader::convertDomElementToArray($doc->documentElement), '::convertDomElementToArray() converts a \\DomElement to an array');
        $doc = new \DOMDocument('1.0');
        $doc->loadXML('<foo><foo foo="bar"/><foo foo="bar"/></foo>');
        $this->assertEquals(['foo' => [['foo' => 'bar'], ['foo' => 'bar']]], \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader::convertDomElementToArray($doc->documentElement), '::convertDomElementToArray() converts a \\DomElement to an array');
    }
    public function testExtensions()
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->registerExtension(new \_PhpScoper5ece82d7231e4\ProjectExtension());
        $container->registerExtension(new \_PhpScoper5ece82d7231e4\ProjectWithXsdExtension());
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/xml'));
        ...
        try {
            ...
            $this->assertInstanceOf('_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Exception\\InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if the configuration does not validate the XSD');
    ...
    public function testExtensionInPhar()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->registerExtension(new \_PhpScoper5ece82d7231e4\ProjectWithXsdExtensionInPhar());
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/xml'));
    ...
    {
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder(), new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator());
    ...
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $loader1 = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/xml/extension1'));
        $loader1->load('services.xml');
        $services = $container->getDefinitions();
        $this->assertCount(3, $services, '->load() attributes unique ids to anonymous services');
        $loader2 = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/xml/extension2'));
    ...
    public function testDocTypeIsNotAllowed()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Exception\\InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if the configuration contains a document type');
    ...
    public function testLoadInlinedServices()
    {
        ...
        $this->assertInstanceOf(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference::class, $fooFactory[0]);
        ...
        $this->assertInstanceOf(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference::class, $fooFactoryFactory[0]);
        ...
        $this->assertInstanceOf(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference::class, $fooConfigurator[0]);
        ...
        $this->assertInstanceOf(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference::class, $barConfigurator[0]);
    ...
    public function testPrototype()
    {
        ...
        $this->assertContains((string) new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Resource\FileResource($fixturesDir . 'xml' . \DIRECTORY_SEPARATOR . 'services_prototype.xml'), $resources);
    ...
    public function testNamedArguments()
    {
        ...
        $this->assertEquals(['$apiKey' => 'ABCD', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\CaseSensitiveClass::class => null], $container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\NamedArgumentsDummy::class)->getArguments());
        $container->compile();
        ...
        $this->assertEquals([['setApiKey', ['123']]], $container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\NamedArgumentsDummy::class)->getMethodCalls());
    }
