...
use _PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Bar;
use _PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\BarInterface;
...
class YamlFileLoaderTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    ...
    public function testLoadUnExistFile()
    {
        ...
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\YamlFileLoader(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder(), new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/ini'));
    ...
    public function testLoadInvalidYamlFile()
    {
        ...
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\YamlFileLoader(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder(), new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator($path));
        $r = new \ReflectionObject($loader);
        $m = $r->getMethod('loadFile');
        $m->setAccessible(\true);
    ...
    {
        $this->expectException('_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Exception\\InvalidArgumentException');
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\YamlFileLoader(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder(), new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/yaml'));
    ...
    public function testLoadParameters()
    {
        ...
        $this->assertEquals(['foo' => 'bar', 'mixedcase' => ['MixedCaseKey' => 'value'], 'values' => [\true, \false, 0, 1000.3, \PHP_INT_MAX], 'bar' => 'foo', 'escape' => '@escapeme', 'foo_bar' => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('foo_bar')], $container->getParameterBag()->all(), '->load() converts YAML keys to lowercase');
    }
    public function testLoadImports()
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $resolver = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Loader\LoaderResolver([new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\IniFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/ini')), new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\XmlFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/xml')), new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\PhpFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/php')), $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\YamlFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/yaml'))]);
        $loader->setResolver($resolver);
        $loader->load('services4.yml');
        $actual = $container->getParameterBag()->all();
        $expected = ['foo' => 'bar', 'values' => [\true, \false, \PHP_INT_MAX], 'bar' => '%foo%', 'escape' => '@escapeme', 'foo_bar' => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('foo_bar'), 'mixedcase' => ['MixedCaseKey' => 'value'], 'imported_from_ini' => \true, 'imported_from_xml' => \true, 'with_wrong_ext' => 'from yaml'];
    ...
    public function testLoadServices()
    {
        ...
        $this->assertInstanceOf('_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Definition', $services['foo'], '->load() converts service element to Definition instances');
        $this->assertEquals('FooClass', $services['foo']->getClass(), '->load() parses the class attribute');
        $this->assertEquals('%path%/foo.php', $services['file']->getFile(), '->load() parses the file tag');
        $this->assertEquals(['foo', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('foo'), [\true, \false]], $services['arguments']->getArguments(), '->load() parses the argument tags');
        $this->assertEquals('sc_configure', $services['configurator1']->getConfigurator(), '->load() parses the configurator tag');
        $this->assertEquals([new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('baz'), 'configure'], $services['configurator2']->getConfigurator(), '->load() parses the configurator tag');
        $this->assertEquals(['BazClass', 'configureStatic'], $services['configurator3']->getConfigurator(), '->load() parses the configurator tag');
        $this->assertEquals([['setBar', []], ['setBar', []], ['setBar', [new \_PhpScoper5ece82d7231e4\Symfony\Component\ExpressionLanguage\Expression('service("foo").foo() ~ (container.hasParameter("foo") ? parameter("foo") : "default")')]]], $services['method_call1']->getMethodCalls(), '->load() parses the method_call tag');
        $this->assertEquals([['setBar', ['foo', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('foo'), [\true, \false]]]], $services['method_call2']->getMethodCalls(), '->load() parses the method_call tag');
        $this->assertEquals('factory', $services['new_factory1']->getFactory(), '->load() parses the factory tag');
        $this->assertEquals([new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('baz'), 'getClass'], $services['new_factory2']->getFactory(), '->load() parses the factory tag');
        ...
        $this->assertEquals(['foo', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('baz')], $services['Acme\\WithShortCutArgs']->getArguments(), '->load() parses short service definition');
    ...
    public function testLoadFactoryShortSyntax()
    {
        ...
        $services = $container->getDefinitions();
        $this->assertEquals([new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('baz'), 'getClass'], $services['factory']->getFactory(), '->load() parses the factory tag with service:method');
    ...
    public function testLoadConfiguratorShortSyntax()
    {
        ...
        $services = $container->getDefinitions();
        $this->assertEquals([new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('foo_bar_configurator'), 'configure'], $services['foo_bar']->getConfigurator(), '->load() parses the configurator tag with service:method');
    ...
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->registerExtension(new \_PhpScoper5ece82d7231e4\ProjectExtension());
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\YamlFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/yaml'));
    ...
    {
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\YamlFileLoader(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder(), new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator());
    ...
    public function testNonArrayTagsThrowsException()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Exception\\InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if the tags key is not an array');
    ...
    public function testTagWithoutNameThrowsException()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Exception\\InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if a tag is missing the name key');
    ...
    public function testTagWithAttributeArrayThrowsException()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Exception\\InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if a tag-attribute is not a scalar');
    ...
    public function testLoadYamlOnlyWithKeys()
    {
        ...
        $this->assertEquals([['setLogger', [new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('logger')]], ['setClass', ['User']]], $definition->getMethodCalls());
    ...
    public function testParsesIteratorArgument()
    {
        ...
        $this->assertEquals([new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Argument\IteratorArgument(['k1' => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('foo.baz'), 'k2' => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('service_container')]), new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Argument\IteratorArgument([])], $lazyDefinition->getArguments(), '->load() parses lazy arguments');
    ...
    public function testClassFromId()
    {
        ...
        $container->compile();
        $this->assertEquals(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\CaseSensitiveClass::class, $container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\CaseSensitiveClass::class)->getClass());
    }
    public function testPrototype()
    {
        ...
        \sort($ids);
        $this->assertSame([\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\Foo::class, \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\Sub\Bar::class, 'service_container'], $ids);
        $resources = $container->getResources();
        $fixturesDir = \dirname(__DIR__) . \DIRECTORY_SEPARATOR . 'Fixtures' . \DIRECTORY_SEPARATOR;
        $resources = \array_map('strval', $resources);
        $this->assertContains((string) new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Resource\FileResource($fixturesDir . 'yaml' . \DIRECTORY_SEPARATOR . 'services_prototype.yml'), $resources);
        $this->assertContains((string) new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Resource\GlobResource($fixturesDir . 'Prototype', '', \true), $resources);
        $this->assertContains('_PhpScoper5ece82d7231e4\\reflection.Symfony\\Component\\DependencyInjection\\Tests\\Fixtures\\Prototype\\Foo', $resources);
        $this->assertContains('_PhpScoper5ece82d7231e4\\reflection.Symfony\\Component\\DependencyInjection\\Tests\\Fixtures\\Prototype\\Sub\\Bar', $resources);
    }
    public function testPrototypeWithNamespace()
    {
        ...
        $ids = \array_keys($container->getDefinitions());
        \sort($ids);
        $this->assertSame([\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\OtherDir\Component1\Dir1\Service1::class, \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\OtherDir\Component1\Dir2\Service2::class, \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\OtherDir\Component2\Dir1\Service4::class, \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\OtherDir\Component2\Dir2\Service5::class, 'service_container'], $ids);
        $this->assertTrue($container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\OtherDir\Component1\Dir1\Service1::class)->hasTag('foo'));
        $this->assertTrue($container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\OtherDir\Component2\Dir1\Service4::class)->hasTag('foo'));
        $this->assertFalse($container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\OtherDir\Component1\Dir1\Service1::class)->hasTag('bar'));
        $this->assertFalse($container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\OtherDir\Component2\Dir1\Service4::class)->hasTag('bar'));
        $this->assertTrue($container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\OtherDir\Component1\Dir2\Service2::class)->hasTag('bar'));
        $this->assertTrue($container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\OtherDir\Component2\Dir2\Service5::class)->hasTag('bar'));
        $this->assertFalse($container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\OtherDir\Component1\Dir2\Service2::class)->hasTag('foo'));
        $this->assertFalse($container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\OtherDir\Component2\Dir2\Service5::class)->hasTag('foo'));
    }
    ...
    public function testDefaults()
    {
        ...
        $this->assertFalse($container->getDefinition('_PhpScoper5ece82d7231e4\\Acme\\WithShortCutArgs')->isPublic());
        $this->assertSame(['foo' => [[]]], $container->getDefinition('_PhpScoper5ece82d7231e4\\Acme\\WithShortCutArgs')->getTags());
        $this->assertTrue($container->getDefinition('_PhpScoper5ece82d7231e4\\Acme\\WithShortCutArgs')->isAutowired());
        $container->compile();
    ...
    public function testNamedArguments()
    {
        ...
        $this->assertEquals([null, '$apiKey' => 'ABCD'], $container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\NamedArgumentsDummy::class)->getArguments());
        $this->assertEquals(['$apiKey' => 'ABCD', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\CaseSensitiveClass::class => null], $container->getDefinition('another_one')->getArguments());
        $container->compile();
        $this->assertEquals([null, 'ABCD'], $container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\NamedArgumentsDummy::class)->getArguments());
    ...
    public function testInstanceof()
    {
        ...
        $container->compile();
        $definition = $container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Bar::class);
    ...
    public function testAnonymousServices()
    {
        ...
        $this->assertInstanceOf(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference::class, $args[0]);
        ...
        $this->assertInstanceOf(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference::class, $factory[0]);
    ...
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\YamlFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/yaml/foo'));
        $loader->load('services.yml');
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Loader\YamlFileLoader($container, new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(self::$fixturesPath . '/yaml/bar'));
        $loader->load('services.yml');
    ...
    public function testAnonymousServicesInInstanceof()
    {
        ...
        $this->assertCount(1, $args);
        $this->assertInstanceOf(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference::class, $args['foo']);
    ...
    public function testBindings()
    {
        ...
        $this->assertEquals(['NonExistent' => null, \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\BarInterface::class => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Bar::class), '$foo' => [null], '$quz' => 'quz', '$factory' => 'factory'], \array_map(function ($v) {
            return $v->getValues()[0];
        }, $definition->getBindings()));
        $this->assertEquals(['quz', null, new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Bar::class), [null]], $definition->getArguments());
        $definition = $container->getDefinition(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\Bar::class);
