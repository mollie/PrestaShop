...
class YamlFileLoaderTest extends \_PhpScoper5ea00cc67502b\PHPUnit\Framework\TestCase
{
    ...
    public function testDefaults()
    {
        ...
        $this->assertFalse($container->getDefinition('_PhpScoper5ea00cc67502b\\Acme\\WithShortCutArgs')->isPublic());
        $this->assertSame(['foo' => [[]]], $container->getDefinition('_PhpScoper5ea00cc67502b\\Acme\\WithShortCutArgs')->getTags());
        $this->assertTrue($container->getDefinition('_PhpScoper5ea00cc67502b\\Acme\\WithShortCutArgs')->isAutowired());
        $container->compile();
