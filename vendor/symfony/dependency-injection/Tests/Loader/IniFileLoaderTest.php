...
class IniFileLoaderTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    protected $container;
    protected $loader;
    protected function setUp()
    {
        ...
        $this->loader = new \MolliePrefix\Symfony\Component\DependencyInjection\Loader\IniFileLoader($this->container, new \MolliePrefix\Symfony\Component\Config\FileLocator(\realpath(__DIR__ . '/../Fixtures/') . '/ini'));
    }
    ...
    {
        $loader = new \MolliePrefix\Symfony\Component\DependencyInjection\Loader\IniFileLoader(new \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder(), new \MolliePrefix\Symfony\Component\Config\FileLocator());
