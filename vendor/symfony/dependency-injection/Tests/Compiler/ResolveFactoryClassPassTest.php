...
use _PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\ResolveFactoryClassPass;
...
class ResolveFactoryClassPassTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    public function testProcess()
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $factory = $container->register('factory', '_PhpScoper5eddef0da618a\\Foo\\Bar');
        $factory->setFactory([null, 'create']);
        $pass = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\ResolveFactoryClassPass();
        $pass->process($container);
        $this->assertSame(['_PhpScoper5eddef0da618a\\Foo\\Bar', 'create'], $factory->getFactory());
    }
    public function testInlinedDefinitionFactoryIsProcessed()
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $factory = $container->register('factory');
        $factory->setFactory([(new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('_PhpScoper5eddef0da618a\\Baz\\Qux'))->setFactory([null, 'getInstance']), 'create']);
        $pass = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\ResolveFactoryClassPass();
        $pass->process($container);
        $this->assertSame(['_PhpScoper5eddef0da618a\\Baz\\Qux', 'getInstance'], $factory->getFactory()[0]->getFactory());
    }
    public function provideFulfilledFactories()
    {
        return [[['_PhpScoper5eddef0da618a\\Foo\\Bar', 'create']], [[new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('foo'), 'create']], [[new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('Baz'), 'create']]];
    }
    /**
