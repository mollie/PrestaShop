...
use _PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Compiler\RegisterEnvVarProcessorsPass;
...
class RegisterEnvVarProcessorsPassTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    public function testSimpleProcessor()
    {
        ...
        $container->register('foo', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Compiler\SimpleProcessor::class)->addTag('container.env_var_processor');
        (new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Compiler\RegisterEnvVarProcessorsPass())->process($container);
        $this->assertTrue($container->has('container.env_var_processors_locator'));
        $this->assertInstanceOf(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Compiler\SimpleProcessor::class, $container->get('container.env_var_processors_locator')->get('foo'));
    ...
    public function testBadProcessor()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Compiler\BadProcessor::class)->addTag('container.env_var_processor');
        (new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Compiler\RegisterEnvVarProcessorsPass())->process($container);
    }
}
class SimpleProcessor implements \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\EnvVarProcessorInterface
{
...
class BadProcessor extends \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Compiler\SimpleProcessor
{
    public static function getProvidedTypes()
    {
