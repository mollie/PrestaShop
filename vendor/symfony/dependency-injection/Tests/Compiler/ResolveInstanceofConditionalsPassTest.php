...
use _PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\ResolveInstanceofConditionalsPass;
use _PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder;
class ResolveInstanceofConditionalsPassTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    public function testProcess()
    {
        ...
        $def->setInstanceofConditionals([parent::class => (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition(''))->setProperty('foo', 'bar')->addTag('baz', ['attr' => 123])]);
        (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\ResolveInstanceofConditionalsPass())->process($container);
        $parent = 'instanceof.' . parent::class . '.0.foo';
        $def = $container->getDefinition('foo');
        $this->assertEmpty($def->getInstanceofConditionals());
        $this->assertInstanceOf(\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition::class, $def);
    ...
    public function testProcessInheritance()
    {
        ...
        $def->setInstanceofConditionals([parent::class => (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition(''))->addMethodCall('foo', ['bar'])]);
        $def = (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition('parent'))->setClass(self::class);
        $container->setDefinition('child', $def);
        (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\ResolveInstanceofConditionalsPass())->process($container);
        (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\ResolveChildDefinitionsPass())->process($container);
    ...
    public function testProcessDoesReplaceShared()
    {
        ...
        $def->setInstanceofConditionals(['stdClass' => (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition(''))->setShared(\false)]);
        (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\ResolveInstanceofConditionalsPass())->process($container);
        $def = $container->getDefinition('foo');
    ...
    public function testProcessHandlesMultipleInheritance()
    {
        ...
        $def->setInstanceofConditionals([parent::class => (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition(''))->setLazy(\true)->setShared(\false), self::class => (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition(''))->setAutowired(\true)]);
        (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\ResolveInstanceofConditionalsPass())->process($container);
        (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\ResolveChildDefinitionsPass())->process($container);
        $def = $container->getDefinition('foo');
        $this->assertTrue($def->isAutowired());
    ...
    public function testProcessUsesAutoconfiguredInstanceof()
    {
        ...
        $def->setInstanceofConditionals([parent::class => (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition(''))->addTag('local_instanceof_tag')->setFactory('locally_set_factory')]);
    ...
    public function testAutoconfigureInstanceofDoesNotDuplicateTags()
    {
        ...
        $def->setInstanceofConditionals([parent::class => (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition(''))->addTag('duplicated_tag')]);
        $def->setAutoconfigured(\true);
    ...
    public function testProcessDoesNotUseAutoconfiguredInstanceofIfNotEnabled()
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $def = $container->register('normal_service', self::class);
        $def->setInstanceofConditionals([parent::class => (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition(''))->addTag('foo_tag')]);
    ...
    public function testBadInterfaceThrowsException()
    {
        ...
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $def = $container->register('normal_service', self::class);
        $def->setInstanceofConditionals(['_PhpScoper5eddef0da618a\\App\\FakeInterface' => (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition(''))->addTag('foo_tag')]);
        (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\ResolveInstanceofConditionalsPass())->process($container);
    }
    public function testBadInterfaceForAutomaticInstanceofIsOk()
    {
        ...
        $container->registerForAutoconfiguration('_PhpScoper5eddef0da618a\\App\\FakeInterface')->setAutowired(\true);
        (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\ResolveInstanceofConditionalsPass())->process($container);
    ...
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('bar', self::class)->addArgument('a')->addMethodCall('setB')->setDecoratedService('foo')->addTag('t')->setInstanceofConditionals([parent::class => (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition(''))->addTag('bar')]);
        (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\ResolveInstanceofConditionalsPass())->process($container);
    ...
    public function testBindings()
    {
        ...
        $def->setInstanceofConditionals([parent::class => new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition('')]);
        (new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\ResolveInstanceofConditionalsPass())->process($container);
        $bindings = $container->getDefinition('foo')->getBindings();
        $this->assertSame(['$toto'], \array_keys($bindings));
        $this->assertInstanceOf(\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Argument\BoundArgument::class, $bindings['$toto']);
