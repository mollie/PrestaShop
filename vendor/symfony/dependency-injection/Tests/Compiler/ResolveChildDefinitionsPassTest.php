...
class ResolveChildDefinitionsPassTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    ...
    public function testDeepDefinitionsResolving()
    {
        ...
        $this->assertSame('MolliePrefix\\Symfony\\Component\\DependencyInjection\\Definition', \get_class($configurator));
        $this->assertSame('parentClass', $configurator->getClass());
        $factory = $container->getDefinition('sibling')->getFactory();
        $this->assertSame('MolliePrefix\\Symfony\\Component\\DependencyInjection\\Definition', \get_class($factory[0]));
        $this->assertSame('parentClass', $factory[0]->getClass());
        $argument = $container->getDefinition('sibling')->getArgument(0);
        $this->assertSame('MolliePrefix\\Symfony\\Component\\DependencyInjection\\Definition', \get_class($argument));
        $this->assertSame('parentClass', $argument->getClass());
        $properties = $container->getDefinition('sibling')->getProperties();
        $this->assertSame('MolliePrefix\\Symfony\\Component\\DependencyInjection\\Definition', \get_class($properties['prop']));
        $this->assertSame('parentClass', $properties['prop']->getClass());
        $methodCalls = $container->getDefinition('sibling')->getMethodCalls();
        $this->assertSame('MolliePrefix\\Symfony\\Component\\DependencyInjection\\Definition', \get_class($methodCalls[0][1][0]));
    ...
    public function testBindings()
    {
        ...
        $container->setDefinition('child', new \MolliePrefix\Symfony\Component\DependencyInjection\ChildDefinition('parent'))->setBindings(['b' => 'B', 'c' => 'C']);
        $this->process($container);
        $bindings = [];
    ...
    {
        $this->assertInstanceOf(\MolliePrefix\Symfony\Component\DependencyInjection\Compiler\ResolveChildDefinitionsPass::class, new \MolliePrefix\Symfony\Component\DependencyInjection\Compiler\ResolveDefinitionTemplatesPass());
    }
    protected function process(\MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        $pass = new \MolliePrefix\Symfony\Component\DependencyInjection\Compiler\ResolveChildDefinitionsPass();
    ...
    public function testProcessDetectsChildDefinitionIndirectCircularReference()
    {
        ...
        $container->setDefinition('b', new \MolliePrefix\Symfony\Component\DependencyInjection\ChildDefinition('a'));
        $container->setDefinition('c', new \MolliePrefix\Symfony\Component\DependencyInjection\ChildDefinition('b'));
        $container->setDefinition('a', new \MolliePrefix\Symfony\Component\DependencyInjection\ChildDefinition('c'));
        $this->process($container);
    }
}
