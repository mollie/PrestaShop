...
use _PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Compiler\ResolveReferencesToAliasesPass;
...
class ResolveReferencesToAliasesPassTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    public function testProcess()
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->setAlias('bar', 'foo');
        $def = $container->register('moo')->setArguments([new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('bar')]);
    ...
    public function testProcessRecursively()
    {
        ...
        $def = $container->register('foobar')->setArguments([new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('moo')]);
        $this->process($container);
        $arguments = $def->getArguments();
        $this->assertEquals('foo', (string) $arguments[0]);
    }
    ...
    public function testResolveFactory()
    {
        ...
        $container->setAlias('factory_alias', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Alias('factory'));
        $foo = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Definition();
        $foo->setFactory([new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('factory_alias'), 'createFoo']);
        $container->setDefinition('foo', $foo);
        $bar = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Definition();
    ...
    {
        $pass = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Compiler\ResolveReferencesToAliasesPass();
