...
class ResolveClassPassTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        (yield ['_PhpScoper5ece82d7231e4\\Acme\\UnknownClass']);
        (yield [\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\CaseSensitiveClass::class]);
    }
    /**
    ...
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $parent = $container->register('_PhpScoper5ece82d7231e4\\App\\Foo', null);
        $child = $container->setDefinition('App\\Foo.child', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ChildDefinition('_PhpScoper5ece82d7231e4\\App\\Foo'));
        (new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Compiler\ResolveClassPass())->process($container);
        $this->assertSame('_PhpScoper5ece82d7231e4\\App\\Foo', $parent->getClass());
    ...
    public function testClassFoundChildDefinition()
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $parent = $container->register('_PhpScoper5ece82d7231e4\\App\\Foo', null);
        $child = $container->setDefinition(self::class, new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ChildDefinition('_PhpScoper5ece82d7231e4\\App\\Foo'));
        (new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Compiler\ResolveClassPass())->process($container);
        $this->assertSame('_PhpScoper5ece82d7231e4\\App\\Foo', $parent->getClass());
    ...
    public function testAmbiguousChildDefinition()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('_PhpScoper5ece82d7231e4\\App\\Foo', null);
        $container->setDefinition('_PhpScoper5ece82d7231e4\\App\\Foo\\Child', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ChildDefinition('_PhpScoper5ece82d7231e4\\App\\Foo'));
        (new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Compiler\ResolveClassPass())->process($container);
    }
}
