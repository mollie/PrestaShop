...
class ResolveDefinitionTemplatesPassTest extends \_PhpScoper5ea00cc67502b\PHPUnit\Framework\TestCase
{
    ...
    public function testDeepDefinitionsResolving()
    {
        ...
        $this->assertInstanceOf('_PhpScoper5ea00cc67502b\\Symfony\\Component\\DependencyInjection\\Definition', $factory[0]);
        $this->assertSame('parentClass', $factory[0]->getClass());
        $argument = $container->getDefinition('sibling')->getArgument(0);
        $this->assertInstanceOf('_PhpScoper5ea00cc67502b\\Symfony\\Component\\DependencyInjection\\Definition', $argument);
        $this->assertSame('parentClass', $argument->getClass());
        $properties = $container->getDefinition('sibling')->getProperties();
        $this->assertInstanceOf('_PhpScoper5ea00cc67502b\\Symfony\\Component\\DependencyInjection\\Definition', $properties['prop']);
        $this->assertSame('parentClass', $properties['prop']->getClass());
        $methodCalls = $container->getDefinition('sibling')->getMethodCalls();
        $this->assertInstanceOf('_PhpScoper5ea00cc67502b\\Symfony\\Component\\DependencyInjection\\Definition', $methodCalls[0][1][0]);
