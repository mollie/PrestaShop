...
class EnvPlaceholderParameterBagTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    ...
    public function testMergeWillNotDuplicateIdenticalParameters()
    {
        ...
        $firstBag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag();
    ...
    public function testMergeWhereFirstBagIsEmptyWillWork()
    {
        ...
        $parameter = \sprintf('env(%s)', $envVariableName);
        $firstBag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag();
        $secondBag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag();
