...
class ParameterBagTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        $bag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($parameters = ['foo' => 'foo', 'bar' => 'bar']);
    ...
    {
        $bag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['foo' => 'foo', 'bar' => 'bar']);
        $bag->remove('foo');
        $this->assertEquals(['bar' => 'bar'], $bag->all(), '->remove() removes a parameter');
    }
    public function testGetSet()
    {
        $bag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['foo' => 'bar']);
        $bag->set('bar', 'foo');
        ...
        try {
            ...
            $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\DependencyInjection\\Exception\\ParameterNotFoundException', $e, '->get() throws an Symfony\\Component\\DependencyInjection\\Exception\\ParameterNotFoundException if the key does not exist');
    ...
    {
        $bag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['foo' => 'foo', 'bar' => 'bar', 'baz' => 'baz', 'fiz' => ['bar' => ['boo' => 12]]]);
    ...
    {
        $bag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag([]);
        ...
        $bag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['foo' => \true]);
        ...
        $bag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['foo' => null]);
        ...
        $bag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['foo' => 'bar', 'baz' => '%%%foo% %foo%%% %%foo%% %%%foo%%%']);
        $this->assertEquals('%%bar bar%% %%foo%% %%bar%%', $bag->resolveValue('%baz%'), '->resolveValue() replaces params placed besides escaped %');
        $bag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['baz' => '%%s?%%s']);
        ...
        } catch (\MolliePrefix\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException $e) {
        ...
        $bag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['foo' => 'a %bar%', 'bar' => []]);
        try {
        ...
        $bag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['foo' => '%bar%', 'bar' => '%foobar%', 'foobar' => '%foo%']);
        try {
            $bag->resolveValue('%foo%');
            $this->fail('->resolveValue() throws a ParameterCircularReferenceException when a parameter has a circular reference');
        } catch (\MolliePrefix\Symfony\Component\DependencyInjection\Exception\ParameterCircularReferenceException $e) {
        ...
        $bag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['foo' => 'a %bar%', 'bar' => 'a %foobar%', 'foobar' => 'a %foo%']);
        try {
            $bag->resolveValue('%foo%');
            $this->fail('->resolveValue() throws a ParameterCircularReferenceException when a parameter has a circular reference');
        } catch (\MolliePrefix\Symfony\Component\DependencyInjection\Exception\ParameterCircularReferenceException $e) {
        ...
        $bag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['host' => 'foo.bar', 'port' => 1337]);
    ...
    {
        $bag = new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['foo' => ['bar' => ['ding' => 'I\'m a bar %%foo %%bar']], 'bar' => 'I\'m a %%foo%%']);
        $bag->resolve();
