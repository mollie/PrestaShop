...
class DefinitionTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        ...
        $def = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Definition('stdClass', ['foo']);
    ...
    {
        return ["With \rs" => ["invalid \r message %service_id%"], "With \ns" => ["invalid \n message %service_id%"], 'With */s' => ['invalid */ message %service_id%'], 'message not containing require %service_id% variable' => ['this is deprecated']];
    }
    ...
    public function testTags()
    {
        ...
        $this->assertEquals($def->getTags(), ['foo' => [[], ['foo' => 'bar']], 'bar' => [['bar' => 'bar']]], '->getTags() returns all tags');
    }
    ...
    {
        $def = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Definition('stdClass', ['fooarg']);
        $def->setAbstract(\true);
        $def->setAutowired(\true);
