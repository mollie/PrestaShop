...
use _PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\PassConfig;
...
use _PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Loader\ClosureLoader;
...
class ContainerBuilderTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    public function testDefaultRegisteredDefinitions()
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        ...
        $this->assertInstanceOf(\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition::class, $definition);
        $this->assertTrue($definition->isSynthetic());
        $this->assertSame(\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerInterface::class, $definition->getClass());
        $this->assertTrue($builder->hasAlias(\_PhpScoper5eddef0da618a\Psr\Container\ContainerInterface::class));
        $this->assertTrue($builder->hasAlias(\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerInterface::class));
    }
    public function testDefinitions()
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $definitions = ['foo' => new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('_PhpScoper5eddef0da618a\\Bar\\FooClass'), 'bar' => new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('BarClass')];
        ...
        $builder->setDefinition('foobar', $foo = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('FooBarClass'));
        $this->assertEquals($foo, $builder->getDefinition('foobar'), '->getDefinition() returns a service definition if defined');
        $this->assertSame($builder->setDefinition('foobar', $foo = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('FooBarClass')), $foo, '->setDefinition() implements a fluid interface by returning the service reference');
        $builder->addDefinitions($defs = ['foobar' => new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('FooBarClass')]);
        ...
        } catch (\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException $e) {
    ...
    {
        $definition = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('stdClass');
    ...
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->register('foo', '_PhpScoper5eddef0da618a\\Bar\\FooClass');
        $this->assertTrue($builder->hasDefinition('foo'), '->register() registers a new service definition');
        $this->assertInstanceOf('_PhpScoper5eddef0da618a\\Symfony\\Component\\DependencyInjection\\Definition', $builder->getDefinition('foo'), '->register() returns the newly created Definition instance');
    }
    public function testAutowire()
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->autowire('foo', '_PhpScoper5eddef0da618a\\Bar\\FooClass');
    ...
    {
        $this->expectException('_PhpScoper5eddef0da618a\\Symfony\\Component\\DependencyInjection\\Exception\\ServiceNotFoundException');
    ...
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $this->assertNull($builder->get('foo', \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE), '->get() returns null if the service does not exist and NULL_ON_INVALID_REFERENCE is passed as a second argument');
    }
    public function testGetThrowsCircularReferenceExceptionIfServiceHasReferenceToItself()
    {
        ...
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->register('baz', 'stdClass')->setArguments([new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('baz')]);
        $builder->get('baz');
    }
    ...
    public function testBadDefinitionId($id)
    {
        $this->expectException('_PhpScoper5eddef0da618a\\Symfony\\Component\\DependencyInjection\\Exception\\InvalidArgumentException');
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->setDefinition($id, new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('Foo'));
    }
    ...
    public function testGetServiceIds()
    {
        ...
        $builder->register('bar', 'stdClass');
        $this->assertEquals(['service_container', 'foo', 'bar', '_PhpScoper5eddef0da618a\\Psr\\Container\\ContainerInterface', '_PhpScoper5eddef0da618a\\Symfony\\Component\\DependencyInjection\\ContainerInterface'], $builder->getServiceIds(), '->getServiceIds() returns all defined service ids');
    }
    ...
    public function testGetAliases()
    {
        ...
        $builder->setAlias('moo', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Alias('foo', \false));
    ...
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $aliased = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('stdClass');
        $aliased->addMethodCall('setBar', [new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('bar', \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_INVALID_REFERENCE)]);
    ...
    public function testAddGetCompilerPass()
    {
        ...
        $builder->addCompilerPass($pass1 = $this->getMockBuilder('_PhpScoper5eddef0da618a\\Symfony\\Component\\DependencyInjection\\Compiler\\CompilerPassInterface')->getMock(), \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\PassConfig::TYPE_BEFORE_OPTIMIZATION, -5);
        $builder->addCompilerPass($pass2 = $this->getMockBuilder('_PhpScoper5eddef0da618a\\Symfony\\Component\\DependencyInjection\\Compiler\\CompilerPassInterface')->getMock(), \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Compiler\PassConfig::TYPE_BEFORE_OPTIMIZATION, 10);
    ...
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->register('foo1', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->setFile(__DIR__ . '/Fixtures/includes/foo.php');
        $builder->register('foo2', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->setFile(__DIR__ . '/Fixtures/includes/%file%.php');
        $builder->setParameter('file', 'foo');
        $this->assertInstanceOf('_PhpScoper5eddef0da618a\\Bar\\FooClass', $builder->get('foo1'), '->createService() requires the file defined by the service definition');
        $this->assertInstanceOf('_PhpScoper5eddef0da618a\\Bar\\FooClass', $builder->get('foo2'), '->createService() replaces parameters in the file provided by the service definition');
    }
    public function testCreateProxyWithRealServiceInstantiator()
    {
        ...
        $this->assertSame('_PhpScoper5eddef0da618a\\Bar\\FooClass', \get_class($foo1));
    }
    ...
    public function testCreateServiceArguments()
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->register('bar', 'stdClass');
        $builder->register('foo1', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->addArgument(['foo' => '%value%', '%value%' => 'foo', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('bar'), '%%unescape_it%%']);
    ...
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->register('foo', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->setFactory('Bar\\FooClass::getInstance');
        $builder->register('qux', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->setFactory(['_PhpScoper5eddef0da618a\\Bar\\FooClass', 'getInstance']);
        $builder->register('bar', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->setFactory([new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('_PhpScoper5eddef0da618a\\Bar\\FooClass'), 'getInstance']);
        $builder->register('baz', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->setFactory([new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('bar'), 'getInstance']);
    ...
    public function testCreateServiceMethodCalls()
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->register('bar', 'stdClass');
        $builder->register('foo1', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->addMethodCall('setBar', [['%value%', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('bar')]]);
        $builder->setParameter('value', 'bar');
    ...
    public function testCreateServiceMethodCallsWithEscapedParam()
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->register('bar', 'stdClass');
        $builder->register('foo1', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->addMethodCall('setBar', [['%%unescape_it%%']]);
        $builder->setParameter('value', 'bar');
    ...
    public function testCreateServiceProperties()
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->register('bar', 'stdClass');
        $builder->register('foo1', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->setProperty('bar', ['%value%', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('bar'), '%%unescape_it%%']);
        $builder->setParameter('value', 'bar');
    ...
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->register('foo1', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->setConfigurator('sc_configure');
        $builder->register('foo2', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->setConfigurator(['%class%', 'configureStatic']);
        $builder->setParameter('class', 'BazClass');
        $builder->register('baz', 'BazClass');
        $builder->register('foo3', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->setConfigurator([new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('baz'), 'configure']);
        $builder->register('foo4', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->setConfigurator([$builder->getDefinition('baz'), 'configure']);
        $builder->register('foo5', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->setConfigurator('foo');
    ...
    public function testCreateServiceWithIteratorArgument()
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->register('bar', 'stdClass');
        $builder->register('lazy_context', 'LazyContext')->setArguments([new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Argument\IteratorArgument(['k1' => new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('bar'), new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('invalid', \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_INVALID_REFERENCE)]), new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Argument\IteratorArgument([])]);
    ...
    public function testCreateSyntheticService()
    {
        ...
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->register('foo', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->setSynthetic(\true);
        $builder->get('foo');
    }
    public function testCreateServiceWithExpression()
    {
        ...
        $builder->register('foo', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->addArgument(['foo' => new \_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\Expression('service("bar").foo ~ parameter("bar")')]);
    ...
    public function testResolveServices()
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->register('foo', '_PhpScoper5eddef0da618a\\Bar\\FooClass');
        $this->assertEquals($builder->get('foo'), $builder->resolveServices(new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('foo')), '->resolveServices() resolves service references to service instances');
        $this->assertEquals(['foo' => ['foo', $builder->get('foo')]], $builder->resolveServices(['foo' => ['foo', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('foo')]]), '->resolveServices() resolves service references to service instances in nested arrays');
        $this->assertEquals($builder->get('foo'), $builder->resolveServices(new \_PhpScoper5eddef0da618a\Symfony\Component\ExpressionLanguage\Expression('service("foo")')), '->resolveServices() resolves expressions');
    }
    public function testResolveServicesWithDecoratedDefinition()
    {
        ...
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->setDefinition('grandpa', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('stdClass'));
        $builder->setDefinition('parent', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition('grandpa'));
        $builder->setDefinition('foo', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ChildDefinition('parent'));
        $builder->get('foo');
    }
    public function testResolveServicesWithCustomDefinitionClass()
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->setDefinition('foo', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Tests\Fixtures\CustomDefinition('stdClass'));
        $this->assertInstanceOf('stdClass', $builder->get('foo'));
    }
    public function testMerge()
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder(new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['bar' => 'foo']));
        $container->setResourceTracking(\false);
        $config = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder(new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['foo' => 'bar']));
        ...
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder(new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['bar' => 'foo']));
        $container->setResourceTracking(\false);
        $config = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder(new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['foo' => '%bar%', 'baz' => '%foo%']));
        $container->merge($config);
        $container->compile();
        ...
        $container->setResourceTracking(\false);
        $container->register('foo', '_PhpScoper5eddef0da618a\\Bar\\FooClass');
        $container->register('bar', 'BarClass');
        $config = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $config->setDefinition('baz', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('BazClass'));
        ...
        $container->setResourceTracking(\false);
        $container->register('foo', '_PhpScoper5eddef0da618a\\Bar\\FooClass');
        $config->setDefinition('foo', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('BazClass'));
        $container->merge($config);
        ...
        $bag->get('env(Foo)');
        $config = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder($bag);
    ...
    {
        $this->expectException('_PhpScoper5eddef0da618a\\Symfony\\Component\\DependencyInjection\\Exception\\EnvNotFoundException');
    ...
    public function testEnvInId()
    {
        ...
        $expected = [\_PhpScoper5eddef0da618a\Psr\Container\ContainerInterface::class => \true, \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerInterface::class => \true, 'baz_%env(BAR)%' => \true, 'bar_%env(BAR)%' => \true];
    ...
    public function testMergeLogicException()
    {
        ...
        $container->setResourceTracking(\false);
        $container->compile();
        $container->merge(new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder());
    }
    public function testfindTaggedServiceIds()
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->register('foo', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->addTag('foo', ['foo' => 'foo'])->addTag('bar', ['bar' => 'bar'])->addTag('foo', ['foofoo' => 'foofoo']);
    ...
    {
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->register('foo', '_PhpScoper5eddef0da618a\\Bar\\FooClass')->addTag('kernel.event_listener', ['foo' => 'foo'])->addTag('kenrel.event_listener', ['bar' => 'bar']);
    ...
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->setDefinition('foo', $definition = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('_PhpScoper5eddef0da618a\\Bar\\FooClass'));
    ...
    public function testAddObjectResource()
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->setResourceTracking(\false);
        $container->addObjectResource(new \_PhpScoper5eddef0da618a\BarClass());
        ...
        $this->assertInstanceOf('_PhpScoper5eddef0da618a\\Symfony\\Component\\Config\\Resource\\FileResource', $resource);
    ...
    public function testCompilesClassDefinitionsOfLazyServices()
    {
        ...
        $container->compile();
        $matchingResources = \array_filter($container->getResources(), function (\_PhpScoper5eddef0da618a\Symfony\Component\Config\Resource\ResourceInterface $resource) {
    ...
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->addResource($a = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Resource\FileResource(__DIR__ . '/Fixtures/xml/services1.xml'));
        $container->addResource($b = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Resource\FileResource(__DIR__ . '/Fixtures/xml/services2.xml'));
        $resources = [];
    ...
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $A = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Resource\ComposerResource();
        $a = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Resource\FileResource(__DIR__ . '/Fixtures/xml/services1.xml');
        $b = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Resource\FileResource(__DIR__ . '/Fixtures/xml/services2.xml');
        $c = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Resource\DirectoryResource($dir = \dirname($b));
    ...
    public function testExtension()
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->setResourceTracking(\false);
        $container->registerExtension($extension = new \_PhpScoper5eddef0da618a\ProjectExtension());
    ...
    {
        $fooDefinition = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('BarClass');
        $fooUserDefinition = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('BarUserClass', [new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('bar')]);
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->setResourceTracking(\false);
    ...
    public function testThrowsExceptionWhenSetDefinitionOnACompiledContainer()
    {
        ...
        $container->setResourceTracking(\false);
        $container->compile();
        $container->setDefinition('a', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition());
    }
    ...
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $abstract = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('AbstractClass');
    ...
    {
        $loader = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Loader\ClosureLoader($container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder());
        $loader->load(function (\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder $container) {
            $container->set('a', new \_PhpScoper5eddef0da618a\BazClass());
            $definition = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('BazClass');
    ...
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $definition = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('BarClass');
    ...
    public function testThrowsCircularExceptionForCircularAliases()
    {
        ...
        $builder = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $builder->setAliases(['foo' => new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Alias('app.test_class'), 'app.test_class' => new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Alias('_PhpScoper5eddef0da618a\\App\\TestClass'), '_PhpScoper5eddef0da618a\\App\\TestClass' => new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Alias('app.test_class')]);
    ...
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register(\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Tests\A::class)->setPublic(\true);
        $bDefinition = $container->register('b', \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Tests\B::class);
        $bDefinition->setAutowired(\true);
        $bDefinition->setPublic(\true);
        $container->compile();
        $this->assertEquals(\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Tests\A::class, (string) $container->getDefinition('b')->getArgument(0));
    }
    public function testClassFromId()
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $unknown = $container->register('_PhpScoper5eddef0da618a\\Acme\\UnknownClass');
        $autoloadClass = $container->register(\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Tests\Fixtures\CaseSensitiveClass::class);
        $container->compile();
        $this->assertSame('_PhpScoper5eddef0da618a\\Acme\\UnknownClass', $unknown->getClass());
        $this->assertEquals(\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Tests\Fixtures\CaseSensitiveClass::class, $autoloadClass->getClass());
    }
    ...
    public function testNoClassFromNamespaceClassIdWithLeadingSlash()
    {
        ...
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('\\' . \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Tests\FooClass::class);
        $container->compile();
    }
    ...
    public function testServiceLocator()
    {
        ...
        $container->compile();
        $this->assertInstanceOf(\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ServiceLocator::class, $foo = $container->get('foo_service'));
    ...
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('class.via.bindings', \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Tests\Fixtures\CaseSensitiveClass::class)->setArguments(['via-bindings']);
        $container->register('class.via.argument', \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Tests\Fixtures\CaseSensitiveClass::class)->setArguments(['via-argument']);
        $container->register('foo', \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Tests\Fixtures\SimilarArgumentsDummy::class)->setPublic(\true)->setBindings([\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Tests\Fixtures\CaseSensitiveClass::class => new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('class.via.bindings'), '$token' => '1234'])->setArguments(['$class1' => new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('class.via.argument')]);
        $this->assertSame(['service_container', 'class.via.bindings', 'class.via.argument', 'foo', '_PhpScoper5eddef0da618a\\Psr\\Container\\ContainerInterface', '_PhpScoper5eddef0da618a\\Symfony\\Component\\DependencyInjection\\ContainerInterface'], $container->getServiceIds());
        $container->compile();
    ...
    public function testUninitializedSyntheticReference()
    {
        ...
        $container->register('bar', 'stdClass')->setPublic(\true)->setShared(\false)->setProperty('foo', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('foo', \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE));
        $container->compile();
    ...
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo', 'stdClass')->setPublic(\false)->setProperty('bar', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('foo'));
        $container->register('baz', 'stdClass')->setPublic(\false)->setProperty('inner', new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('baz.inner'))->setDecoratedService('foo');
        $container->compile();
        $this->assertSame(['service_container'], \array_keys($container->getDefinitions()));
    }
    public function testScalarService()
    {
        $c = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $c->register('foo', 'string')->setPublic(\true)->setFactory([\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Tests\Fixtures\ScalarFactory::class, 'getSomeValue']);
        $c->compile();
...
class B
{
    public function __construct(\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Tests\A $a)
    {
    }
}
