...
class ServiceLocatorTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    public function testHas()
    {
        $locator = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ServiceLocator(['foo' => function () {
            return 'bar';
        }, 'bar' => function () {
            return 'baz';
        }, function () {
    ...
    {
        $i = 0;
        $locator = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ServiceLocator(['foo' => function () use(&$i) {
            ++$i;
            return 'bar';
        }]);
        $this->assertSame('bar', $locator->get('foo'));
    ...
    {
        $this->expectException('_PhpScoper5ece82d7231e4\\Psr\\Container\\NotFoundExceptionInterface');
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        ...
        $locator = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ServiceLocator(['foo' => function () use(&$locator) {
    ...
    public function testThrowsInServiceSubscriber()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Container();
        $container->set('foo', new \stdClass());
        $subscriber = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\SomeServiceSubscriber();
        $subscriber->container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ServiceLocator(['bar' => function () {
        }]);
    ...
    public function testGetThrowsServiceNotFoundException()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Container();
        $container->set('foo', new \stdClass());
        $locator = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ServiceLocator([]);
...
class SomeServiceSubscriber implements \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ServiceSubscriberInterface
{
    public $container;
