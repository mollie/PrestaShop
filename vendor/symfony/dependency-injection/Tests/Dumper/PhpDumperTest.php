...
use MolliePrefix\Symfony\Component\DependencyInjection\ContainerInterface as SymfonyContainerInterface;
...
use MolliePrefix\Symfony\Component\DependencyInjection\Tests\Fixtures\StubbedTranslator;
...
use MolliePrefix\Symfony\Component\DependencyInjection\Variable;
use MolliePrefix\Symfony\Component\ExpressionLanguage\Expression;
require_once __DIR__ . '/../Fixtures/includes/classes.php';
class PhpDumperTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    ...
    public function testDump()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath . '/php/services1-1.php', $dumper->dump(['class' => 'Container', 'base_class' => 'AbstractContainer', 'namespace' => 'MolliePrefix\\Symfony\\Component\\DependencyInjection\\Dump']), '->dump() takes a class and a base_class options');
    }
    ...
    public function testDumpCustomContainerClassWithoutConstructor()
    {
        ...
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $this->assertStringEqualsFile(self::$fixturesPath . '/php/custom_container_class_without_constructor.php', $dumper->dump(['base_class' => 'NoConstructorContainer', 'namespace' => 'MolliePrefix\\Symfony\\Component\\DependencyInjection\\Tests\\Fixtures\\Container']));
    }
    public function testDumpCustomContainerClassConstructorWithoutArguments()
    {
        ...
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $this->assertStringEqualsFile(self::$fixturesPath . '/php/custom_container_class_constructor_without_arguments.php', $dumper->dump(['base_class' => 'ConstructorWithoutArgumentsContainer', 'namespace' => 'MolliePrefix\\Symfony\\Component\\DependencyInjection\\Tests\\Fixtures\\Container']));
    }
    public function testDumpCustomContainerClassWithOptionalArgumentLessConstructor()
    {
        ...
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $this->assertStringEqualsFile(self::$fixturesPath . '/php/custom_container_class_with_optional_constructor_arguments.php', $dumper->dump(['base_class' => 'ConstructorWithOptionalArgumentsContainer', 'namespace' => 'MolliePrefix\\Symfony\\Component\\DependencyInjection\\Tests\\Fixtures\\Container']));
    }
    public function testDumpCustomContainerClassWithMandatoryArgumentLessConstructor()
    {
        ...
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $this->assertStringEqualsFile(self::$fixturesPath . '/php/custom_container_class_with_mandatory_constructor_arguments.php', $dumper->dump(['base_class' => 'ConstructorWithMandatoryArgumentsContainer', 'namespace' => 'MolliePrefix\\Symfony\\Component\\DependencyInjection\\Tests\\Fixtures\\Container']));
    }
    /**
    ...
    public function testExportParameters($parameters)
    {
        ...
        $container = new \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder(new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($parameters));
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $dumper->dump();
    }
    ...
    {
        return [[['foo' => new \MolliePrefix\Symfony\Component\DependencyInjection\Definition('stdClass')]], [['foo' => new \MolliePrefix\Symfony\Component\ExpressionLanguage\Expression('service("foo").foo() ~ (container.hasParameter("foo") ? parameter("foo") : "default")')]], [['foo' => new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('foo')]], [['foo' => new \MolliePrefix\Symfony\Component\DependencyInjection\Variable('foo')]]];
    }
    ...
    public function testAddService()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException', $e, '->dump() throws a RuntimeException if the container to be dumped has reference to objects or resources');
    ...
    public function testConflictingMethodsWithParent()
    {
        ...
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        eval('?>' . $dumper->dump(['class' => $class, 'base_class' => 'MolliePrefix\\Symfony\\Component\\DependencyInjection\\Tests\\Fixtures\\containers\\CustomContainer']));
        $this->assertTrue(\method_exists($class, 'getBar2Service'));
        $this->assertTrue(\method_exists($class, 'getFoobar2Service'));
    }
    /**
    ...
    public function testAliases()
    {
        ...
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Aliases();
    ...
    public function testFrozenContainerWithoutAliases()
    {
        ...
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Frozen_No_Aliases();
    ...
    public function testOverrideServiceWhenUsingADumpedContainer()
    {
        ...
        $container = new \MolliePrefix\ProjectServiceContainer();
    ...
    public function testEnvParameter()
    {
        ...
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_EnvParameters();
    ...
    public function testDumpedBase64EnvParameters()
    {
        ...
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Base64Parameters();
    ...
    public function testCustomEnvParameters()
    {
        ...
        $container->register(\MolliePrefix\Symfony\Component\DependencyInjection\Tests\Dumper\Rot13EnvVarProcessor::class)->addTag('container.env_var_processor')->setPublic(\true);
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $dumper->dump();
        ...
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Rot13Parameters();
        $this->assertSame('world', $container->getParameter('hello'));
    }
    ...
    {
        $container = new \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo', 'stdClass')->addMethodCall('add', [new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('service_container')])->setPublic(\false);
        $container->register('bar', 'stdClass')->addArgument(new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('foo'))->setPublic(\true);
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
    ...
    public function testNonSharedLazyDefinitionReferences()
    {
        ...
        $container->register('bar', 'stdClass')->addArgument(new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('foo', \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder::EXCEPTION_ON_INVALID_REFERENCE, \false));
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $dumper->setProxyDumper(new \MolliePrefix\DummyProxyDumper());
    ...
    public function testInitializePropertiesBeforeMethodCalls()
    {
        ...
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Properties_Before_Method_Calls();
        $this->assertTrue($container->get('bar')->callPassed(), '->dump() initializes properties before method calls');
    }
    public function testCircularReferenceAllowanceForLazyServices()
    {
        $container = new \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo', 'stdClass')->addArgument(new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('bar'))->setPublic(\true);
        $container->register('bar', 'stdClass')->setLazy(\true)->addArgument(new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('foo'))->setPublic(\true);
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $dumper->setProxyDumper(new \MolliePrefix\DummyProxyDumper());
        $dumper->dump();
        ...
        $this->expectException(\MolliePrefix\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException::class);
    ...
    public function testLazyArgumentProvideGenerator()
    {
        ...
        $container->register('lazy_context', 'LazyContext')->setPublic(\true)->setArguments([new \MolliePrefix\Symfony\Component\DependencyInjection\Argument\IteratorArgument(['k1' => new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('lazy_referenced'), 'k2' => new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('service_container')]), new \MolliePrefix\Symfony\Component\DependencyInjection\Argument\IteratorArgument([])]);
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        eval('?>' . $dumper->dump(['class' => 'Symfony_DI_PhpDumper_Test_Lazy_Argument_Provide_Generator']));
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Lazy_Argument_Provide_Generator();
    ...
    {
        $container = new \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo_service', 'stdClass')->setArguments([new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('baz_service')])->setPublic(\true);
    ...
    {
        $container = new \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo_service', \MolliePrefix\Symfony\Component\DependencyInjection\ServiceLocator::class)->setPublic(\true)->addArgument(['bar' => new \MolliePrefix\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('bar_service')), 'baz' => new \MolliePrefix\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \MolliePrefix\Symfony\Component\DependencyInjection\TypedReference('baz_service', 'stdClass')), 'nil' => $nil = new \MolliePrefix\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('nil'))]);
        // no method calls
        $container->register('translator.loader_1', 'stdClass')->setPublic(\true);
        $container->register('translator.loader_1_locator', \MolliePrefix\Symfony\Component\DependencyInjection\ServiceLocator::class)->setPublic(\false)->addArgument(['translator.loader_1' => new \MolliePrefix\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('translator.loader_1'))]);
        $container->register('translator_1', \MolliePrefix\Symfony\Component\DependencyInjection\Tests\Fixtures\StubbedTranslator::class)->setPublic(\true)->addArgument(new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('translator.loader_1_locator'));
        // one method calls
        $container->register('translator.loader_2', 'stdClass')->setPublic(\true);
        $container->register('translator.loader_2_locator', \MolliePrefix\Symfony\Component\DependencyInjection\ServiceLocator::class)->setPublic(\false)->addArgument(['translator.loader_2' => new \MolliePrefix\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('translator.loader_2'))]);
        $container->register('translator_2', \MolliePrefix\Symfony\Component\DependencyInjection\Tests\Fixtures\StubbedTranslator::class)->setPublic(\true)->addArgument(new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('translator.loader_2_locator'))->addMethodCall('addResource', ['db', new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('translator.loader_2'), 'nl']);
        // two method calls
        $container->register('translator.loader_3', 'stdClass')->setPublic(\true);
        $container->register('translator.loader_3_locator', \MolliePrefix\Symfony\Component\DependencyInjection\ServiceLocator::class)->setPublic(\false)->addArgument(['translator.loader_3' => new \MolliePrefix\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('translator.loader_3'))]);
        $container->register('translator_3', \MolliePrefix\Symfony\Component\DependencyInjection\Tests\Fixtures\StubbedTranslator::class)->setPublic(\true)->addArgument(new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('translator.loader_3_locator'))->addMethodCall('addResource', ['db', new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('translator.loader_3'), 'nl'])->addMethodCall('addResource', ['db', new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('translator.loader_3'), 'en']);
        $nil->setValues([null]);
        $container->register('bar_service', 'stdClass')->setArguments([new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('baz_service')])->setPublic(\true);
        $container->register('baz_service', 'stdClass')->setPublic(\false);
        $container->compile();
    ...
    {
        $container = new \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo_service', \MolliePrefix\Symfony\Component\DependencyInjection\Tests\Fixtures\TestServiceSubscriber::class)->setPublic(\true)->setAutowired(\true)->addArgument(new \MolliePrefix\Symfony\Component\DependencyInjection\Reference(\MolliePrefix\Psr\Container\ContainerInterface::class))->addTag('container.service_subscriber', ['key' => 'bar', 'id' => \MolliePrefix\Symfony\Component\DependencyInjection\Tests\Fixtures\TestServiceSubscriber::class]);
        $container->register(\MolliePrefix\Symfony\Component\DependencyInjection\Tests\Fixtures\TestServiceSubscriber::class, \MolliePrefix\Symfony\Component\DependencyInjection\Tests\Fixtures\TestServiceSubscriber::class)->setPublic(\true);
        $container->register(\MolliePrefix\Symfony\Component\DependencyInjection\Tests\Fixtures\CustomDefinition::class, \MolliePrefix\Symfony\Component\DependencyInjection\Tests\Fixtures\CustomDefinition::class)->setPublic(\false);
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
    ...
    public function testPrivateWithIgnoreOnInvalidReference()
    {
        ...
        $container->register('bar', 'BarClass')->setPublic(\true)->addMethodCall('setBaz', [new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('not_invalid', \MolliePrefix\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_INVALID_REFERENCE)]);
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        eval('?>' . $dumper->dump(['class' => 'Symfony_DI_PhpDumper_Test_Private_With_Ignore_On_Invalid_Reference']));
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Private_With_Ignore_On_Invalid_Reference();
    ...
    public function testExpressionReferencingPrivateService()
    {
        ...
        $container->register('public_foo', 'stdClass')->setPublic(\true)->addArgument(new \MolliePrefix\Symfony\Component\ExpressionLanguage\Expression('service("private_foo").bar'));
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
    ...
    public function testUninitializedReference()
    {
        ...
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Uninitialized_Reference();
    ...
    public function testDeepServiceGraph()
    {
        ...
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Deep_Graph();
        $this->assertInstanceOf(\MolliePrefix\Symfony\Component\DependencyInjection\Tests\Dumper\FooForDeepGraph::class, $container->get('foo'));
        $this->assertEquals((object) ['p2' => (object) ['p3' => (object) []]], $container->get('foo')->bClone);
    }
    public function testInlineSelfRef()
    {
        $container = new \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder();
        $bar = (new \MolliePrefix\Symfony\Component\DependencyInjection\Definition('MolliePrefix\\App\\Bar'))->setProperty('foo', new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('MolliePrefix\\App\\Foo'));
        $baz = (new \MolliePrefix\Symfony\Component\DependencyInjection\Definition('MolliePrefix\\App\\Baz'))->setProperty('bar', $bar)->addArgument($bar);
        $container->register('MolliePrefix\\App\\Foo')->setPublic(\true)->addArgument($baz);
    ...
    public function testDumpHandlesLiteralClassWithRootNamespace()
    {
        ...
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Literal_Class_With_Root_Namespace();
        $this->assertInstanceOf('stdClass', $container->get('foo'));
    }
    public function testDumpHandlesObjectClassNames()
    {
        $container = new \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder(new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['class' => 'stdClass']));
        $container->setDefinition('foo', new \MolliePrefix\Symfony\Component\DependencyInjection\Definition(new \MolliePrefix\Symfony\Component\DependencyInjection\Parameter('class')));
        $container->setDefinition('bar', new \MolliePrefix\Symfony\Component\DependencyInjection\Definition('stdClass', [new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('foo')]))->setPublic(\true);
        $container->setParameter('inline_requires', \true);
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        eval('?>' . $dumper->dump(['class' => 'Symfony_DI_PhpDumper_Test_Object_Class_Name', 'inline_class_loader_parameter' => 'inline_requires']));
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Object_Class_Name();
    ...
    public function testUninitializedSyntheticReference()
    {
        ...
        $container->register('bar', 'stdClass')->setPublic(\true)->setShared(\false)->setProperty('foo', new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('foo', \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE));
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        ...
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_UninitializedSyntheticReference();
    ...
    public function testLegacyPrivateServices()
    {
        ...
        $container->setDefinition('private_child', new \MolliePrefix\Symfony\Component\DependencyInjection\ChildDefinition('foo'));
        $container->setDefinition('private_parent', new \MolliePrefix\Symfony\Component\DependencyInjection\ChildDefinition('private'));
        ...
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Legacy_Privates();
    ...
    public function testPrivateServiceTriggersDeprecation()
    {
        ...
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Private_Service_Triggers_Deprecation();
        $container->get('bar');
    }
    /**
     * @group legacy
    ...
    {
        $container = new \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder(new \MolliePrefix\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['Foo' => 'bar', 'BAR' => 'foo']));
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        eval('?>' . $dumper->dump(['class' => 'Symfony_DI_PhpDumper_Test_Parameter_With_Mixed_Case']));
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Parameter_With_Mixed_Case();
    ...
    public function testParameterWithLowerCase()
    {
        ...
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Parameter_With_Lower_Case();
        $this->assertSame('bar', $container->getParameter('FOO'));
    }
    /**
     * @group legacy
    ...
    {
        $container = new \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('Bar', 'stdClass')->setProperty('foo', new \MolliePrefix\Symfony\Component\DependencyInjection\Reference('foo'))->setPublic(\true);
        ...
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Reference_With_Lower_Case_Id();
        $this->assertEquals((object) ['foo' => (object) []], $container->get('Bar'));
    }
    public function testScalarService()
    {
        $container = new \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo', 'string')->setPublic(\true)->setFactory([\MolliePrefix\Symfony\Component\DependencyInjection\Tests\Fixtures\ScalarFactory::class, 'getSomeValue']);
        $container->compile();
        $dumper = new \MolliePrefix\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        eval('?>' . $dumper->dump(['class' => 'Symfony_DI_PhpDumper_Test_Scalar_Service']));
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_Test_Scalar_Service();
    ...
    public function testAliasCanBeFoundInTheDumpedContainerWhenBothTheAliasAndTheServiceArePublic()
    {
        ...
        eval('?>' . $dump);
        $container = new \MolliePrefix\Symfony_DI_PhpDumper_AliasesCanBeFoundInTheDumpedContainer();
        // Bar should still be found in the compiled container
        $service_ids = $container->getServiceIds();
        $this->assertContains('bar', $service_ids);
    }
}
class Rot13EnvVarProcessor implements \MolliePrefix\Symfony\Component\DependencyInjection\EnvVarProcessorInterface
{
