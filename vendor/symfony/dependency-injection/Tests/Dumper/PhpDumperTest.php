...
use _PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerInterface as SymfonyContainerInterface;
...
use _PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\StubbedTranslator;
use _PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\TestServiceSubscriber;
...
class PhpDumperTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    ...
    public function testDump()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath . '/php/services1-1.php', $dumper->dump(['class' => 'Container', 'base_class' => 'AbstractContainer', 'namespace' => '_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Dump']), '->dump() takes a class and a base_class options');
    }
    ...
    public function testDumpCustomContainerClassWithoutConstructor()
    {
        ...
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $this->assertStringEqualsFile(self::$fixturesPath . '/php/custom_container_class_without_constructor.php', $dumper->dump(['base_class' => 'NoConstructorContainer', 'namespace' => '_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Tests\\Fixtures\\Container']));
    }
    public function testDumpCustomContainerClassConstructorWithoutArguments()
    {
        ...
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $this->assertStringEqualsFile(self::$fixturesPath . '/php/custom_container_class_constructor_without_arguments.php', $dumper->dump(['base_class' => 'ConstructorWithoutArgumentsContainer', 'namespace' => '_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Tests\\Fixtures\\Container']));
    }
    public function testDumpCustomContainerClassWithOptionalArgumentLessConstructor()
    {
        ...
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $this->assertStringEqualsFile(self::$fixturesPath . '/php/custom_container_class_with_optional_constructor_arguments.php', $dumper->dump(['base_class' => 'ConstructorWithOptionalArgumentsContainer', 'namespace' => '_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Tests\\Fixtures\\Container']));
    }
    public function testDumpCustomContainerClassWithMandatoryArgumentLessConstructor()
    {
        ...
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $this->assertStringEqualsFile(self::$fixturesPath . '/php/custom_container_class_with_mandatory_constructor_arguments.php', $dumper->dump(['base_class' => 'ConstructorWithMandatoryArgumentsContainer', 'namespace' => '_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Tests\\Fixtures\\Container']));
    }
    /**
    ...
    public function testExportParameters($parameters)
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($parameters));
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $dumper->dump();
    }
    ...
    {
        return [[['foo' => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Definition('stdClass')]], [['foo' => new \_PhpScoper5ece82d7231e4\Symfony\Component\ExpressionLanguage\Expression('service("foo").foo() ~ (container.hasParameter("foo") ? parameter("foo") : "default")')]], [['foo' => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('foo')]], [['foo' => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Variable('foo')]]];
    }
    ...
    public function testAddService()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException', $e, '->dump() throws a RuntimeException if the container to be dumped has reference to objects or resources');
    ...
    public function testConflictingMethodsWithParent()
    {
        ...
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        eval('?>' . $dumper->dump(['class' => $class, 'base_class' => '_PhpScoper5ece82d7231e4\\Symfony\\Component\\DependencyInjection\\Tests\\Fixtures\\containers\\CustomContainer']));
        $this->assertTrue(\method_exists($class, 'getBar2Service'));
        $this->assertTrue(\method_exists($class, 'getFoobar2Service'));
    }
    /**
    ...
    public function testAliases()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Aliases();
    ...
    public function testFrozenContainerWithoutAliases()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Frozen_No_Aliases();
    ...
    public function testOverrideServiceWhenUsingADumpedContainer()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\ProjectServiceContainer();
    ...
    public function testEnvParameter()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_EnvParameters();
    ...
    public function testDumpedBase64EnvParameters()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Base64Parameters();
    ...
    public function testCustomEnvParameters()
    {
        ...
        $container->register(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Dumper\Rot13EnvVarProcessor::class)->addTag('container.env_var_processor')->setPublic(\true);
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $dumper->dump();
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Rot13Parameters();
        $this->assertSame('world', $container->getParameter('hello'));
    }
    ...
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo', 'stdClass')->addMethodCall('add', [new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('service_container')])->setPublic(\false);
        $container->register('bar', 'stdClass')->addArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('foo'))->setPublic(\true);
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
    ...
    public function testNonSharedLazyDefinitionReferences()
    {
        ...
        $container->register('bar', 'stdClass')->addArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('foo', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder::EXCEPTION_ON_INVALID_REFERENCE, \false));
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $dumper->setProxyDumper(new \_PhpScoper5ece82d7231e4\DummyProxyDumper());
    ...
    public function testInitializePropertiesBeforeMethodCalls()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Properties_Before_Method_Calls();
        $this->assertTrue($container->get('bar')->callPassed(), '->dump() initializes properties before method calls');
    }
    public function testCircularReferenceAllowanceForLazyServices()
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo', 'stdClass')->addArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('bar'))->setPublic(\true);
        $container->register('bar', 'stdClass')->setLazy(\true)->addArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('foo'))->setPublic(\true);
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        $dumper->setProxyDumper(new \_PhpScoper5ece82d7231e4\DummyProxyDumper());
        $dumper->dump();
        ...
        $this->expectException(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException::class);
    ...
    public function testLazyArgumentProvideGenerator()
    {
        ...
        $container->register('lazy_context', 'LazyContext')->setPublic(\true)->setArguments([new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Argument\IteratorArgument(['k1' => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('lazy_referenced'), 'k2' => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('service_container')]), new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Argument\IteratorArgument([])]);
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        eval('?>' . $dumper->dump(['class' => 'Symfony_DI_PhpDumper_Test_Lazy_Argument_Provide_Generator']));
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Lazy_Argument_Provide_Generator();
    ...
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo_service', 'stdClass')->setArguments([new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('baz_service')])->setPublic(\true);
    ...
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo_service', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ServiceLocator::class)->setPublic(\true)->addArgument(['bar' => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('bar_service')), 'baz' => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\TypedReference('baz_service', 'stdClass')), 'nil' => $nil = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('nil'))]);
        // no method calls
        $container->register('translator.loader_1', 'stdClass')->setPublic(\true);
        $container->register('translator.loader_1_locator', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ServiceLocator::class)->setPublic(\false)->addArgument(['translator.loader_1' => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('translator.loader_1'))]);
        $container->register('translator_1', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\StubbedTranslator::class)->setPublic(\true)->addArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('translator.loader_1_locator'));
        // one method calls
        $container->register('translator.loader_2', 'stdClass')->setPublic(\true);
        $container->register('translator.loader_2_locator', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ServiceLocator::class)->setPublic(\false)->addArgument(['translator.loader_2' => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('translator.loader_2'))]);
        $container->register('translator_2', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\StubbedTranslator::class)->setPublic(\true)->addArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('translator.loader_2_locator'))->addMethodCall('addResource', ['db', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('translator.loader_2'), 'nl']);
        // two method calls
        $container->register('translator.loader_3', 'stdClass')->setPublic(\true);
        $container->register('translator.loader_3_locator', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ServiceLocator::class)->setPublic(\false)->addArgument(['translator.loader_3' => new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('translator.loader_3'))]);
        $container->register('translator_3', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\StubbedTranslator::class)->setPublic(\true)->addArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('translator.loader_3_locator'))->addMethodCall('addResource', ['db', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('translator.loader_3'), 'nl'])->addMethodCall('addResource', ['db', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('translator.loader_3'), 'en']);
        $nil->setValues([null]);
        $container->register('bar_service', 'stdClass')->setArguments([new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('baz_service')])->setPublic(\true);
        $container->register('baz_service', 'stdClass')->setPublic(\false);
        $container->compile();
    ...
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo_service', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\TestServiceSubscriber::class)->setPublic(\true)->setAutowired(\true)->addArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference(\_PhpScoper5ece82d7231e4\Psr\Container\ContainerInterface::class))->addTag('container.service_subscriber', ['key' => 'bar', 'id' => \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\TestServiceSubscriber::class]);
        $container->register(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\TestServiceSubscriber::class, \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\TestServiceSubscriber::class)->setPublic(\true);
        $container->register(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\CustomDefinition::class, \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\CustomDefinition::class)->setPublic(\false);
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
    ...
    public function testPrivateWithIgnoreOnInvalidReference()
    {
        ...
        $container->register('bar', 'BarClass')->setPublic(\true)->addMethodCall('setBaz', [new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('not_invalid', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_INVALID_REFERENCE)]);
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        eval('?>' . $dumper->dump(['class' => 'Symfony_DI_PhpDumper_Test_Private_With_Ignore_On_Invalid_Reference']));
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Private_With_Ignore_On_Invalid_Reference();
    ...
    public function testExpressionReferencingPrivateService()
    {
        ...
        $container->register('public_foo', 'stdClass')->setPublic(\true)->addArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\ExpressionLanguage\Expression('service("private_foo").bar'));
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
    ...
    public function testUninitializedReference()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Uninitialized_Reference();
    ...
    public function testDeepServiceGraph()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Deep_Graph();
        $this->assertInstanceOf(\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Dumper\FooForDeepGraph::class, $container->get('foo'));
        $this->assertEquals((object) ['p2' => (object) ['p3' => (object) []]], $container->get('foo')->bClone);
    }
    public function testInlineSelfRef()
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $bar = (new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Definition('_PhpScoper5ece82d7231e4\\App\\Bar'))->setProperty('foo', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('_PhpScoper5ece82d7231e4\\App\\Foo'));
        $baz = (new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Definition('_PhpScoper5ece82d7231e4\\App\\Baz'))->setProperty('bar', $bar)->addArgument($bar);
        $container->register('_PhpScoper5ece82d7231e4\\App\\Foo')->setPublic(\true)->addArgument($baz);
    ...
    public function testDumpHandlesLiteralClassWithRootNamespace()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Literal_Class_With_Root_Namespace();
        $this->assertInstanceOf('stdClass', $container->get('foo'));
    }
    public function testDumpHandlesObjectClassNames()
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['class' => 'stdClass']));
        $container->setDefinition('foo', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Definition(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Parameter('class')));
        $container->setDefinition('bar', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Definition('stdClass', [new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('foo')]))->setPublic(\true);
        $container->setParameter('inline_requires', \true);
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        eval('?>' . $dumper->dump(['class' => 'Symfony_DI_PhpDumper_Test_Object_Class_Name', 'inline_class_loader_parameter' => 'inline_requires']));
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Object_Class_Name();
    ...
    public function testUninitializedSyntheticReference()
    {
        ...
        $container->register('bar', 'stdClass')->setPublic(\true)->setShared(\false)->setProperty('foo', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('foo', \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder::IGNORE_ON_UNINITIALIZED_REFERENCE));
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_UninitializedSyntheticReference();
    ...
    public function testLegacyPrivateServices()
    {
        ...
        $container->setDefinition('private_child', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ChildDefinition('foo'));
        $container->setDefinition('private_parent', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ChildDefinition('private'));
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Legacy_Privates();
    ...
    public function testPrivateServiceTriggersDeprecation()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Private_Service_Triggers_Deprecation();
        $container->get('bar');
    }
    /**
     * @group legacy
    ...
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(['Foo' => 'bar', 'BAR' => 'foo']));
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        eval('?>' . $dumper->dump(['class' => 'Symfony_DI_PhpDumper_Test_Parameter_With_Mixed_Case']));
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Parameter_With_Mixed_Case();
    ...
    public function testParameterWithLowerCase()
    {
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Parameter_With_Lower_Case();
        $this->assertSame('bar', $container->getParameter('FOO'));
    }
    /**
     * @group legacy
    ...
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('Bar', 'stdClass')->setProperty('foo', new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('foo'))->setPublic(\true);
        ...
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Reference_With_Lower_Case_Id();
        $this->assertEquals((object) ['foo' => (object) []], $container->get('Bar'));
    }
    public function testScalarService()
    {
        $container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo', 'string')->setPublic(\true)->setFactory([\_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Tests\Fixtures\ScalarFactory::class, 'getSomeValue']);
        $container->compile();
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\PhpDumper($container);
        eval('?>' . $dumper->dump(['class' => 'Symfony_DI_PhpDumper_Test_Scalar_Service']));
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_Test_Scalar_Service();
    ...
    public function testAliasCanBeFoundInTheDumpedContainerWhenBothTheAliasAndTheServiceArePublic()
    {
        ...
        eval('?>' . $dump);
        $container = new \_PhpScoper5ece82d7231e4\Symfony_DI_PhpDumper_AliasesCanBeFoundInTheDumpedContainer();
        // Bar should still be found in the compiled container
        $service_ids = $container->getServiceIds();
        $this->assertContains('bar', $service_ids);
    }
}
class Rot13EnvVarProcessor implements \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\EnvVarProcessorInterface
{
