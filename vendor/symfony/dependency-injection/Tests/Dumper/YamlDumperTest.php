...
use _PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Dumper\YamlDumper;
...
class YamlDumperTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    ...
    {
        $dumper = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Dumper\YamlDumper($container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder());
    ...
    public function testAddParameters()
    {
        ...
        $dumper = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Dumper\YamlDumper($container);
    ...
    {
        $container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $container->register('foo', 'Class1')->setPublic(\true)->addArgument((new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('Class2'))->addArgument(new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('Class2')));
        $dumper = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Dumper\YamlDumper($container);
    ...
    private function assertEqualYamlStructure($expected, $yaml, $message = '')
    {
        ...
        $this->assertEquals($parser->parse($expected, \_PhpScoper5eddef0da618a\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS), $parser->parse($yaml, \_PhpScoper5eddef0da618a\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS), $message);
    }
}
