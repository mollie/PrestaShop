...
use _PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\GraphvizDumper;
use _PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference;
class GraphvizDumperTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    ...
    {
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\GraphvizDumper($container = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder());
        ...
        $dumper = new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Dumper\GraphvizDumper($container);
    ...
    public function testDumpWithInlineDefinition()
    {
        ...
        $container->register('foo', 'stdClass')->addArgument((new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Definition('stdClass'))->addArgument(new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference('bar')));
