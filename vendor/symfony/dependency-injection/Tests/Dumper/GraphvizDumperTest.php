...
use _PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Dumper\GraphvizDumper;
use _PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference;
class GraphvizDumperTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    ...
    {
        $dumper = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Dumper\GraphvizDumper($container = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder());
        ...
        $dumper = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Dumper\GraphvizDumper($container);
    ...
    public function testDumpWithInlineDefinition()
    {
        ...
        $container->register('foo', 'stdClass')->addArgument((new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Definition('stdClass'))->addArgument(new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\Reference('bar')));
