...
class CrossCheckTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    ...
    public function testCrossCheck($fixture, $type)
    {
        ...
        $container1 = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $loader1 = new $loaderClass($container1, new \_PhpScoper5eddef0da618a\Symfony\Component\Config\FileLocator());
        $loader1->load($tmp);
        $dumper = new $dumperClass($container1);
        \file_put_contents($tmp, $dumper->dump());
        $container2 = new \_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder();
        $loader2 = new $loaderClass($container2, new \_PhpScoper5eddef0da618a\Symfony\Component\Config\FileLocator());
        $loader2->load($tmp);
        \unlink($tmp);
        ...
        $r = new \ReflectionProperty(\_PhpScoper5eddef0da618a\Symfony\Component\DependencyInjection\ContainerBuilder::class, 'normalizedIds');
        $r->setAccessible(\true);
