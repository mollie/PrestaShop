...
\class_exists(\MolliePrefix\Symfony\Component\DependencyInjection\ChildDefinition::class);
if (\false) {
    /**
     ...
     */
    class DefinitionDecorator extends \MolliePrefix\Symfony\Component\DependencyInjection\Definition
    {
    }
}
