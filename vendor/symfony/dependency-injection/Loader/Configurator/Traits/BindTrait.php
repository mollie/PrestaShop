...
trait BindTrait
{
    ...
    public final function bind($nameOrFqcn, $valueOrRef)
    {
        ...
        if (isset($nameOrFqcn[0]) && '$' !== $nameOrFqcn[0] && !$valueOrRef instanceof \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference) {
            throw new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('Invalid binding for service "%s": named arguments must start with a "$", and FQCN must map to references. Neither applies to binding "%s".', $this->id, $nameOrFqcn));
        }
