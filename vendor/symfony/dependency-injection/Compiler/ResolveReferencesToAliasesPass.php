 ...
 */
class ResolveReferencesToAliasesPass extends \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function processValue($value, $isRoot = \false)
    {
        if ($value instanceof \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference) {
            ...
            if ($defId !== $id) {
                return new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Reference($defId, $value->getInvalidBehavior());
            }
        }
     ...
     */
    private function getDefinitionId($id, \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        $seen = [];
        while ($container->hasAlias($id)) {
            if (isset($seen[$id])) {
                throw new \_PhpScoper5ece82d7231e4\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_merge(\array_keys($seen), [$id]));
            }
            $seen[$id] = \true;
