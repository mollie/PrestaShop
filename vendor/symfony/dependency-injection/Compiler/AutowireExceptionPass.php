 ...
 */
class AutowireExceptionPass implements \MolliePrefix\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $autowirePass;
    private $inlineServicePass;
    public function __construct(\MolliePrefix\Symfony\Component\DependencyInjection\Compiler\AutowirePass $autowirePass, \MolliePrefix\Symfony\Component\DependencyInjection\Compiler\InlineServiceDefinitionsPass $inlineServicePass)
    {
    ...
    private function doesServiceExistInTheContainer($serviceId, \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder $container, array $inlinedIds)
    {
