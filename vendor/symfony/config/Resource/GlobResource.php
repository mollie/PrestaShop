...
use _PhpScoper5eddef0da618a\Symfony\Component\Finder\Finder;
use _PhpScoper5eddef0da618a\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \_PhpScoper5eddef0da618a\Symfony\Component\Config\Resource\SelfCheckingResourceInterface, \Serializable
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator()
    {
        ...
        if (!\class_exists(\_PhpScoper5eddef0da618a\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \_PhpScoper5eddef0da618a\Symfony\Component\Finder\Finder();
        $regex = \_PhpScoper5eddef0da618a\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
