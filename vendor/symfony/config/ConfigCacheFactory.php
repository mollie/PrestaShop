 ...
 */
class ConfigCacheFactory implements \_PhpScoper5eddef0da618a\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    private $debug;
    /**
    ...
    public function cache($file, $callback)
    {
        ...
        $cache = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\ConfigCache($file, $this->debug);
        if (!$cache->isFresh()) {
