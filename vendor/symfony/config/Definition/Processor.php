...
class Processor
{
     ...
     */
    public function process(\MolliePrefix\Symfony\Component\Config\Definition\NodeInterface $configTree, array $configs)
    {
        $currentConfig = [];
     ...
     * @return array The processed configuration
     */
    public function processConfiguration(\MolliePrefix\Symfony\Component\Config\Definition\ConfigurationInterface $configuration, array $configs)
    {
