...
{
    private $reference;
    public function dump(\_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ConfigurationInterface $configuration, $namespace = null)
    {
        return $this->dumpNode($configuration->getConfigTreeBuilder()->buildTree(), $namespace);
    }
    public function dumpNode(\_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\NodeInterface $node, $namespace = null)
    {
        $this->reference = '';
     ...
     */
    private function writeNode(\_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\NodeInterface $node, $depth = 0, $root = \false, $namespace = null)
    {
        ...
        if ($node instanceof \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ArrayNode) {
            ...
            if ($node instanceof \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\PrototypedArrayNode) {
                ...
                if ($prototype instanceof \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\PrototypedArrayNode) {
                    $prototype->setName($key);
                    $children = [$key => $prototype];
                } elseif ($prototype instanceof \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ArrayNode) {
            ...
            foreach ($children as $child) {
                if (!$child instanceof \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ArrayNode) {
                    // get attributes
                    // metadata
                    ...
                    if ($child instanceof \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\EnumNode) {
