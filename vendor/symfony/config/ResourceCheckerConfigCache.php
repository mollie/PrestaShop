 ...
 */
class ResourceCheckerConfigCache implements \MolliePrefix\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        ...
        if (\function_exists('MolliePrefix\\opcache_invalidate') && \filter_var(\ini_get('opcache.enable'), \FILTER_VALIDATE_BOOLEAN)) {
