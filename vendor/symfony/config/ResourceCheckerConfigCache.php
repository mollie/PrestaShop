 ...
 */
class ResourceCheckerConfigCache implements \_PhpScoper5eddef0da618a\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \_PhpScoper5eddef0da618a\Symfony\Component\Filesystem\Filesystem();
