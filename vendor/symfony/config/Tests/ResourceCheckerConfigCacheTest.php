...
use _PhpScoper5eddef0da618a\Symfony\Component\Config\ResourceCheckerConfigCache;
use _PhpScoper5eddef0da618a\Symfony\Component\Config\Tests\Resource\ResourceStub;
class ResourceCheckerConfigCacheTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    ...
    {
        $cache = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\ResourceCheckerConfigCache($this->cacheFile);
        $this->assertSame($this->cacheFile, $cache->getPath());
    }
    public function testCacheIsNotFreshIfEmpty()
    {
        $checker = $this->getMockBuilder('_PhpScoper5eddef0da618a\\Symfony\\Component\\Config\\ResourceCheckerInterface')->getMock()->expects($this->never())->method('supports');
        ...
        $cache = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\ResourceCheckerConfigCache($this->cacheFile, [$checker]);
    ...
    {
        $cache = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\ResourceCheckerConfigCache($this->cacheFile, new \ArrayIterator([]));
        $this->assertTrue($cache->isFresh());
    }
    public function testResourcesWithoutcheckersAreIgnoredAndConsideredFresh()
    {
        ...
        $cache = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\ResourceCheckerConfigCache($this->cacheFile);
        $cache->write('', [new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Tests\Resource\ResourceStub()]);
        $this->assertTrue($cache->isFresh());
        // no (matching) ResourceChecker passed
    }
    public function testIsFreshWithchecker()
    {
        $checker = $this->getMockBuilder('_PhpScoper5eddef0da618a\\Symfony\\Component\\Config\\ResourceCheckerInterface')->getMock();
    ...
    public function testCacheIsNotFreshWhenUnserializeFails()
    {
        $checker = $this->getMockBuilder('_PhpScoper5eddef0da618a\\Symfony\\Component\\Config\\ResourceCheckerInterface')->getMock();
        $cache = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\ResourceCheckerConfigCache($this->cacheFile, [$checker]);
        $cache->write('foo', [new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Resource\FileResource(__FILE__)]);
