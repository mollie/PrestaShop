...
class LoaderTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    public function testGetSetResolver()
    {
        $resolver = $this->getMockBuilder('_PhpScoper5eddef0da618a\\Symfony\\Component\\Config\\Loader\\LoaderResolverInterface')->getMock();
        $loader = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Tests\Loader\ProjectLoader1();
        $loader->setResolver($resolver);
        $this->assertSame($resolver, $loader->getResolver(), '->setResolver() sets the resolver loader');
    }
    public function testResolve()
    {
        $resolvedLoader = $this->getMockBuilder('_PhpScoper5eddef0da618a\\Symfony\\Component\\Config\\Loader\\LoaderInterface')->getMock();
        $resolver = $this->getMockBuilder('_PhpScoper5eddef0da618a\\Symfony\\Component\\Config\\Loader\\LoaderResolverInterface')->getMock();
...
class ProjectLoader1 extends \_PhpScoper5eddef0da618a\Symfony\Component\Config\Loader\Loader
{
