...
class NormalizationTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    /**
    ...
    public static function assertNormalized(\MolliePrefix\Symfony\Component\Config\Definition\NodeInterface $tree, $denormalized, $normalized)
    {
