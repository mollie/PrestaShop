...
class NormalizationTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testNormalizeEncoders($denormalized)
    {
        ...
        $normalized = ['encoders' => ['foo' => ['algorithm' => 'plaintext']]];
    ...
    public function getEncoderTests()
    {
        $configs = [];
        // XML
        $configs[] = ['encoder' => [['class' => 'foo', 'algorithm' => 'plaintext']]];
        // XML when only one element of this type
        $configs[] = ['encoder' => ['class' => 'foo', 'algorithm' => 'plaintext']];
        // YAML/PHP
        $configs[] = ['encoders' => [['class' => 'foo', 'algorithm' => 'plaintext']]];
        // YAML/PHP
    ...
    {
        $normalized = ['thing' => [42 => ['foo', 'bar'], 1337 => ['baz', 'qux']]];
    ...
    public static function assertNormalized(\_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\NodeInterface $tree, $denormalized, $normalized)
    {
