...
class MergeTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    public function testForbiddenOverwrite()
    {
        $this->expectException('_PhpScoper5eddef0da618a\\Symfony\\Component\\Config\\Definition\\Exception\\ForbiddenOverwriteException');
    ...
    public function testPerformsNoDeepMerging()
    {
        ...
        $this->assertEquals(['no_deep_merging' => ['c' => 'd']], $tree->merge($a, $b));
    }
