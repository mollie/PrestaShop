...
class IntegerNodeTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $node = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\IntegerNode('test');
