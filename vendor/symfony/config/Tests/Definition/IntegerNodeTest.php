...
class IntegerNodeTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $node = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Definition\IntegerNode('test');
