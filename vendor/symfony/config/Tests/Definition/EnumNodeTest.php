...
class EnumNodeTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    public function testFinalizeValue()
    {
        $node = new \MolliePrefix\Symfony\Component\Config\Definition\EnumNode('foo', null, ['foo', 'bar']);
    ...
    public function testConstructionWithNoValues()
    {
        ...
        new \MolliePrefix\Symfony\Component\Config\Definition\EnumNode('foo', null, []);
    }
    public function testConstructionWithOneValue()
    {
        $node = new \MolliePrefix\Symfony\Component\Config\Definition\EnumNode('foo', null, ['foo']);
        $this->assertSame('foo', $node->finalize('foo'));
    }
    public function testConstructionWithOneDistinctValue()
    {
        $node = new \MolliePrefix\Symfony\Component\Config\Definition\EnumNode('foo', null, ['foo', 'foo']);
        $this->assertSame('foo', $node->finalize('foo'));
    }
