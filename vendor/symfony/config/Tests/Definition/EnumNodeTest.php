...
class EnumNodeTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    public function testFinalizeValue()
    {
        $node = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\EnumNode('foo', null, ['foo', 'bar']);
    ...
    public function testConstructionWithNoValues()
    {
        ...
        new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\EnumNode('foo', null, []);
    }
    public function testConstructionWithOneValue()
    {
        $node = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\EnumNode('foo', null, ['foo']);
        $this->assertSame('foo', $node->finalize('foo'));
    }
    public function testConstructionWithOneDistinctValue()
    {
        $node = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\EnumNode('foo', null, ['foo', 'foo']);
        $this->assertSame('foo', $node->finalize('foo'));
    }
