...
class ArrayNodeTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    ...
    {
        $unrecognizedOptionException = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException('Unrecognized option "foo" under "root"');
    ...
    {
        $node = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ArrayNode('foo');
    ...
    {
        $zeroNode = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ArrayNode(0);
        $zeroNode->addChild(new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ScalarNode('name'));
        $fiveNode = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ArrayNode(5);
        $fiveNode->addChild(new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ScalarNode(0));
        $fiveNode->addChild(new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ScalarNode('new_key'));
        $rootNode = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ArrayNode('root');
        $rootNode->addChild($zeroNode);
        $rootNode->addChild($fiveNode);
        $rootNode->addChild(new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ScalarNode('string_key'));
    ...
    {
        $scalar1 = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ScalarNode('1');
        $scalar2 = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ScalarNode('2');
        $scalar3 = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ScalarNode('3');
        $node = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ArrayNode('foo');
    ...
    public function testAddChildEmptyName()
    {
        ...
        $node = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ArrayNode('root');
        $childNode = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ArrayNode('');
    ...
    public function testAddChildNameAlreadyExists()
    {
        ...
        $node = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ArrayNode('root');
        $childNode = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ArrayNode('foo');
        $node->addChild($childNode);
        $childNodeWithSameName = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\ArrayNode('foo');
