...
use _PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\Builder\EnumNodeDefinition;
class EnumNodeDefinitionTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    public function testWithOneValue()
    {
        $def = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\Builder\EnumNodeDefinition('foo');
        $def->values(['foo']);
        $node = $def->getNode();
