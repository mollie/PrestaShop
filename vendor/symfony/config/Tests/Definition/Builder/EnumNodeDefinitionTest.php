...
use _PhpScoper5ece82d7231e4\Symfony\Component\Config\Definition\Builder\EnumNodeDefinition;
class EnumNodeDefinitionTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    public function testWithOneValue()
    {
        $def = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Definition\Builder\EnumNodeDefinition('foo');
        $def->values(['foo']);
        $node = $def->getNode();
