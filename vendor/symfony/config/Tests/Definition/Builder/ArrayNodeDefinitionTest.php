...
use _PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\Builder\ArrayNodeDefinition;
use _PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\Builder\ScalarNodeDefinition;
...
class ArrayNodeDefinitionTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    public function testAppendingSomeNode()
    {
        $parent = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\Builder\ArrayNodeDefinition('root');
        $child = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\Builder\ScalarNodeDefinition('child');
    ...
    public function testPrototypeNodeSpecificOption($method, $args)
    {
        ...
        $node = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\Builder\ArrayNodeDefinition('root');
    ...
    public function testPrototypedArrayNodeDefault($args, $shouldThrowWhenUsingAttrAsKey, $shouldThrowWhenNotUsingAttrAsKey, $defaults)
    {
        ...
        } catch (\_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException $e) {
    ...
    {
        $nodeDefinition = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Definition\Builder\ArrayNodeDefinition('root');
        $nodeDefinition->addDefaultChildrenIfNoneSet()->prototype('array')->prototype('array');
        $node = $nodeDefinition->getNode();
        $this->assertInstanceOf('_PhpScoper5eddef0da618a\\Symfony\\Component\\Config\\Definition\\PrototypedArrayNode', $node);
        $this->assertInstanceOf('_PhpScoper5eddef0da618a\\Symfony\\Component\\Config\\Definition\\PrototypedArrayNode', $node->getPrototype());
    }
