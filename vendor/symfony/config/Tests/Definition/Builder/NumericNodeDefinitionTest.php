...
use _PhpScoper5ea00cc67502b\Symfony\Component\Config\Definition\Builder\FloatNodeDefinition;
use _PhpScoper5ea00cc67502b\Symfony\Component\Config\Definition\Builder\IntegerNodeDefinition;
class NumericNodeDefinitionTest extends \_PhpScoper5ea00cc67502b\PHPUnit\Framework\TestCase
{
    public function testIncoherentMinAssertion()
    {
        ...
        $def = new \_PhpScoper5ea00cc67502b\Symfony\Component\Config\Definition\Builder\IntegerNodeDefinition('foo');
        $def->max(3)->min(4);
    }
    public function testIncoherentMaxAssertion()
    {
        ...
        $node = new \_PhpScoper5ea00cc67502b\Symfony\Component\Config\Definition\Builder\IntegerNodeDefinition('foo');
        $node->min(3)->max(2);
    }
    ...
    public function testFloatMinAssertion()
    {
        ...
        $def = new \_PhpScoper5ea00cc67502b\Symfony\Component\Config\Definition\Builder\FloatNodeDefinition('foo');
