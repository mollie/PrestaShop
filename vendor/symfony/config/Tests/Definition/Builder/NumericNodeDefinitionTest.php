...
use _PhpScoper5ece82d7231e4\Symfony\Component\Config\Definition\Builder\FloatNodeDefinition;
use _PhpScoper5ece82d7231e4\Symfony\Component\Config\Definition\Builder\IntegerNodeDefinition;
class NumericNodeDefinitionTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    public function testIncoherentMinAssertion()
    {
        ...
        $def = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Definition\Builder\IntegerNodeDefinition('foo');
        $def->max(3)->min(4);
    }
    public function testIncoherentMaxAssertion()
    {
        ...
        $node = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Definition\Builder\IntegerNodeDefinition('foo');
        $node->min(3)->max(2);
    }
    ...
    public function testFloatMinAssertion()
    {
        ...
        $def = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Definition\Builder\FloatNodeDefinition('foo');
