...
class NodeBuilderTest extends \_PhpScoper5ea00cc67502b\PHPUnit\Framework\TestCase
{
    public function testThrowsAnExceptionWhenTryingToCreateANonRegisteredNodeType()
    {
        $this->expectException('RuntimeException');
        $builder = new \_PhpScoper5ea00cc67502b\Symfony\Component\Config\Definition\Builder\NodeBuilder();
        $builder->node('', 'foobar');
    }
    ...
    {
        $class = \_PhpScoper5ea00cc67502b\Symfony\Component\Config\Tests\Definition\Builder\SomeNodeDefinition::class;
        $builder = new \_PhpScoper5ea00cc67502b\Symfony\Component\Config\Definition\Builder\NodeBuilder();
    ...
    public function testNodeTypesAreNotCaseSensitive()
    {
        ...
        $builder->setNodeClass('CuStOm', \_PhpScoper5ea00cc67502b\Symfony\Component\Config\Tests\Definition\Builder\SomeNodeDefinition::class);
...
class SomeNodeDefinition extends \_PhpScoper5ea00cc67502b\Symfony\Component\Config\Definition\Builder\VariableNodeDefinition
{
}
