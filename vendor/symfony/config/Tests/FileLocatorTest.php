...
class FileLocatorTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator([]);
    ...
    {
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(__DIR__ . '/Fixtures');
        ...
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator([__DIR__ . '/Fixtures', __DIR__ . '/Fixtures/Again']);
        ...
        $loader = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\FileLocator(__DIR__ . '/Fixtures/Again');
        $this->assertEquals([__DIR__ . '/Fixtures' . \DIRECTORY_SEPARATOR . 'foo.xml', __DIR__ . '/Fixtures/Again' . \DIRECTORY_SEPARATOR . 'foo.xml'], $loader->locate('foo.xml', __DIR__ . '/Fixtures', \false), '->locate() returns an array of absolute filenames');
    }
    public function testLocateThrowsAnExceptionIfTheFileDoesNotExists()
    {
        $this->expectException('_PhpScoper5ece82d7231e4\\Symfony\\Component\\Config\\Exception\\FileLocatorFileNotFoundException');
