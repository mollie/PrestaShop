 ...
 */
namespace _PhpScoper5eddef0da618a\Symfony\Component\Config\Tests\Exception;

use _PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase;
use _PhpScoper5eddef0da618a\Symfony\Component\Config\Exception\FileLoaderLoadException;
class FileLoaderLoadExceptionTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    public function testMessageCannotLoadResource()
    {
        $exception = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Exception\FileLoaderLoadException('resource', null);
    ...
    {
        $exception = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Exception\FileLoaderLoadException('resource', null, null, null, 'foobar');
    ...
    {
        $exception = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Exception\FileLoaderLoadException('resource', null, null, null, 'annotation');
    ...
    {
        $exception = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Exception\FileLoaderLoadException('resource', 'sourceResource');
    ...
    {
        $exception = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Exception\FileLoaderLoadException('resource', null, null, new \Exception('There was a previous error with an ending dot.'));
    ...
    {
        $exception = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Exception\FileLoaderLoadException('resource', null, null, new \Exception('There was a previous error with no ending dot'));
