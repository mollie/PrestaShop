...
class FileExistenceResourceTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    protected $resource;
    protected $file;
    protected $time;
    protected function setUp()
    {
        ...
        $this->time = \time();
        $this->resource = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Resource\FileExistenceResource($this->file);
    }
    ...
    public function testIsFreshWithExistingResource()
    {
        ...
        $serialized = \serialize(new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Resource\FileExistenceResource($this->file));
