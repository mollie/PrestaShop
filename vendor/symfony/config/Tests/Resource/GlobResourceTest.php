...
class GlobResourceTest extends \_PhpScoper5eddef0da618a\PHPUnit\Framework\TestCase
{
    ...
    public function testIterator()
    {
        ...
        $resource = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Resource\GlobResource($dir, '/Resource', \true);
    ...
    {
        $dir = \dirname(__DIR__) . '/Fixtures';
        $resource = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Resource\GlobResource($dir, '/*', \false);
    ...
    {
        $dir = \dirname(__DIR__) . '/Fixtures';
        $resource = new \_PhpScoper5eddef0da618a\Symfony\Component\Config\Resource\GlobResource($dir, '/*', \true);
