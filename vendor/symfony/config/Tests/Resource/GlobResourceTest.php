...
class GlobResourceTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    ...
    public function testIterator()
    {
        ...
        $resource = new \MolliePrefix\Symfony\Component\Config\Resource\GlobResource($dir, '/Resource', \true);
    ...
    {
        $dir = \dirname(__DIR__) . '/Fixtures';
        $resource = new \MolliePrefix\Symfony\Component\Config\Resource\GlobResource($dir, '/*', \false);
    ...
    {
        $dir = \dirname(__DIR__) . '/Fixtures';
        $resource = new \MolliePrefix\Symfony\Component\Config\Resource\GlobResource($dir, '/*', \true);
