...
class DirectoryResourceTest extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    protected $directory;
    ...
    {
        $resource = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Resource\DirectoryResource($this->directory);
        $this->assertSame(\realpath($this->directory), $resource->getResource(), '->getResource() returns the path to the resource');
    }
    public function testGetPattern()
    {
        $resource = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Resource\DirectoryResource($this->directory, 'bar');
    ...
    public function testResourceDoesNotExist()
    {
        ...
        new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Resource\DirectoryResource('/____foo/foobar' . \mt_rand(1, 999999));
    }
    ...
    {
        $resource = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Resource\DirectoryResource($this->directory, '/.xml$/');
    ...
    {
        $resource = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Resource\DirectoryResource($this->directory, '/\\.(foo|xml)$/');
    ...
    {
        $resourceA = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Resource\DirectoryResource($this->directory, '/.xml$/');
        $resourceB = new \_PhpScoper5ece82d7231e4\Symfony\Component\Config\Resource\DirectoryResource($this->directory, '/.yaml$/');
