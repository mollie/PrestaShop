...
if (!\function_exists('MolliePrefix\\mb_convert_encoding')) {
...
if (!\function_exists('MolliePrefix\\mb_decode_numericentity')) {
...
if (!\function_exists('MolliePrefix\\mb_encode_numericentity')) {
...
if (!\function_exists('MolliePrefix\\mb_convert_case')) {
...
if (!\function_exists('MolliePrefix\\mb_strpos')) {
...
if (!\function_exists('MolliePrefix\\mb_strtoupper')) {
    function mb_strtoupper($string, $encoding = null)
    {
        return \MolliePrefix\Symfony\Polyfill\Mbstring\Mbstring::mb_strtoupper($string, $encoding);
    }
}
if (!\function_exists('MolliePrefix\\mb_substitute_character')) {
...
if (!\function_exists('MolliePrefix\\mb_substr')) {
...
if (!\function_exists('MolliePrefix\\mb_strrchr')) {
...
if (!\function_exists('MolliePrefix\\mb_strrichr')) {
...
if (!\function_exists('MolliePrefix\\mb_http_input')) {
...
} elseif (!\function_exists('MolliePrefix\\mb_convert_variables')) {
