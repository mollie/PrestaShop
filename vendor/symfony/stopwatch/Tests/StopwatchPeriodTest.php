...
use MolliePrefix\Symfony\Component\Stopwatch\StopwatchPeriod;
class StopwatchPeriodTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $period = new \MolliePrefix\Symfony\Component\Stopwatch\StopwatchPeriod($start, $start, $useMorePrecision);
    ...
    {
        $period = new \MolliePrefix\Symfony\Component\Stopwatch\StopwatchPeriod($end, $end, $useMorePrecision);
    ...
    {
        $period = new \MolliePrefix\Symfony\Component\Stopwatch\StopwatchPeriod($start, $end, $useMorePrecision);
    ...
    public function provideDurationValues()
    {
        ...
        (yield [0.0, 0.0, \true, 0.0]);
        (yield [2, 3.14, \false, 1]);
        (yield [2, 3.14, \true, 1.14]);
        (yield [2.71, 3.14, \false, 1]);
        (yield [2.71, 3.14, \true, 0.43]);
    }
}
