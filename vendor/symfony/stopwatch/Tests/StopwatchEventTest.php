...
use MolliePrefix\Symfony\Component\Stopwatch\StopwatchEvent;
/**
 * StopwatchEventTest.
 *
 ...
 */
class StopwatchEventTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    const DELTA = 37;
    public function testGetOrigin()
    {
        $event = new \MolliePrefix\Symfony\Component\Stopwatch\StopwatchEvent(12);
        $this->assertEquals(12, $event->getOrigin());
    }
    public function testGetCategory()
    {
        $event = new \MolliePrefix\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000);
        $this->assertEquals('default', $event->getCategory());
        $event = new \MolliePrefix\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000, 'cat');
    ...
    public function testInvalidOriginThrowsAnException()
    {
        ...
        new \MolliePrefix\Symfony\Component\Stopwatch\StopwatchEvent('abc');
    }
    public function testHumanRepresentation()
    {
        ...
        $event = new \MolliePrefix\Symfony\Component\Stopwatch\StopwatchEvent(\microtime(\true) * 1000, 'foo');
