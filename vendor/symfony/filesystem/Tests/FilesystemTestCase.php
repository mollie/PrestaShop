...
class FilesystemTestCase extends \_PhpScoper5ece82d7231e4\PHPUnit\Framework\TestCase
{
    private $umask;
    ...
    {
        $this->umask = \umask(0);
        $this->filesystem = new \_PhpScoper5ece82d7231e4\Symfony\Component\Filesystem\Filesystem();
