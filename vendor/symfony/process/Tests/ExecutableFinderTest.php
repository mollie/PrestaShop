...
use MolliePrefix\Symfony\Component\Process\ExecutableFinder;
/**
 * @author Chris Smith <chris@cs278.org>
 */
class ExecutableFinderTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    private $path;
    ...
    public function testFind()
    {
        ...
        $finder = new \MolliePrefix\Symfony\Component\Process\ExecutableFinder();
    ...
    public function testFindBatchExecutableOnWindows()
    {
        ...
        $target = \tempnam(\sys_get_temp_dir(), 'example-windows-executable');
        \touch($target);
        \touch($target . '.BAT');
