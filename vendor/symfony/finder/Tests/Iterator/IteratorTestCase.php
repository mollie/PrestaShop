...
abstract class IteratorTestCase extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    ...
    protected function assertIteratorInForeach(array $expected, \Traversable $iterator)
    {
        ...
        foreach ($iterator as $file) {
            $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Finder\\SplFileInfo', $file);
