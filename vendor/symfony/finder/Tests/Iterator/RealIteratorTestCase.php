...
abstract class RealIteratorTestCase extends \MolliePrefix\Symfony\Component\Finder\Tests\Iterator\IteratorTestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$files = ['.git/', '.foo/', '.foo/.bar', '.foo/bar', '.bar', 'test.py', 'foo/', 'foo/bar.tmp', 'test.php', 'toto/', 'toto/.git/', 'foo bar'];
