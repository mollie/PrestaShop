...
class Use_ extends \MolliePrefix\PhpParser\BuilderAbstract
{
    ...
    public function getNode()
    {
        ...
        return new \MolliePrefix\PhpParser\Node\Stmt\Use_(array(new \MolliePrefix\PhpParser\Node\Stmt\UseUse($this->name, $alias)), $this->type);
    }
}
