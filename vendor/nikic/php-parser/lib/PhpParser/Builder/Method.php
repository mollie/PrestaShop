...
class Method extends \MolliePrefix\PhpParser\Builder\FunctionLike
{
    protected $name;
    protected $flags = 0;
    /** @var array|null */
    ...
    {
        return new \MolliePrefix\PhpParser\Node\Stmt\ClassMethod($this->name, array('flags' => $this->flags, 'byRef' => $this->returnByRef, 'params' => $this->params, 'returnType' => $this->returnType, 'stmts' => $this->stmts), $this->attributes);
    }
}
