...
class String_ extends \MolliePrefix\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8($num)
    {
        ...
        throw new \MolliePrefix\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
    /**
     * @internal
     *
