 ...
 */
class MatchNoneConstraint implements \MolliePrefix\Composer\Semver\Constraint\ConstraintInterface
{
    /** @var string|null */
    ...
    {
        return new \MolliePrefix\Composer\Semver\Constraint\Bound('0.0.0.0-dev', \false);
    }
    /**
     * {@inheritDoc}
     */
