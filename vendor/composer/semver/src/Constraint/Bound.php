...
class Bound
{
     ...
     * @return bool
     */
    public function compareTo(\MolliePrefix\Composer\Semver\Constraint\Bound $other, $operator)
    {
    ...
    {
        return new \MolliePrefix\Composer\Semver\Constraint\Bound('0.0.0.0-dev', \true);
    }
    /**
     * @return self
     */
    ...
    {
        return new \MolliePrefix\Composer\Semver\Constraint\Bound(\PHP_INT_MAX . '.0.0.0', \false);
    }
}
