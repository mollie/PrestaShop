...
class VersionParser
{
    ...
    public function parseConstraints($constraints)
    {
        ...
        $constraint = \MolliePrefix\Composer\Semver\Constraint\MultiConstraint::create($orGroups, \false);
    ...
    private function parseConstraint($constraint)
    {
        ...
        if (\preg_match('{^(v)?[xX*](\\.[xX*])*$}i', $constraint, $match)) {
            if (!empty($match[1]) || !empty($match[2])) {
                return array(new \MolliePrefix\Composer\Semver\Constraint\Constraint('>=', '0.0.0.0-dev'));
            }
            return array(new \MolliePrefix\Composer\Semver\Constraint\MatchAllConstraint());
        }
