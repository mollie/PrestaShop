 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Reports;
...
class Cbf implements \MolliePrefix\PHP_CodeSniffer\Reports\Report
{
    /**
     ...
     */
    public function generateFileReport($report, \MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $showSources = \false, $width = 80)
    {
        ...
        if ($phpcsFile->config->stdin === \true) {
            ...
            throw new \MolliePrefix\PHP_CodeSniffer\Exceptions\DeepExitException($fixedContent, 1);
        }
        if ($errors === 0) {
            return \false;
        }
