...
class Junit implements \MolliePrefix\PHP_CodeSniffer\Reports\Report
{
    /**
    ...
    public function generate($cachedData, $totalFiles, $totalErrors, $totalWarnings, $totalFixable, $showSources = \false, $width = 80, $interactive = \false, $toScreen = \true)
    {
        ...
        echo '<testsuites name="PHP_CodeSniffer ' . \MolliePrefix\PHP_CodeSniffer\Config::VERSION . '" errors="0" tests="' . $tests . '" failures="' . $failures . '">' . \PHP_EOL;
        echo $cachedData;
