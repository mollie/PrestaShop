...
use MolliePrefix\PHP_CodeSniffer\Standards\PEAR\Sniffs\Classes\ClassDeclarationSniff as PEARClassDeclarationSniff;
use MolliePrefix\PHP_CodeSniffer\Util\Tokens;
class ClassDeclarationSniff extends \MolliePrefix\PHP_CodeSniffer\Standards\PEAR\Sniffs\Classes\ClassDeclarationSniff
{
    /**
    ...
    public function processOpen(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if ($implements !== \false) {
            $prev = $phpcsFile->findPrevious(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $openingBrace - 1, $implements, \true);
    ...
    public function processClose(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$stackPtr]['code'] !== T_ANON_CLASS) {
            ...
            $ignoreTokens = \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$phpcsCommentTokens;
