 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\PSR2\Sniffs\Files;
...
class ClosingTagSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$last]['code'] === \T_CLOSE_TAG) {
            ...
            if ($fix === \true) {
                ...
                $prev = $phpcsFile->findPrevious(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $last - 1, null, \true);
