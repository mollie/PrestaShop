 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\PSR2\Sniffs\Methods;
...
class MethodDeclarationSniff extends \MolliePrefix\PHP_CodeSniffer\Sniffs\AbstractScopeSniff
{
    /**
    ...
    {
        parent::__construct(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$ooScopeTokens, [\T_FUNCTION]);
    }
    //end __construct()
    /**
    ...
    protected function processTokenWithinScope(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        $abstract = 0;
        $final = 0;
        $find = \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$methodPrefixes + \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens;
        $prev = $phpcsFile->findPrevious($find, $stackPtr - 1, null, \true);
        $prefix = $stackPtr;
        while (($prefix = $phpcsFile->findPrevious(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$methodPrefixes, $prefix - 1, $prev)) !== \false) {
