 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\Squiz\Sniffs\Classes;

use MolliePrefix\PHP_CodeSniffer\Files\File;
use MolliePrefix\PHP_CodeSniffer\Sniffs\AbstractScopeSniff;
use MolliePrefix\PHP_CodeSniffer\Util\Tokens;
class SelfMemberReferenceSniff extends \MolliePrefix\PHP_CodeSniffer\Sniffs\AbstractScopeSniff
{
    /**
     ...
     * @return void
     */
    protected function processTokenWithinScope(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        $calledClassName = $phpcsFile->findPrevious(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $stackPtr - 1, null, \true);
        ...
        if ($tokens[$calledClassName]['code'] === T_SELF) {
            ...
            if ($tokens[$calledClassName]['code'] === \T_STRING) {
                ...
                $prevNonEmpty = $phpcsFile->findPrevious(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $calledClassName - 1, null, \true);
                ...
                if ($declarationName === $fullQualifiedClassName) {
                    ...
                    if ($fix === \true) {
                        ...
                        while ($tokens[$currentPointer]['code'] === \T_NS_SEPARATOR || $tokens[$currentPointer]['code'] === \T_STRING || isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$currentPointer]['code']]) === \true) {
                            if (isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$currentPointer]['code']]) === \true) {
                                --$currentPointer;
                                continue;
                            }
     ...
     * @return void
     */
    protected function processTokenOutsideScope(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
    }
     ...
     * @return string
     */
    protected function getNamespaceOfScope(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        $namespace = '\\';
