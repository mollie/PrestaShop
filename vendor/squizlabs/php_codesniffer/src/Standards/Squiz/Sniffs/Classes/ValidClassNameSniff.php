...
class ValidClassNameSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $valid = \MolliePrefix\PHP_CodeSniffer\Util\Common::isCamelCaps($name, \true, \true, \false);
        if ($valid === \false) {
