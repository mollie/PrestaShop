...
class ClassDefinitionNameSpacingSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $endTokens += \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$commentTokens;
