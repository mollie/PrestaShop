...
class ScopeKeywordSpacingSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        $register = \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$scopeModifiers;
        $register[] = \T_STATIC;
        return $register;
    }
    //end register()
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$stackPtr]['code'] === \T_STATIC && ($nextToken === \false || $tokens[$nextToken]['code'] === \T_DOUBLE_COLON || $tokens[$prevToken]['code'] === \T_NEW)) {
