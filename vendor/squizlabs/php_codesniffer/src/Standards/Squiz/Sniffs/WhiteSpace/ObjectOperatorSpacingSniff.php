...
class ObjectOperatorSpacingSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
     ...
     */
    protected function checkSpacingBeforeOperator(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $before)
    {
     ...
     * @return boolean true if there was no error, false otherwise.
     */
    protected function checkSpacingAfterOperator(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $after)
    {
