...
class OperatorSpacingSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function register()
    {
        ...
        */
        ...
        $this->nonOperandTokens = \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$operators;
        // Trying to compare a negative value; eg. ($var === -1).
        $this->nonOperandTokens += \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$comparisonTokens;
        // Trying to compare a negative value; eg. ($var || -1 === $b).
        $this->nonOperandTokens += \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$booleanOperators;
        // Trying to assign a negative value; eg. ($var = -1).
        $this->nonOperandTokens += \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$assignmentTokens;
        ...
        $this->nonOperandTokens += \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$castTokens;
        /*
            These are the tokens the sniff is looking for.
        */
        $targets = \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$comparisonTokens;
        $targets += \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$operators;
        $targets += \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$assignmentTokens;
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$stackPtr - 1]['code'] !== \T_WHITESPACE && ($tokens[$stackPtr - 1]['code'] === T_INLINE_THEN && $tokens[$stackPtr]['code'] === T_INLINE_ELSE) === \false) {
            ...
            if (isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$assignmentTokens[$tokens[$stackPtr]['code']]) === \false || $this->ignoreSpacingBeforeAssignments === \false) {
        ...
        if ($tokens[$stackPtr + 1]['code'] !== \T_WHITESPACE) {
            ...
            if ($found !== 1 && ($found !== 'newline' || $this->ignoreNewlines === \false)) {
                ...
                if ($nextNonWhitespace !== \false && isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$commentTokens[$tokens[$nextNonWhitespace]['code']]) === \true && $found === 'newline') {
     ...
     * @return boolean
     */
    protected function isOperator(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
