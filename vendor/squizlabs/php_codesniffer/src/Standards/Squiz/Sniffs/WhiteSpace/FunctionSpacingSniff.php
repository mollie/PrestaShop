...
class FunctionSpacingSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $previousNonEmpty = $phpcsFile->findPrevious(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $stackPtr - 1, null, \true);
        ...
        $isFirst = \false;
        $isLast = \false;
        $ignore = [\T_WHITESPACE => \T_WHITESPACE] + \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$methodPrefixes;
        ...
        if (isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$next]['code']]) === \true && $tokens[$next]['line'] === $tokens[$closer]['line']) {
        ...
        */
        ...
        if ($prevLineToken === null) {
            ...
            if ($tokens[$prevContent]['code'] === \T_COMMENT || isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$phpcsCommentTokens[$tokens[$prevContent]['code']]) === \true) {
