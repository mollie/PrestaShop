...
class VariableCommentSniff extends \MolliePrefix\PHP_CodeSniffer\Sniffs\AbstractVariableSniff
{
    /**
     ...
     * @return void
     */
    public function processMemberVar(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
