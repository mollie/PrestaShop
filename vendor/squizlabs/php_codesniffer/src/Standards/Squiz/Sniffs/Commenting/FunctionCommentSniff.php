 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\Squiz\Sniffs\Commenting;

use MolliePrefix\PHP_CodeSniffer\Config;
use MolliePrefix\PHP_CodeSniffer\Files\File;
use MolliePrefix\PHP_CodeSniffer\Standards\PEAR\Sniffs\Commenting\FunctionCommentSniff as PEARFunctionCommentSniff;
use MolliePrefix\PHP_CodeSniffer\Util\Common;
class FunctionCommentSniff extends \MolliePrefix\PHP_CodeSniffer\Standards\PEAR\Sniffs\Commenting\FunctionCommentSniff
{
    /**
     ...
     * @return void
     */
    protected function processReturn(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $commentStart)
    {
        ...
        if ($return !== null) {
            ...
            if (empty($content) === \true || $tokens[$return + 2]['code'] !== T_DOC_COMMENT_STRING) {
                ...
                foreach ($typeNames as $i => $typeName) {
                    $suggestedName = \MolliePrefix\PHP_CodeSniffer\Util\Common::suggestType($typeName);
     ...
     * @return void
     */
    protected function processThrows(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $commentStart)
    {
        $tokens = $phpcsFile->getTokens();
     ...
     * @return void
     */
    protected function processParams(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $commentStart)
    {
        if ($this->phpVersion === null) {
            $this->phpVersion = \MolliePrefix\PHP_CodeSniffer\Config::getConfigData('php_version');
            if ($this->phpVersion === null) {
                ...
                if (\strpos($suggestedName, 'array') !== \false || \substr($suggestedName, -2) === '[]') {
                    ...
                    if (\strpos($suggestedName, 'callable') !== \false) {
                        ...
                        if (\strpos($suggestedName, 'callback') !== \false) {
                            ...
                            if (\in_array($suggestedName, \MolliePrefix\PHP_CodeSniffer\Util\Common::$allowedTypes, \true) === \false) {
     ...
     * @return void
     */
    protected function checkSpacingAfterParamType(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $param, $maxType, $spacing = 1)
    {
        // Check number of spaces after the type.
     ...
     * @return void
     */
    protected function checkSpacingAfterParamName(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $param, $maxVar, $spacing = 1)
    {
        // Check number of spaces after the var name.
