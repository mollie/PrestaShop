...
class EchoedStringsSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if ($phpcsFile->findNext(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$operators, $stackPtr, $end, \false) === \false) {
