...
class StaticThisUsageSniff extends \MolliePrefix\PHP_CodeSniffer\Sniffs\AbstractScopeSniff
{
    /**
     ...
     * @return void
     */
    public function processTokenWithinScope(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $currScope)
    {
     ...
     * @return void
     */
    private function checkThisUsage(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $next, $end)
    {
        $tokens = $phpcsFile->getTokens();
        do {
