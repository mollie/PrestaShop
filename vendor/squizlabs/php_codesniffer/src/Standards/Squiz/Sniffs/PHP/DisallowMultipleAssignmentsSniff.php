...
class DisallowMultipleAssignmentsSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if (empty($tokens[$stackPtr]['conditions']) === \false) {
            ...
            if (isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$ooScopeTokens[$tokens[$deepestScope]['code']]) === \true) {
                return;
            }
        }
        /*
