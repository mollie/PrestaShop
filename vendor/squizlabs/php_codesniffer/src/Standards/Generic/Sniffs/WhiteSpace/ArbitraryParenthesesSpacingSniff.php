...
class ArbitraryParenthesesSpacingSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        $this->ignoreTokens = \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$functionNameTokens;
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $preOpener = $phpcsFile->findPrevious(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $opener - 1, null, \true);
