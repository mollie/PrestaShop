 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\Generic\Sniffs\VersionControl;
...
class SubversionPropertiesSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
