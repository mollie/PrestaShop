 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\Generic\Sniffs\Debug;
...
class ClosureLinterSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        $lintPath = \MolliePrefix\PHP_CodeSniffer\Config::getExecutablePath('gjslint');
        if ($lintPath === null) {
            return;
        }
