...
class MultipleStatementAlignmentSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        $tokens = \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$assignmentTokens;
    ...
    public function checkAlignment($phpcsFile, $stackPtr, $end = null)
    {
        ...
        $find = \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$assignmentTokens;
        unset($find[\T_DOUBLE_ARROW]);
        $scopes = \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$scopeOpeners;
        ...
        for ($assign = $stackPtr; $assign < $end; $assign++) {
            ...
            if (isset($scopes[$tokens[$assign]['code']]) === \true && isset($tokens[$assign]['scope_opener']) === \true && $tokens[$assign]['level'] === $tokens[$stackPtr]['level']) {
                break;
            }
            if ($assign === $arrayEnd) {
                $arrayEnd = null;
            ...
            if (isset($find[$tokens[$assign]['code']]) === \false) {
                ...
                if (isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$assign]['code']]) === \false && $tokens[$assign]['line'] - $tokens[$lastCode]['line'] > 1 && $tokens[$assign]['level'] === $tokens[$stackPtr]['level'] && $arrayEnd === null) {
                    break;
                }
                ...
                if (isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$tokens[$assign]['code']]) === \false) {
                    $lastCode = $assign;
            ...
            //end if
            $var = $phpcsFile->findPrevious(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $assign - 1, null, \true);
