...
class ConstructorNameSniff extends \MolliePrefix\PHP_CodeSniffer\Sniffs\AbstractScopeSniff
{
    /**
     ...
     * @return void
     */
    protected function loadFunctionNamesInScope(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $currScope)
    {
        $this->functionList = [];
        $tokens = $phpcsFile->getTokens();
