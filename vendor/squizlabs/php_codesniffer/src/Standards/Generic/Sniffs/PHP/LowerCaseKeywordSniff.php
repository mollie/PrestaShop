...
class LowerCaseKeywordSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if (\strtolower($keyword) !== $keyword) {
            ...
            $messageKeyword = \MolliePrefix\PHP_CodeSniffer\Util\Common::prepareForOutput($keyword);
