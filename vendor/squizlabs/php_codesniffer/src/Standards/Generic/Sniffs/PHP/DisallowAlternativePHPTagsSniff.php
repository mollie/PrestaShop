...
class DisallowAlternativePHPTagsSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
     ...
     */
    protected function findClosingTag(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $tokens, $stackPtr, $content)
    {
     ...
     * @return void
     */
    protected function addChangeset(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $tokens, $openTagPointer, $closeTagPointer, $echo = \false)
    {
