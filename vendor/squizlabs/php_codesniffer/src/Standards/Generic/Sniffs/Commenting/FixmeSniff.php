 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\Generic\Sniffs\Commenting;
...
class FixmeSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        return \array_diff(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$commentTokens, \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$phpcsCommentTokens);
    }
    //end register()
    /**
