...
class AssignmentInConditionSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    {
        $this->assignmentTokens = \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$assignmentTokens;
        unset($this->assignmentTokens[\T_DOUBLE_ARROW]);
        $starters = \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$booleanOperators;
