...
class UselessOverridingMethodSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
            ...
            if ($code === T_OPEN_PARENTHESIS) {
                ...
                if ($code === T_CLOSE_PARENTHESIS) {
                    ...
                    if ($parenthesisCount === 1 && $code === T_COMMA) {
                        ...
                        if (isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens[$code]) === \false) {
