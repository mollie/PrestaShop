 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\Generic\Sniffs\Arrays;

use MolliePrefix\PHP_CodeSniffer\Sniffs\AbstractArraySniff;
use MolliePrefix\PHP_CodeSniffer\Util\Tokens;
class ArrayIndentSniff extends \MolliePrefix\PHP_CodeSniffer\Sniffs\AbstractArraySniff
{
    /**
    ...
    public function processMultiLineArray($phpcsFile, $stackPtr, $arrayStart, $arrayEnd, $indices)
    {
        ...
        foreach ($indices as $index) {
            ...
            $prev = $phpcsFile->findPrevious(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $start - 1, null, \true);
