 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\Generic\Sniffs\Classes;

use MolliePrefix\PHP_CodeSniffer\Files\File;
use MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff;
class OpeningBraceSameLineSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
