 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\Generic\Sniffs\Strings;
...
class UnnecessaryStringConcatSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if (isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$stringTokens[$tokens[$prev]['code']]) === \true && isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$stringTokens[$tokens[$next]['code']]) === \true) {
