 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\Generic\Sniffs\Functions;
...
class FunctionCallArgumentSpacingSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $ignoreTokens = \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens;
        ...
        $openBracket = $phpcsFile->findNext(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $functionName + 1, null, \true);
     ...
     * @return void
     */
    public function checkSpacing(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $openBracket)
    {
        $tokens = $phpcsFile->getTokens();
        ...
        while (($nextSeparator = $phpcsFile->findNext($find, $nextSeparator + 1, $closeBracket)) !== \false) {
            ...
            if ($tokens[$nextSeparator]['code'] === T_COMMA) {
                if ($tokens[$nextSeparator - 1]['code'] === \T_WHITESPACE) {
                    $prev = $phpcsFile->findPrevious(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $nextSeparator - 2, null, \true);
                    if (isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$heredocTokens[$tokens[$prev]['code']]) === \false) {
                ...
                if ($tokens[$nextSeparator + 1]['code'] !== \T_WHITESPACE) {
                    ...
                    $next = $phpcsFile->findNext(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $nextSeparator + 1, null, \true);
