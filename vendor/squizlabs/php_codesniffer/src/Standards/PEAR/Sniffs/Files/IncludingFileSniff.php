 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\PEAR\Sniffs\Files;
...
class IncludingFileSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        // it's conditional.
        $previous = $phpcsFile->findPrevious(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $stackPtr - 1, null, \true);
        if (isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$assignmentTokens[$tokens[$previous]['code']]) === \true) {
