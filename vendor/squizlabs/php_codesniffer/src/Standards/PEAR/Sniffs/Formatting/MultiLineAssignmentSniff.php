 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\PEAR\Sniffs\Formatting;

use MolliePrefix\PHP_CodeSniffer\Files\File;
use MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff;
class MultiLineAssignmentSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
