 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\PEAR\Sniffs\NamingConventions;
...
class ValidFunctionNameSniff extends \MolliePrefix\PHP_CodeSniffer\Sniffs\AbstractScopeSniff
{
    /**
    ...
    protected function processTokenWithinScope(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if (\MolliePrefix\PHP_CodeSniffer\Util\Common::isCamelCaps($testMethodName, \false, \true, \false) === \false) {
    ...
    protected function processTokenOutsideScope(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if (\MolliePrefix\PHP_CodeSniffer\Util\Common::isCamelCaps($camelCapsPart, \false, \true, \false) === \false) {
            $validName = \false;
