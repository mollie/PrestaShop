 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\PEAR\Sniffs\Commenting;
...
class FunctionCommentSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $find = \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$methodPrefixes;
        $find[] = \T_WHITESPACE;
