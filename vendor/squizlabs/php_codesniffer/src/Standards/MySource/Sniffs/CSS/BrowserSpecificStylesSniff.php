 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\MySource\Sniffs\CSS;

use MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff;
use MolliePrefix\PHP_CodeSniffer\Files\File;
class BrowserSpecificStylesSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
