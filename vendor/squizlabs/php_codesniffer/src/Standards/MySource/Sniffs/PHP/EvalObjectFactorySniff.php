 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\MySource\Sniffs\PHP;
...
class EvalObjectFactorySniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        */
        ...
        for ($i = $openBracket + 1; $i < $closeBracket; $i++) {
            if (isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$stringTokens[$tokens[$i]['code']]) === \true) {
