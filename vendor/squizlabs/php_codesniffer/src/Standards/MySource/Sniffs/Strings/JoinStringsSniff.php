 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\MySource\Sniffs\Strings;
...
class JoinStringsSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $prev = $phpcsFile->findPrevious(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $prev - 1, null, \true);
