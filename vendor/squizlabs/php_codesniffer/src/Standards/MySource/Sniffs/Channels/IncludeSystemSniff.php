 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\MySource\Sniffs\Channels;
...
class IncludeSystemSniff extends \MolliePrefix\PHP_CodeSniffer\Sniffs\AbstractScopeSniff
{
    /**
     ...
     * @return string
     */
    protected function getIncludedClassFromToken(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, array $tokens, $stackPtr)
    {
        if (\strtolower($tokens[$stackPtr]['content']) === 'includesystem') {
            ...
            if (\strtolower($tokens[$stackPtr]['content']) === 'includeasset') {
                ...
                if (isset(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$includeTokens[$tokens[$stackPtr]['code']]) === \true) {
