 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\PSR12\Sniffs\Classes;

use MolliePrefix\PHP_CodeSniffer\Files\File;
use MolliePrefix\PHP_CodeSniffer\Standards\Generic\Sniffs\Functions\FunctionCallArgumentSpacingSniff;
use MolliePrefix\PHP_CodeSniffer\Standards\PSR2\Sniffs\Classes\ClassDeclarationSniff;
use MolliePrefix\PHP_CodeSniffer\Standards\Squiz\Sniffs\Functions\MultiLineFunctionDeclarationSniff;
use MolliePrefix\PHP_CodeSniffer\Util\Tokens;
class AnonClassDeclarationSniff extends \MolliePrefix\PHP_CodeSniffer\Standards\PSR2\Sniffs\Classes\ClassDeclarationSniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $this->multiLineSniff = new \MolliePrefix\PHP_CodeSniffer\Standards\Squiz\Sniffs\Functions\MultiLineFunctionDeclarationSniff();
        $this->functionCallSniff = new \MolliePrefix\PHP_CodeSniffer\Standards\Generic\Sniffs\Functions\FunctionCallArgumentSpacingSniff();
     ...
     * @return void
     */
    public function processSingleLineArgumentList(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
        $openBracket = $tokens[$stackPtr]['parenthesis_opener'];
     ...
     * @return void
     */
    public function processMultiLineArgumentList(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
        $openBracket = $tokens[$stackPtr]['parenthesis_opener'];
