...
class ClassInstantiationSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        // Find the class name.
        $allowed = [\T_STRING => \T_STRING, \T_NS_SEPARATOR => \T_NS_SEPARATOR, T_SELF => T_SELF, \T_STATIC => \T_STATIC, \T_VARIABLE => \T_VARIABLE, T_DOLLAR => T_DOLLAR, \T_OBJECT_OPERATOR => \T_OBJECT_OPERATOR, \T_DOUBLE_COLON => \T_DOUBLE_COLON];
        ...
        if ($fix === \true) {
            $prev = $phpcsFile->findPrevious(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $classNameEnd - 1, null, \true);
