 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\PSR12\Sniffs\Keywords;

use MolliePrefix\PHP_CodeSniffer\Files\File;
use MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff;
class ShortFormTypeKeywordsSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
