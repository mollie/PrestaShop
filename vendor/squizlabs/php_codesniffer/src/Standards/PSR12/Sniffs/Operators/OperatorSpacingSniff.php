 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\PSR12\Sniffs\Operators;

use MolliePrefix\PHP_CodeSniffer\Files\File;
use MolliePrefix\PHP_CodeSniffer\Standards\Squiz\Sniffs\WhiteSpace\OperatorSpacingSniff as SquizOperatorSpacingSniff;
use MolliePrefix\PHP_CodeSniffer\Util\Tokens;
class OperatorSpacingSniff extends \MolliePrefix\PHP_CodeSniffer\Standards\Squiz\Sniffs\WhiteSpace\OperatorSpacingSniff
{
    /**
    ...
    public function register()
    {
        ...
        $targets += \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$booleanOperators;
