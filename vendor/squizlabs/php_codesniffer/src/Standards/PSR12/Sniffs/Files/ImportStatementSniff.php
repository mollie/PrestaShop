...
class ImportStatementSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        if ($phpcsFile->hasCondition($stackPtr, \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$ooScopeTokens) === \true) {
