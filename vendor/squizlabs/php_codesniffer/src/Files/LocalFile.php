...
class LocalFile extends \MolliePrefix\PHP_CodeSniffer\Files\File
{
    /**
    ...
    public function process()
    {
        ...
        $cache = \MolliePrefix\PHP_CodeSniffer\Util\Cache::get($this->path);
        ...
        \MolliePrefix\PHP_CodeSniffer\Util\Cache::set($this->path, $cache);
