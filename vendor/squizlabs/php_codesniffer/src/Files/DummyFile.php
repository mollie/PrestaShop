...
class DummyFile extends \MolliePrefix\PHP_CodeSniffer\Files\File
{
    /**
     ...
     * @return void
     */
    public function __construct($content, \MolliePrefix\PHP_CodeSniffer\Ruleset $ruleset, \MolliePrefix\PHP_CodeSniffer\Config $config)
    {
