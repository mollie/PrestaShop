 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Filters;
...
class Filter extends \RecursiveFilterIterator
{
     ...
     * @return void
     */
    public function __construct($iterator, $basedir, \MolliePrefix\PHP_CodeSniffer\Config $config, \MolliePrefix\PHP_CodeSniffer\Ruleset $ruleset)
    {
    ...
    public function accept()
    {
        ...
        $realPath = \MolliePrefix\PHP_CodeSniffer\Util\Common::realpath($filePath);
        if ($realPath !== \false) {
