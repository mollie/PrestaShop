 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Generators;
...
abstract class Generator
{
     ...
     * @see generate()
     */
    public function __construct(\MolliePrefix\PHP_CodeSniffer\Ruleset $ruleset)
    {
        $this->ruleset = $ruleset;
        foreach ($ruleset->sniffs as $className => $sniffClass) {
            $file = \MolliePrefix\PHP_CodeSniffer\Autoload::getLoadedFileName($className);
