...
abstract class AbstractArraySniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
    ...
    public function process(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr)
    {
        ...
        $lastContent = $phpcsFile->findPrevious(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $arrayEnd - 1, null, \true);
        ...
        $indices = [];
        $current = $arrayStart;
        while (($next = $phpcsFile->findNext(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $current + 1, $arrayEnd, \true)) !== \false) {
            ...
            if ($tokens[$end]['code'] === \T_DOUBLE_ARROW) {
                ...
                $valueStart = $phpcsFile->findNext(\MolliePrefix\PHP_CodeSniffer\Util\Tokens::$emptyTokens, $end + 1, null, \true);
     ...
     * @return int
     */
    private function getNext(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $ptr, $arrayEnd)
    {
        $tokens = $phpcsFile->getTokens();
        while ($ptr < $arrayEnd) {
