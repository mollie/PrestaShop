...
abstract class AbstractScopeSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
     ...
     *                  the rest of the file.
     */
    protected abstract function processTokenWithinScope(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr, $currScope);
    /**
     ...
     *                  the rest of the file.
     */
    protected abstract function processTokenOutsideScope(\MolliePrefix\PHP_CodeSniffer\Files\File $phpcsFile, $stackPtr);
}
//end class
