 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Tests\Core\Filters\Filter;

use MolliePrefix\PHP_CodeSniffer\Config;
use MolliePrefix\PHP_CodeSniffer\Filters\Filter;
use MolliePrefix\PHP_CodeSniffer\Ruleset;
use MolliePrefix\PHPUnit\Framework\TestCase;
class AcceptTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    /**
     * The Config object.
     *
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$config = new \MolliePrefix\PHP_CodeSniffer\Config(["--standard={$standard}", "--ignore=*/somethingelse/*"]);
        self::$ruleset = new \MolliePrefix\PHP_CodeSniffer\Ruleset(self::$config);
    }
    ...
    public function testExcludePatterns($inputPaths, $expectedOutput)
    {
        ...
        $filter = new \MolliePrefix\PHP_CodeSniffer\Filters\Filter($fakeDI, '/', self::$config, self::$ruleset);
