...
abstract class AbstractMethodUnitTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    /**
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$phpcsFile = new \MolliePrefix\PHP_CodeSniffer\Files\DummyFile($contents, $ruleset, $config);
    ...
    public function getTargetToken($commentString, $tokenType, $tokenContent = null)
    {
        ...
        $comment = self::$phpcsFile->findPrevious(\T_COMMENT, $start, null, \false, $commentString);
