...
class ErrorSuppressionTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testSuppressError()
    {
        ...
        $file = new \MolliePrefix\PHP_CodeSniffer\Files\DummyFile($content, $ruleset, $config);
        $file->process();
