 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Tests\Core\Sniffs;

use MolliePrefix\PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest;
class AbstractArraySniffTest extends \MolliePrefix\PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest
{
    /**
    ...
    {
        self::$sniff = new \MolliePrefix\PHP_CodeSniffer\Tests\Core\Sniffs\AbstractArraySniffTestable();
