...
class RuleInclusionAbsoluteLinuxTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    /**
     * The Ruleset object.
     *
    ...
    public function testLinuxStylePathRuleInclusion()
    {
        ...
        $this->assertSame('MolliePrefix\\PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Formatting\\SpaceAfterNotSniff', $this->ruleset->sniffCodes['Generic.Formatting.SpaceAfterNot']);
