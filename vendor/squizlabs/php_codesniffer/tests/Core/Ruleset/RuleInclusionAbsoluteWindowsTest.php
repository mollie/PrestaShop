...
class RuleInclusionAbsoluteWindowsTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    /**
     * The Ruleset object.
     *
    ...
    public function setUp()
    {
        ...
        $config = new \MolliePrefix\PHP_CodeSniffer\Config(["--standard={$this->standard}"]);
        $this->ruleset = new \MolliePrefix\PHP_CodeSniffer\Ruleset($config);
    }
    //end setUp()
    /**
     * Reset ruleset file.
    ...
    public function testWindowsStylePathRuleInclusion()
    {
        ...
        $this->assertSame('MolliePrefix\\PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Formatting\\SpaceAfterCastSniff', $this->ruleset->sniffCodes['Generic.Formatting.SpaceAfterCast']);
