...
class FindExtendedClassNameTest extends \MolliePrefix\PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest
{
    /**
    ...
    {
        return [['/* testExtendedClass */', 'testFECNClass'], ['/* testNamespacedClass */', 'MolliePrefix\\PHP_CodeSniffer\\Tests\\Core\\File\\testFECNClass'], ['/* testNonExtendedClass */', \false], ['/* testInterface */', \false], ['/* testInterfaceThatExtendsInterface */', 'testFECNInterface'], ['/* testInterfaceThatExtendsFQCNInterface */', 'MolliePrefix\\PHP_CodeSniffer\\Tests\\Core\\File\\testFECNInterface'], ['/* testNestedExtendedClass */', \false], ['/* testNestedExtendedAnonClass */', 'testFECNAnonClass'], ['/* testClassThatExtendsAndImplements */', 'testFECNClass'], ['/* testClassThatImplementsAndExtends */', 'testFECNClass']];
    }
