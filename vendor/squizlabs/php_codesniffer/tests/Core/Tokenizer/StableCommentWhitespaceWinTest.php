...
class StableCommentWhitespaceWinTest extends \MolliePrefix\PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest
{
    /**
    ...
    public function testCommentTokenization($testMarker, $expectedTokens)
    {
        ...
        $comment = $this->getTargetToken($testMarker, \MolliePrefix\PHP_CodeSniffer\Util\Tokens::$commentTokens);
