...
class AnonClassParenthesisOwnerTest extends \MolliePrefix\PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest
{
    /**
    ...
    {
        return [['/* testNoParentheses */'], ['/* testNoParenthesesAndEmptyTokens */']];
    }
