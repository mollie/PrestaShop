...
class AllSniffs
{
    ...
    public static function suite()
    {
        ...
        $suite = new \MolliePrefix\PHPUnit\Framework\TestSuite('PHP CodeSniffer Standards');
        ...
        foreach ($installedStandards as $standard => $details) {
            ...
            foreach ($di as $file) {
                ...
                $className = \MolliePrefix\PHP_CodeSniffer\Autoload::loadFile($file->getPathname());
    ...
    {
        return \MolliePrefix\PHP_CodeSniffer\Util\Standards::getInstalledStandardDetails(\true);
    }
