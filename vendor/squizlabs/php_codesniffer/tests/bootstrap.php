...
if (\class_exists('MolliePrefix\\PHPUnit_Framework_TestSuite') === \true && \class_exists('MolliePrefix\\PHPUnit\\Framework\\TestSuite') === \false) {
    \class_alias('MolliePrefix\\PHPUnit_Framework_TestSuite', 'PHPUnit' . '\\Framework\\TestSuite');
}
if (\class_exists('MolliePrefix\\PHPUnit_Framework_TestCase') === \true && \class_exists('MolliePrefix\\PHPUnit\\Framework\\TestCase') === \false) {
    \class_alias('MolliePrefix\\PHPUnit_Framework_TestCase', 'PHPUnit' . '\\Framework\\TestCase');
}
if (\class_exists('MolliePrefix\\PHPUnit_TextUI_TestRunner') === \true && \class_exists('MolliePrefix\\PHPUnit\\TextUI\\TestRunner') === \false) {
    \class_alias('MolliePrefix\\PHPUnit_TextUI_TestRunner', 'PHPUnit' . '\\TextUI\\TestRunner');
}
