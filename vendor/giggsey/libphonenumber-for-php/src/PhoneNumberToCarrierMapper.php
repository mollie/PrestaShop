...
class PhoneNumberToCarrierMapper
{
     ...
     */
    public function getNameForValidNumber(\MolliePrefix\libphonenumber\PhoneNumber $number, $languageCode)
    {
        $languageStr = \MolliePrefix\Giggsey\Locale\Locale::getPrimaryLanguage($languageCode);
        $scriptStr = '';
        $regionStr = \MolliePrefix\Giggsey\Locale\Locale::getRegion($languageCode);
     ...
     *     invalid
     */
    public function getNameForNumber(\MolliePrefix\libphonenumber\PhoneNumber $number, $languageCode)
    {
     ...
     */
    public function getSafeDisplayName(\MolliePrefix\libphonenumber\PhoneNumber $number, $languageCode)
    {
    ...
    {
        return $numberType === \MolliePrefix\libphonenumber\PhoneNumberType::MOBILE || $numberType === \MolliePrefix\libphonenumber\PhoneNumberType::FIXED_LINE_OR_MOBILE || $numberType === \MolliePrefix\libphonenumber\PhoneNumberType::PAGER;
    }
}
