...
class MultiFileMetadataSourceImpl implements \MolliePrefix\libphonenumber\MetadataSourceInterface
{
    protected static $metaDataFilePrefix = \MolliePrefix\libphonenumber\PhoneNumberUtil::META_DATA_FILE_PREFIX;
    /**
     ...
     */
    public function __construct(\MolliePrefix\libphonenumber\MetadataLoaderInterface $metadataLoader, $currentFilePrefix = null)
    {
    ...
    public function getMetadataForNonGeographicalRegion($countryCallingCode)
    {
        if (!\array_key_exists($countryCallingCode, $this->countryCodeToNonGeographicalMetadataMap)) {
            $this->loadMetadataFromFile($this->currentFilePrefix, \MolliePrefix\libphonenumber\PhoneNumberUtil::REGION_CODE_FOR_NON_GEO_ENTITY, $countryCallingCode, $this->metadataLoader);
        }
     ...
     */
    public function loadMetadataFromFile($filePrefix, $regionCode, $countryCallingCode, \MolliePrefix\libphonenumber\MetadataLoaderInterface $metadataLoader)
    {
