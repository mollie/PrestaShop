...
class PhoneMetadata
{
    ...
    public function setGeneralDesc(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
    ...
    public function setFixedLine(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
    ...
    public function setMobile(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
        $this->mobile = $value;
        return $this;
    }
    ...
    public function setTollFree(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
        $this->tollFree = $value;
        return $this;
    }
    ...
    public function setPremiumRate(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
    ...
    public function setSharedCost(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
    ...
    public function setPersonalNumber(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
    ...
    public function setVoip(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
        $this->voip = $value;
        return $this;
    }
    ...
    public function setPager(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
        $this->pager = $value;
        return $this;
    }
    ...
    public function setUan(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
        $this->uan = $value;
        return $this;
    }
    ...
    public function setEmergency(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
    ...
    public function setVoicemail(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
    ...
    public function setShortCode(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
    ...
    public function setStandardRate(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
    ...
    public function setCarrierSpecific(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
    ...
    public function setSmsServices(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
    ...
    public function setNoInternationalDialling(\MolliePrefix\libphonenumber\PhoneNumberDesc $value)
    {
    ...
    public function fromArray(array $input)
    {
        if (isset($input['generalDesc'])) {
            $desc = new \MolliePrefix\libphonenumber\PhoneNumberDesc();
        ...
        foreach ($input['numberFormat'] as $numberFormatElt) {
            $numberFormat = new \MolliePrefix\libphonenumber\NumberFormat();
    ...
    public function addNumberFormat(\MolliePrefix\libphonenumber\NumberFormat $value)
    {
        $this->numberFormat[] = $value;
        return $this;
    }
    public function addIntlNumberFormat(\MolliePrefix\libphonenumber\NumberFormat $value)
    {
