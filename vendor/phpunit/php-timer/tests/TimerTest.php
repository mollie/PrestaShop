...
class PHP_TimerTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->assertInternalType('float', \MolliePrefix\PHP_Timer::stop());
    }
    /**
    ...
    {
        $this->assertEquals($string, \MolliePrefix\PHP_Timer::secondsToTimeString($seconds));
    }
    /**
    ...
    {
        $this->assertStringMatchesFormat('%f %s', \MolliePrefix\PHP_Timer::timeSinceStartOfRequest());
    }
    /**
