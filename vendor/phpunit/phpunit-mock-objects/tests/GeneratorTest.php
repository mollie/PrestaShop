 ...
 */
class Framework_MockObject_GeneratorTest extends \MolliePrefix\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->generator = new \MolliePrefix\PHPUnit_Framework_MockObject_Generator();
    }
    /**
    ...
    {
        $mock = $this->generator->getMock(\MolliePrefix\InterfaceWithSemiReservedMethodName::class);
        $this->assertTrue(\method_exists($mock, 'unset'));
        $this->assertInstanceOf(\MolliePrefix\InterfaceWithSemiReservedMethodName::class, $mock);
    }
    ...
    {
        $mock = $this->generator->getMockForAbstractClass(\MolliePrefix\AbstractMockTestClass::class);
        $this->assertTrue(\method_exists($mock, 'doSomething'));
    }
    public function testGetMockForAbstractClassWithNonExistentMethods()
    {
        $mock = $this->generator->getMockForAbstractClass(\MolliePrefix\AbstractMockTestClass::class, [], '', \true, \true, \true, ['nonexistentMethod']);
    ...
    {
        return ['className not a string' => [[], ''], 'mockClassName not a string' => [\Countable::class, new \stdClass()]];
    }
    public function testGetMockForTraitWithNonExistentMethodsAndNonAbstractMethods()
    {
        $mock = $this->generator->getMockForTrait(\MolliePrefix\AbstractTrait::class, [], '', \true, \true, \true, ['nonexistentMethod']);
        $this->assertTrue(\method_exists($mock, 'nonexistentMethod'));
        $this->assertTrue(\method_exists($mock, 'doSomething'));
    ...
    {
        $mock = $this->generator->getMockForTrait(\MolliePrefix\AbstractTrait::class);
        $this->assertTrue(\method_exists($mock, 'doSomething'));
    }
    public function testGetMockForSingletonWithReflectionSuccess()
    {
        $mock = $this->generator->getMock(\MolliePrefix\SingletonClass::class, ['doSomething'], [], '', \false);
    ...
    {
        $this->generator->getMock(\stdClass::class, [], [], '', \false, \true, \true, \true, \true);
    }
    /**
     * @requires PHP 7
     */
    ...
    {
        $stub = $this->generator->getMock([\MolliePrefix\AnInterfaceWithReturnType::class, \MolliePrefix\AnInterface::class]);
        $this->assertInstanceOf(\MolliePrefix\AnInterfaceWithReturnType::class, $stub);
        $this->assertInstanceOf(\MolliePrefix\AnInterface::class, $stub);
        $this->assertInstanceOf(\MolliePrefix\PHPUnit_Framework_MockObject_MockObject::class, $stub);
    }
