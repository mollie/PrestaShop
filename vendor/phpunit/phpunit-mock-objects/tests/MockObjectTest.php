 ...
 */
class Framework_MockObjectTest extends \MolliePrefix\PHPUnit_Framework_TestCase
{
    public function testMockedMethodIsNeverCalled()
    {
        $mock = $this->getMockBuilder(\MolliePrefix\AnInterface::class)->getMock();
        $mock->expects($this->never())->method('doSomething');
    }
    public function testMockedMethodIsNeverCalledWithParameter()
    {
        $mock = $this->getMockBuilder(\MolliePrefix\SomeClass::class)->getMock();
    ...
    {
        $mock = $this->getMockBuilder(\MolliePrefix\SomeClass::class)->setMethods(['doSomething'])->getMock();
    ...
    {
        $mock = $this->getMockBuilder(\MolliePrefix\SomeClass::class)->setMethods(['doSomething'])->getMock();
        $mock->expects($this->once())->method('doSomething')->will($this->returnCallback(['MethodCallback', 'staticCallback']));
        $this->assertEquals('pass', $mock->doSomething('foo', 'bar'));
    }
    public function testPublicMethodCallback()
    {
        $mock = $this->getMockBuilder(\MolliePrefix\SomeClass::class)->setMethods(['doSomething'])->getMock();
        $mock->expects($this->once())->method('doSomething')->will($this->returnCallback([new \MolliePrefix\MethodCallback(), 'nonStaticCallback']));
        $this->assertEquals('pass', $mock->doSomething('foo', 'bar'));
    }
    public function testMockClassOnlyGeneratedOnce()
    {
        $mock1 = $this->getMockBuilder(\MolliePrefix\AnInterface::class)->getMock();
        $mock2 = $this->getMockBuilder(\MolliePrefix\AnInterface::class)->getMock();
        $this->assertEquals(\get_class($mock1), \get_class($mock2));
    }
    public function testMockClassDifferentForPartialMocks()
    {
        $mock1 = $this->getMockBuilder(\MolliePrefix\PartialMockTestClass::class)->getMock();
        $mock2 = $this->getMockBuilder(\MolliePrefix\PartialMockTestClass::class)->setMethods(['doSomething'])->getMock();
        $mock3 = $this->getMockBuilder(\MolliePrefix\PartialMockTestClass::class)->setMethods(['doSomething'])->getMock();
        $mock4 = $this->getMockBuilder(\MolliePrefix\PartialMockTestClass::class)->setMethods(['doAnotherThing'])->getMock();
        $mock5 = $this->getMockBuilder(\MolliePrefix\PartialMockTestClass::class)->setMethods(['doAnotherThing'])->getMock();
    ...
    {
        $mock1 = $this->getMockBuilder(\MolliePrefix\PartialMockTestClass::class)->getMock();
        $mock2 = $this->getMockBuilder(\MolliePrefix\PartialMockTestClass::class)->setMockClassName('MyMockClassNameForPartialMockTestClass1')->getMock();
        $mock3 = $this->getMockBuilder(\MolliePrefix\PartialMockTestClass::class)->getMock();
        $mock4 = $this->getMockBuilder(\MolliePrefix\PartialMockTestClass::class)->setMethods(['doSomething'])->setMockClassName('AnotherMockClassNameForPartialMockTestClass')->getMock();
        $mock5 = $this->getMockBuilder(\MolliePrefix\PartialMockTestClass::class)->setMockClassName('MyMockClassNameForPartialMockTestClass2')->getMock();
        $this->assertNotEquals(\get_class($mock1), \get_class($mock2));
    ...
    {
        $mock1 = $this->getMockBuilder(\MolliePrefix\PartialMockTestClass::class)->getMock();
        $mock2 = $this->getMockBuilder(\MolliePrefix\PartialMockTestClass::class)->disableOriginalConstructor()->getMock();
    ...
    {
        $mock1 = $this->getMockBuilder(\MolliePrefix\PartialMockTestClass::class)->getMock();
        $mock2 = $this->getMockBuilder(\MolliePrefix\PartialMockTestClass::class)->disableOriginalClone()->getMock();
        $this->assertNotEquals(\get_class($mock1), \get_class($mock2));
    }
    public function testGetMockForAbstractClass()
    {
        $mock = $this->getMockBuilder(\MolliePrefix\AbstractMockTestClass::class)->getMock();
        $mock->expects($this->never())->method('doSomething');
    }
    /**
    ...
    {
        $mock = $this->getMockBuilder([\MolliePrefix\AnInterface::class, \MolliePrefix\AnotherInterface::class])->getMock();
        $this->assertInstanceOf(\MolliePrefix\AnInterface::class, $mock);
        $this->assertInstanceOf(\MolliePrefix\AnotherInterface::class, $mock);
    }
    public function testGetMockForTrait()
    {
        $mock = $this->getMockForTrait(\MolliePrefix\AbstractTrait::class);
        $mock->expects($this->never())->method('doSomething');
        $parent = \get_parent_class($mock);
        $traits = \class_uses($parent, \false);
        $this->assertContains(\MolliePrefix\AbstractTrait::class, $traits);
    }
    ...
    public function testObjectMethodCallWithArgumentCloningEnabled()
    {
        ...
        $mock = $this->getMockBuilder('SomeClass')->setMethods(['doSomethingElse'])->enableArgumentCloning()->getMock();
        $actualArguments = [];
    ...
    {
        $expectedObject = new \stdClass();
        $mock = $this->getMockBuilder('SomeClass')->setMethods(['doSomethingElse'])->disableArgumentCloning()->getMock();
        $actualArguments = [];
        $mock->expects($this->any())->method('doSomethingElse')->will($this->returnCallback(function () use(&$actualArguments) {
            $actualArguments = \func_get_args();
        }));
    ...
    {
        $mockWithCloning = $this->getMockBuilder('SomeClass')->setMethods(['doSomethingElse'])->enableArgumentCloning()->getMock();
        $mockWithoutCloning = $this->getMockBuilder('SomeClass')->setMethods(['doSomethingElse'])->disableArgumentCloning()->getMock();
    ...
    {
        $mock = $this->getMockBuilder(\MolliePrefix\SomeClass::class)->setMethods(['right', 'wrong'])->getMock();
    ...
    {
        $mock = $this->getMockBuilder(\MolliePrefix\SomeClass::class)->setMethods(['right', 'wrong'])->getMock();
        $mock->expects($this->once())->method('right')->with(['first', 'second']);
        try {
            $mock->right(['second']);
        } catch (\MolliePrefix\PHPUnit_Framework_ExpectationFailedException $e) {
    ...
    {
        $foo = $this->getMockBuilder('MethodCallbackByReference')->setMethods(['bar'])->disableOriginalConstructor()->disableArgumentCloning()->getMock();
        $foo->expects($this->any())->method('bar')->will($this->returnCallback([$foo, 'callback']));
        $a = $b = $c = 0;
        $foo->bar($a, $b, $c);
    ...
    public function testMockArgumentsPassedByReference3()
    {
        ...
        $a = new \stdClass();
        $b = $c = 0;
        $foo->expects($this->any())->method('bar')->with($a, $b, $c)->will($this->returnCallback([$foo, 'callback']));
    ...
    public function testMockArgumentsPassedByReference4()
    {
        ...
        $a = new \stdClass();
        $b = $c = 0;
        $foo->expects($this->any())->method('bar')->with($this->isInstanceOf(\stdClass::class), $b, $c)->will($this->returnCallback([$foo, 'callback']));
        $this->assertNull($foo->bar($a, $b, $c));
    }
    /**
    ...
    {
        $mock = $this->getMockFromWsdl(__DIR__ . '/_fixture/GoogleSearch.wsdl', 'MolliePrefix\\My\\Space\\WsdlMock');
        $this->assertStringStartsWith('Mock_WsdlMock_', \get_class($mock));
    }
    /**
     * @requires extension soap
    ...
    {
        $this->assertInstanceOf(\MolliePrefix\InterfaceWithStaticMethod::class, $this->getMockBuilder(\MolliePrefix\InterfaceWithStaticMethod::class)->getMock());
    }
    /**
    ...
    {
        $mock = $this->getMockBuilder(\MolliePrefix\ClassWithStaticMethod::class)->getMock();
        $mock->staticMethod();
    }
    /**
    ...
    {
        $this->assertInstanceOf(\MolliePrefix\ClassThatImplementsSerializable::class, $this->getMockBuilder(\MolliePrefix\ClassThatImplementsSerializable::class)->disableOriginalConstructor()->getMock());
    }
    public function testGetMockForClassWithSelfTypeHint()
    {
        $this->assertInstanceOf(\MolliePrefix\ClassWithSelfTypeHint::class, $this->getMockBuilder(\MolliePrefix\ClassWithSelfTypeHint::class)->getMock());
    }
    ...
    {
        $mock = $this->getMockBuilder(\MolliePrefix\StringableClass::class)->getMock();
    ...
    {
        return [['Traversable'], ['\\Traversable'], ['TraversableMockTestInterface'], [['Traversable']], [['Iterator', 'Traversable']], [['\\Iterator', '\\Traversable']]];
    }
    public function testParameterCallbackConstraintOnlyEvaluatedOnce()
    {
        $mock = $this->getMockBuilder(\MolliePrefix\Foo::class)->setMethods(['bar'])->getMock();
        $expectedNumberOfCalls = 1;
        $callCount = 0;
        $mock->expects($this->exactly($expectedNumberOfCalls))->method('bar')->with($this->callback(function ($argument) use(&$callCount) {
 ...
 * file that was distributed with this source code.
 */
\class_alias('MolliePrefix\\Framework_MockObjectTest', 'MolliePrefix\\Framework_MockObjectTest', \false);
