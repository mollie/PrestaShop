 ...
 */
class PHPUnit_Framework_MockObject_Stub_Exception implements \MolliePrefix\PHPUnit_Framework_MockObject_Stub
{
    protected $exception;
    public function __construct($exception)
    {
        ...
        if (!$exception instanceof \Throwable && !$exception instanceof \Exception) {
            throw new \MolliePrefix\PHPUnit_Framework_MockObject_RuntimeException('Exception must be an instance of Throwable (PHP 7) or Exception (PHP 5)');
        }
