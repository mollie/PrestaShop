 ...
 */
class PHPUnit_Framework_MockObject_Invocation_Static implements \MolliePrefix\PHPUnit_Framework_MockObject_Invocation, \MolliePrefix\PHPUnit_Framework_SelfDescribing
{
    /**
     * @var array
     */
    protected static $uncloneableExtensions = ['mysqli' => \true, 'SQLite' => \true, 'sqlite3' => \true, 'tidy' => \true, 'xmlwriter' => \true, 'xsl' => \true];
    /**
     * @var array
     */
    protected static $uncloneableClasses = ['Closure', 'COMPersistHelper', 'IteratorIterator', 'RecursiveIteratorIterator', 'SplFileObject', 'PDORow', 'ZipArchive'];
    /**
     * @var string
     */
    public $className;
    ...
    public function generateReturnValue()
    {
        switch ($this->returnType) {
            ...
            default:
                ...
                $generator = new \MolliePrefix\PHPUnit_Framework_MockObject_Generator();
