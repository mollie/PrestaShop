 ...
 */
class PHPUnit_Framework_MockObject_Matcher_Parameters extends \MolliePrefix\PHPUnit_Framework_MockObject_Matcher_StatelessInvocation
{
    /**
    ...
    public function verify()
    {
        ...
        if (\count($this->invocation->parameters) < \count($this->parameters)) {
            ...
            throw new \MolliePrefix\PHPUnit_Framework_ExpectationFailedException(\sprintf($message, $this->invocation->toString()));
        }
