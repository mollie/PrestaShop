...
class Totals
{
    ...
    public function setNumLines($loc, $cloc, $ncloc, $executable, $executed)
    {
        ...
        $this->linesNode->setAttribute('percent', \MolliePrefix\SebastianBergmann\CodeCoverage\Util::percent($executed, $executable, \true));
    }
    public function setNumClasses($count, $tested)
    {
        ...
        $this->classesNode->setAttribute('percent', \MolliePrefix\SebastianBergmann\CodeCoverage\Util::percent($tested, $count, \true));
    }
    public function setNumTraits($count, $tested)
    {
        ...
        $this->traitsNode->setAttribute('percent', \MolliePrefix\SebastianBergmann\CodeCoverage\Util::percent($tested, $count, \true));
    }
    public function setNumMethods($count, $tested)
    {
        ...
        $this->methodsNode->setAttribute('percent', \MolliePrefix\SebastianBergmann\CodeCoverage\Util::percent($tested, $count, \true));
    }
    public function setNumFunctions($count, $tested)
    {
        ...
        $this->functionsNode->setAttribute('percent', \MolliePrefix\SebastianBergmann\CodeCoverage\Util::percent($tested, $count, \true));
    }
}
