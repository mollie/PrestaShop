...
class Crap4j
{
    ...
    {
        if (!\is_int($threshold)) {
            throw \MolliePrefix\SebastianBergmann\CodeCoverage\InvalidArgumentException::create(1, 'integer');
        }
     ...
     * @return string
     */
    public function process(\MolliePrefix\SebastianBergmann\CodeCoverage\CodeCoverage $coverage, $target = null, $name = null)
    {
