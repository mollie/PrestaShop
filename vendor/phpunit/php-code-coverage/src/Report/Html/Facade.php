...
class Facade
{
    ...
    public function process(\MolliePrefix\SebastianBergmann\CodeCoverage\CodeCoverage $coverage, $target)
    {
        ...
        $dashboard = new \MolliePrefix\SebastianBergmann\CodeCoverage\Report\Html\Dashboard($this->templatePath, $this->generator, $date, $this->lowUpperBound, $this->highLowerBound);
        $directory = new \MolliePrefix\SebastianBergmann\CodeCoverage\Report\Html\Directory($this->templatePath, $this->generator, $date, $this->lowUpperBound, $this->highLowerBound);
        $file = new \MolliePrefix\SebastianBergmann\CodeCoverage\Report\Html\File($this->templatePath, $this->generator, $date, $this->lowUpperBound, $this->highLowerBound);
    ...
    private function getDirectory($directory)
    {
        ...
        throw new \MolliePrefix\SebastianBergmann\CodeCoverage\RuntimeException(\sprintf('Directory "%s" does not exist.', $directory));
    }
}
