 ...
 */
class Dashboard extends \MolliePrefix\SebastianBergmann\CodeCoverage\Report\Html\Renderer
{
    /**
    ...
    public function render(\MolliePrefix\SebastianBergmann\CodeCoverage\Node\Directory $node, $file)
    {
        ...
        $template = new \MolliePrefix\Text_Template($this->templatePath . 'dashboard.html', '{{', '}}');
