...
class Builder
{
     ...
     * @return Directory
     */
    public function build(\MolliePrefix\SebastianBergmann\CodeCoverage\CodeCoverage $coverage)
    {
        $files = $coverage->getData();
        $commonPath = $this->reducePaths($files);
        $root = new \MolliePrefix\SebastianBergmann\CodeCoverage\Node\Directory($commonPath, null);
     ...
     */
    private function addItems(\MolliePrefix\SebastianBergmann\CodeCoverage\Node\Directory $root, array $items, array $tests, $cacheTokens)
    {
