...
use MolliePrefix\SebastianBergmann\CodeCoverage\InvalidArgumentException;
/**
 * Represents a file in the code coverage information tree.
 */
class File extends \MolliePrefix\SebastianBergmann\CodeCoverage\Node\AbstractNode
{
    /**
     * @var array
     */
     ...
     */
    public function __construct($name, \MolliePrefix\SebastianBergmann\CodeCoverage\Node\AbstractNode $parent, array $coverageData, array $testData, $cacheTokens)
    {
    ...
    protected function calculateStatistics()
    {
        ...
        if ($this->cacheTokens) {
            $tokens = \MolliePrefix\PHP_Token_Stream_CachingFactory::get($this->getPath());
        } else {
            $tokens = new \MolliePrefix\PHP_Token_Stream($this->getPath());
        }
     ...
     */
    protected function processClasses(\MolliePrefix\PHP_Token_Stream $tokens)
    {
     ...
     * @param \PHP_Token_Stream $tokens
     */
    protected function processTraits(\MolliePrefix\PHP_Token_Stream $tokens)
    {
     ...
     * @param \PHP_Token_Stream $tokens
     */
    protected function processFunctions(\MolliePrefix\PHP_Token_Stream $tokens)
    {
    ...
    {
        return ['methodName' => $methodName, 'visibility' => $method['visibility'], 'signature' => $method['signature'], 'startLine' => $method['startLine'], 'endLine' => $method['endLine'], 'executableLines' => 0, 'executedLines' => 0, 'ccn' => $method['ccn'], 'coverage' => 0, 'crap' => 0, 'link' => $link . $method['startLine']];
    }
}
