 ...
 */
class Directory extends \MolliePrefix\SebastianBergmann\CodeCoverage\Node\AbstractNode implements \IteratorAggregate
{
    /**
     * @var AbstractNode[]
     */
    ...
    {
        return new \RecursiveIteratorIterator(new \MolliePrefix\SebastianBergmann\CodeCoverage\Node\Iterator($this), \RecursiveIteratorIterator::SELF_FIRST);
    }
    /**
    ...
    {
        $file = new \MolliePrefix\SebastianBergmann\CodeCoverage\Node\File($name, $this, $coverageData, $testData, $cacheTokens);
        $this->children[] = $file;
