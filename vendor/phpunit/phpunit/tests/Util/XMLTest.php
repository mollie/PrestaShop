 ...
 */
class Util_XMLTest extends \MolliePrefix\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $e = null;
        $escapedString = \MolliePrefix\PHPUnit_Util_XML::prepareString($char);
    ...
    {
        \MolliePrefix\PHPUnit_Util_XML::load('');
    }
    /**
     * @expectedException PHPUnit_Framework_Exception
    ...
    {
        \MolliePrefix\PHPUnit_Util_XML::load([1, 2, 3]);
    }
    /**
     * @expectedException PHPUnit_Framework_Exception
    ...
    {
        \MolliePrefix\PHPUnit_Util_XML::load(\false);
    }
    public function testNestedXmlToVariable()
    {
        ...
        $actual = \MolliePrefix\PHPUnit_Util_XML::xmlToVariable($dom->documentElement);
