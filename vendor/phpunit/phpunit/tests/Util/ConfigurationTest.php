 ...
 */
class Util_ConfigurationTest extends \MolliePrefix\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->configuration = \MolliePrefix\PHPUnit_Util_Configuration::getInstance(\dirname(__DIR__) . \DIRECTORY_SEPARATOR . '_files' . \DIRECTORY_SEPARATOR . 'configuration.xml');
    }
    /**
    ...
    {
        \MolliePrefix\PHPUnit_Util_Configuration::getInstance('not_existing_file.xml');
    }
    /**
    ...
    public function testShouldReadColorsWhenTrueInConfigurationfile()
    {
        ...
        $configurationInstance = \MolliePrefix\PHPUnit_Util_Configuration::getInstance($configurationFilename);
        $configurationValues = $configurationInstance->getPHPUnitConfiguration();
        $this->assertEquals(\MolliePrefix\PHPUnit_TextUI_ResultPrinter::COLOR_AUTO, $configurationValues['colors']);
    }
    /**
     * @covers PHPUnit_Util_Configuration::getPHPUnitConfiguration
     */
    public function testShouldReadColorsWhenFalseInConfigurationfile()
    {
        ...
        $configurationInstance = \MolliePrefix\PHPUnit_Util_Configuration::getInstance($configurationFilename);
        $configurationValues = $configurationInstance->getPHPUnitConfiguration();
        $this->assertEquals(\MolliePrefix\PHPUnit_TextUI_ResultPrinter::COLOR_NEVER, $configurationValues['colors']);
    }
    /**
     * @covers PHPUnit_Util_Configuration::getPHPUnitConfiguration
     */
    ...
    {
        $this->assertEquals(['whitelist' => ['addUncoveredFilesFromWhitelist' => \true, 'processUncoveredFilesFromWhitelist' => \false, 'include' => ['directory' => [0 => ['path' => '/path/to/files', 'prefix' => '', 'suffix' => '.php', 'group' => 'DEFAULT']], 'file' => [0 => '/path/to/file', 1 => '/path/to/file']], 'exclude' => ['directory' => [0 => ['path' => '/path/to/files', 'prefix' => '', 'suffix' => '.php', 'group' => 'DEFAULT']], 'file' => [0 => '/path/to/file']]]], $this->configuration->getFilterConfiguration());
    }
    /**
    ...
    {
        $this->assertEquals(['include' => [0 => 'name'], 'exclude' => [0 => 'name']], $this->configuration->getGroupConfiguration());
    }
    /**
    ...
    {
        $this->assertEquals(['include' => [0 => 'name'], 'exclude' => [0 => 'name']], $this->configuration->getTestdoxGroupConfiguration());
    }
    /**
    ...
    {
        $this->assertEquals(['lowUpperBound' => '50', 'highLowerBound' => '90', 'coverage-html' => '/tmp/report', 'coverage-clover' => '/tmp/clover.xml', 'json' => '/tmp/logfile.json', 'plain' => '/tmp/logfile.txt', 'tap' => '/tmp/logfile.tap', 'logIncompleteSkipped' => \false, 'junit' => '/tmp/logfile.xml', 'testdox-html' => '/tmp/testdox.html', 'testdox-text' => '/tmp/testdox.txt', 'testdox-xml' => '/tmp/testdox.xml'], $this->configuration->getLoggingConfiguration());
    }
    /**
    ...
    {
        $this->assertEquals(['include_path' => [\dirname(__DIR__) . \DIRECTORY_SEPARATOR . '_files' . \DIRECTORY_SEPARATOR . '.', '/path/to/lib'], 'ini' => ['foo' => 'bar'], 'const' => ['FOO' => \false, 'BAR' => \true], 'var' => ['foo' => \false], 'env' => ['foo' => \true], 'post' => ['foo' => 'bar'], 'get' => ['foo' => 'bar'], 'cookie' => ['foo' => 'bar'], 'server' => ['foo' => 'bar'], 'files' => ['foo' => 'bar'], 'request' => ['foo' => 'bar']], $this->configuration->getPHPConfiguration());
    }
    /**
    ...
    public function testPHPConfigurationIsHandledCorrectly()
    {
        ...
        $this->assertEquals(\true, \BAR);
        $this->assertEquals(\false, $GLOBALS['foo']);
        $this->assertEquals(\true, $_ENV['foo']);
        $this->assertEquals(\true, \getenv('foo'));
    ...
    {
        $this->assertEquals(['backupGlobals' => \true, 'backupStaticAttributes' => \false, 'beStrictAboutChangesToGlobalState' => \false, 'bootstrap' => '/path/to/bootstrap.php', 'cacheTokens' => \false, 'columns' => 80, 'colors' => 'never', 'stderr' => \false, 'convertErrorsToExceptions' => \true, 'convertNoticesToExceptions' => \true, 'convertWarningsToExceptions' => \true, 'forceCoversAnnotation' => \false, 'stopOnFailure' => \false, 'stopOnWarning' => \false, 'reportUselessTests' => \false, 'strictCoverage' => \false, 'disallowTestOutput' => \false, 'enforceTimeLimit' => \false, 'extensionsDirectory' => '/tmp', 'printerClass' => 'PHPUnit_TextUI_ResultPrinter', 'testSuiteLoaderClass' => 'PHPUnit_Runner_StandardTestSuiteLoader', 'verbose' => \false, 'timeoutForSmallTests' => 1, 'timeoutForMediumTests' => 10, 'timeoutForLargeTests' => 60, 'beStrictAboutResourceUsageDuringSmallTests' => \false, 'disallowTodoAnnotatedTests' => \false, 'failOnWarning' => \false, 'failOnRisky' => \false], $this->configuration->getPHPUnitConfiguration());
    }
    /**
     * @covers PHPUnit_Util_Configuration::getInstance
     */
    ...
    {
        $configurationWithXinclude = \MolliePrefix\PHPUnit_Util_Configuration::getInstance(\dirname(__DIR__) . \DIRECTORY_SEPARATOR . '_files' . \DIRECTORY_SEPARATOR . 'configuration_xinclude.xml');
    ...
    {
        $emptyConfiguration = \MolliePrefix\PHPUnit_Util_Configuration::getInstance(\dirname(__DIR__) . \DIRECTORY_SEPARATOR . '_files' . \DIRECTORY_SEPARATOR . 'configuration_empty.xml');
     ...
     */
    protected function assertConfigurationEquals(\MolliePrefix\PHPUnit_Util_Configuration $expectedConfiguration, \MolliePrefix\PHPUnit_Util_Configuration $actualConfiguration)
    {
    ...
    {
        $configuration = \MolliePrefix\PHPUnit_Util_Configuration::getInstance(\dirname(__DIR__) . \DIRECTORY_SEPARATOR . '_files' . \DIRECTORY_SEPARATOR . 'configuration.suites.xml');
    ...
    {
        $configuration = \MolliePrefix\PHPUnit_Util_Configuration::getInstance(\dirname(__DIR__) . \DIRECTORY_SEPARATOR . '_files' . \DIRECTORY_SEPARATOR . 'configuration.one-file-suite.xml');
 ...
 * file that was distributed with this source code.
 */
\class_alias('MolliePrefix\\Util_ConfigurationTest', 'Util_ConfigurationTest', \false);
