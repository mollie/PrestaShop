 ...
 */
class PHPUnit_Util_PHPTest extends \MolliePrefix\PHPUnit_Framework_TestCase
{
    ...
    {
        $phpMock = $this->getMockForAbstractClass('PHPUnit_Util_PHP');
        $phpMock->setUseStderrRedirection(\true);
    ...
    {
        $phpMock = $this->getMockForAbstractClass('PHPUnit_Util_PHP');
        $settings = ['allow_url_fopen=1', 'auto_append_file=', 'display_errors=1'];
