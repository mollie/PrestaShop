 ...
 */
class Issue1335Test extends \MolliePrefix\PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals((object) ['foo' => 'MolliePrefix\\back\\slash'], $GLOBALS['globalObjectWithBackSlashString']);
    }
    public function testGlobalObjectWithDoubleBackSlashString()
    {
        $this->assertEquals((object) ['foo' => 'MolliePrefix\\back\\slash'], $GLOBALS['globalObjectWithDoubleBackSlashString']);
    }
}
/**
 * @runTestsInSeparateProcesses
