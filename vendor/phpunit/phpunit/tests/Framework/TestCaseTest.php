...
$_REQUEST['h'] = 'h';
$GLOBALS['i'] = 'i';
class Framework_TestCaseTest extends \MolliePrefix\PHPUnit_Framework_TestCase
{
    ...
    public function testSuccess()
    {
        ...
        $result = $test->run();
        $this->assertEquals(\MolliePrefix\PHPUnit_Runner_BaseTestRunner::STATUS_PASSED, $test->getStatus());
    ...
    public function testFailure()
    {
        ...
        $result = $test->run();
        $this->assertEquals(\MolliePrefix\PHPUnit_Runner_BaseTestRunner::STATUS_FAILURE, $test->getStatus());
        $this->assertEquals(0, $result->errorCount());
    ...
    public function testError()
    {
        ...
        $result = $test->run();
        $this->assertEquals(\MolliePrefix\PHPUnit_Runner_BaseTestRunner::STATUS_ERROR, $test->getStatus());
    ...
    {
        $test = new \MolliePrefix\TestSkipped();
        $result = $test->run();
        $this->assertEquals(\MolliePrefix\PHPUnit_Runner_BaseTestRunner::STATUS_SKIPPED, $test->getStatus());
    ...
    {
        $test = new \MolliePrefix\TestIncomplete();
        $result = $test->run();
        $this->assertEquals(\MolliePrefix\PHPUnit_Runner_BaseTestRunner::STATUS_INCOMPLETE, $test->getStatus());
    ...
    {
        $test = new \MolliePrefix\ExceptionInSetUpTest('testSomething');
        $result = $test->run();
    ...
    {
        $test = new \MolliePrefix\ExceptionInAssertPreConditionsTest('testSomething');
        $result = $test->run();
        $this->assertTrue($test->setUp);
    ...
    {
        $test = new \MolliePrefix\ExceptionInTest('testSomething');
        $result = $test->run();
        $this->assertTrue($test->setUp);
        $this->assertTrue($test->assertPreConditions);
    ...
    {
        $test = new \MolliePrefix\ExceptionInAssertPostConditionsTest('testSomething');
        $result = $test->run();
        $this->assertTrue($test->setUp);
        $this->assertTrue($test->assertPreConditions);
        $this->assertTrue($test->testSomething);
    ...
    {
        $test = new \MolliePrefix\ExceptionInTearDownTest('testSomething');
        $result = $test->run();
        $this->assertTrue($test->setUp);
        $this->assertTrue($test->assertPreConditions);
        $this->assertTrue($test->testSomething);
    ...
    public function testNoArgTestCasePasses()
    {
        ...
        $t = new \MolliePrefix\PHPUnit_Framework_TestSuite('NoArgTestCaseTest');
        $t->run($result);
        $this->assertCount(1, $result);
        $this->assertEquals(0, $result->failureCount());
        $this->assertEquals(0, $result->errorCount());
    ...
    {
        $test = new \MolliePrefix\WasRun();
        $test->run();
        $this->assertTrue($test->wasRun);
    }
    public function testException()
    {
        $test = new \MolliePrefix\ThrowExceptionTestCase('test');
    ...
    {
        $test = new \MolliePrefix\ThrowNoExceptionTestCase('test');
        $test->expectException(\RuntimeException::class);
        $result = $test->run();
        $this->assertEquals(1, $result->failureCount());
        $this->assertCount(1, $result);
    ...
    {
        $GLOBALS['singleton'] = \MolliePrefix\Singleton::getInstance();
        self::$testStatic = 123;
    }
    /**
    ...
    {
        $this->assertNotSame($GLOBALS['singleton'], \MolliePrefix\Singleton::getInstance());
        $this->assertSame(0, self::$testStatic);
    }
    public function testIsInIsolationReturnsFalse()
    {
        $test = new \MolliePrefix\IsolationTest('testIsInIsolationReturnsFalse');
        $result = $test->run();
        $this->assertCount(1, $result);
        $this->assertTrue($result->wasSuccessful());
    }
    ...
    {
        $test = new \MolliePrefix\IsolationTest('testIsInIsolationReturnsTrue');
    ...
    {
        $test = new \MolliePrefix\OutputTestCase('testExpectOutputStringFooActualFoo');
        $result = $test->run();
        $this->assertCount(1, $result);
        $this->assertTrue($result->wasSuccessful());
    }
    ...
    {
        $test = new \MolliePrefix\OutputTestCase('testExpectOutputStringFooActualBar');
        $result = $test->run();
        $this->assertCount(1, $result);
    ...
    {
        $test = new \MolliePrefix\OutputTestCase('testExpectOutputRegexFooActualFoo');
        $result = $test->run();
        $this->assertCount(1, $result);
        $this->assertTrue($result->wasSuccessful());
    }
    ...
    {
        $test = new \MolliePrefix\OutputTestCase('testExpectOutputRegexFooActualBar');
        $result = $test->run();
        $this->assertCount(1, $result);
        $this->assertFalse($result->wasSuccessful());
    }
    ...
    {
        $test = new \MolliePrefix\RequirementsTest('testAlwaysSkip');
        $result = $test->run();
        $this->assertEquals(1, $result->skippedCount());
    ...
    {
        $test = new \MolliePrefix\RequirementsTest('testAlwaysSkip2');
        $result = $test->run();
        $this->assertEquals(1, $result->skippedCount());
    ...
    {
        $test = new \MolliePrefix\RequirementsTest('testAlwaysSkip3');
        $result = $test->run();
        $this->assertEquals(1, $result->skippedCount());
    ...
    {
        $test = new \MolliePrefix\RequirementsTest('testNine');
        $result = $test->run();
        $this->assertEquals(1, $result->skippedCount());
    ...
    {
        $test = new \MolliePrefix\RequirementsTest('testTen');
        $result = $test->run();
    ...
    {
        $test = new \MolliePrefix\RequirementsTest('testSpecificExtensionVersion');
        $result = $test->run();
    ...
    {
        $test = new \MolliePrefix\RequirementsTest('testAllPossibleRequirements');
        $result = $test->run();
    ...
    {
        $test = new \MolliePrefix\RequirementsTest('testExistingMethod');
        $result = $test->run();
        $this->assertEquals(0, $result->skippedCount());
    }
    public function testRequiringAnExistingFunctionDoesNotSkip()
    {
        $test = new \MolliePrefix\RequirementsTest('testExistingFunction');
        $result = $test->run();
        $this->assertEquals(0, $result->skippedCount());
    }
    public function testRequiringAnExistingExtensionDoesNotSkip()
    {
        $test = new \MolliePrefix\RequirementsTest('testExistingExtension');
        $result = $test->run();
        $this->assertEquals(0, $result->skippedCount());
    }
    public function testRequiringAnExistingOsDoesNotSkip()
    {
        $test = new \MolliePrefix\RequirementsTest('testExistingOs');
        $result = $test->run();
        $this->assertEquals(0, $result->skippedCount());
    }
    ...
    {
        $expectedCwd = \getcwd();
        $test = new \MolliePrefix\ChangeCurrentWorkingDirectoryTest('testSomethingThatChangesTheCwd');
        $test->run();
    ...
    {
        $o = new \MolliePrefix\ClassWithScalarTypeDeclarations();
        $o->foo(null, null);
    }
    public function testCreateMockFromClassName()
    {
        $mock = $this->createMock(\MolliePrefix\Mockable::class);
        $this->assertInstanceOf(\MolliePrefix\Mockable::class, $mock);
        $this->assertInstanceOf(\MolliePrefix\PHPUnit_Framework_MockObject_MockObject::class, $mock);
    }
    ...
    {
        /** @var Mockable $mock */
        $mock = $this->createPartialMock(\MolliePrefix\Mockable::class, ['foo']);
        $this->assertNull($mock->foo());
    ...
    {
        /** @var Mockable $mock */
        $mock = $this->createPartialMock(\MolliePrefix\Mockable::class, []);
    ...
    {
        /** @var Mockable $mock */
        $mock = $this->createConfiguredMock(\MolliePrefix\Mockable::class, ['foo' => \false]);
        $this->assertFalse($mock->foo());
        $this->assertNull($mock->bar());
    }
    public function testProvidingOfAutoreferencedArray()
    {
        $test = new \MolliePrefix\TestAutoreferenced('testJsonEncodeException', $this->getAutoreferencedArray());
        $test->runBare();
    ...
    private function getAutoreferencedArray()
    {
        ...
        return ['RECURSION' => ['data' => $recursionData]];
    }
    public function testProvidingArrayThatMixesObjectsAndScalars()
    {
        $data = [[123], ['foo'], [$this->createMock(\MolliePrefix\Mockable::class)]];
        $test = new \MolliePrefix\TestAutoreferenced('testJsonEncodeException', [$data]);
        $test->runBare();
        $this->assertInternalType('array', $test->myTestData);
