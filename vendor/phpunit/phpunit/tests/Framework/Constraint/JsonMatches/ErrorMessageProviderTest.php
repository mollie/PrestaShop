 ...
 */
class Framework_Constraint_JsonMatches_ErrorMessageProviderTest extends \MolliePrefix\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->assertEquals($expected, \MolliePrefix\PHPUnit_Framework_Constraint_JsonMatches_ErrorMessageProvider::translateTypeToPrefix($type));
    }
    /**
    ...
    {
        $this->assertEquals($expected, \MolliePrefix\PHPUnit_Framework_Constraint_JsonMatches_ErrorMessageProvider::determineJsonError($error, $prefix));
    }
    ...
    {
        return ['expected' => ['Expected value JSON decode error - ', 'expected'], 'actual' => ['Actual value JSON decode error - ', 'actual'], 'default' => ['', '']];
    }
}
/*
 * This file is part of PHPUnit.
 ...
 * file that was distributed with this source code.
 */
\class_alias('MolliePrefix\\Framework_Constraint_JsonMatches_ErrorMessageProviderTest', 'MolliePrefix\\Framework_Constraint_JsonMatches_ErrorMessageProviderTest', \false);
