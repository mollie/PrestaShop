...
class BeforeClassWithOnlyDataProviderTest extends \MolliePrefix\PHPUnit_Framework_TestCase
{
    ...
    {
        self::$setUpBeforeClassWasCalled = \true;
    }
    /**
     * @beforeClass
     */
