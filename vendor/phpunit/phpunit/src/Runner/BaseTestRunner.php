...
abstract class PHPUnit_Runner_BaseTestRunner
{
    ...
    {
        return new \MolliePrefix\PHPUnit_Runner_StandardTestSuiteLoader();
    }
    /**
    ...
    public function getTest($suiteClassName, $suiteClassFile = '', $suffixes = '')
    {
        if (\is_dir($suiteClassName) && !\is_file($suiteClassName . '.php') && empty($suiteClassFile)) {
            ...
            $suite = new \MolliePrefix\PHPUnit_Framework_TestSuite($suiteClassName);
        ...
        try {
            ...
            try {
                $test = new \MolliePrefix\PHPUnit_Framework_TestSuite($testClass);
            } catch (\MolliePrefix\PHPUnit_Framework_Exception $e) {
                $test = new \MolliePrefix\PHPUnit_Framework_TestSuite();
