 ...
 */
use MolliePrefix\SebastianBergmann\Environment\Console;
/**
 * Prints the result of a TextUI TestRunner run.
 */
class PHPUnit_TextUI_ResultPrinter extends \MolliePrefix\PHPUnit_Util_Printer implements \MolliePrefix\PHPUnit_Framework_TestListener
{
    ...
    public function __construct($out = null, $verbose = \false, $colors = self::COLOR_DEFAULT, $debug = \false, $numberOfColumns = 80, $reverse = \false)
    {
        ...
        if (!\is_bool($verbose)) {
            throw \MolliePrefix\PHPUnit_Util_InvalidArgumentHelper::factory(2, 'boolean');
        }
        $availableColors = [self::COLOR_NEVER, self::COLOR_AUTO, self::COLOR_ALWAYS];
        if (!\in_array($colors, $availableColors)) {
            throw \MolliePrefix\PHPUnit_Util_InvalidArgumentHelper::factory(3, \vsprintf('value from "%s", "%s" or "%s"', $availableColors));
        }
        if (!\is_bool($debug)) {
            throw \MolliePrefix\PHPUnit_Util_InvalidArgumentHelper::factory(4, 'boolean');
        }
        if (!\is_int($numberOfColumns) && $numberOfColumns != 'max') {
            throw \MolliePrefix\PHPUnit_Util_InvalidArgumentHelper::factory(5, 'integer or "max"');
        }
        if (!\is_bool($reverse)) {
            throw \MolliePrefix\PHPUnit_Util_InvalidArgumentHelper::factory(6, 'boolean');
        }
        $console = new \MolliePrefix\SebastianBergmann\Environment\Console();
     ...
     * @param int                           $count
     */
    protected function printDefect(\MolliePrefix\PHPUnit_Framework_TestFailure $defect, $count)
    {
     ...
     * @param int                           $count
     */
    protected function printDefectHeader(\MolliePrefix\PHPUnit_Framework_TestFailure $defect, $count)
    {
     ...
     * @param PHPUnit_Framework_TestFailure $defect
     */
    protected function printDefectTrace(\MolliePrefix\PHPUnit_Framework_TestFailure $defect)
    {
     ...
     * @param PHPUnit_Framework_TestResult $result
     */
    protected function printErrors(\MolliePrefix\PHPUnit_Framework_TestResult $result)
    {
     ...
     * @param PHPUnit_Framework_TestResult $result
     */
    protected function printFailures(\MolliePrefix\PHPUnit_Framework_TestResult $result)
    {
     ...
     * @param PHPUnit_Framework_TestResult $result
     */
    protected function printWarnings(\MolliePrefix\PHPUnit_Framework_TestResult $result)
    {
     ...
     * @param PHPUnit_Framework_TestResult $result
     */
    protected function printIncompletes(\MolliePrefix\PHPUnit_Framework_TestResult $result)
    {
     ...
     * @param PHPUnit_Framework_TestResult $result
     */
    protected function printRisky(\MolliePrefix\PHPUnit_Framework_TestResult $result)
    {
     ...
     * @param PHPUnit_Framework_TestResult $result
     */
    protected function printSkipped(\MolliePrefix\PHPUnit_Framework_TestResult $result)
    {
        $this->printDefects($result->skipped(), 'skipped test');
    }
    protected function printHeader()
    {
        $this->write("\n\n" . \MolliePrefix\PHP_Timer::resourceUsage() . "\n\n");
    }
    /**
     * @param PHPUnit_Framework_TestResult $result
     */
    protected function printFooter(\MolliePrefix\PHPUnit_Framework_TestResult $result)
    {
        if (\count($result) === 0) {
    ...
    {
        if ($this->debug) {
            $this->write(\sprintf("\nStarting test '%s'.\n", \MolliePrefix\PHPUnit_Util_Test::describe($test)));
        }
    }
    /**
     * A test ended.
    ...
    public function endTest(\MolliePrefix\PHPUnit_Framework_Test $test, $time)
    {
        ...
        } elseif ($test instanceof \MolliePrefix\PHPUnit_Extensions_PhptTestCase) {
            $this->numAssertions++;
        }
