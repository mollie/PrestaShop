 ...
 */
class PHPUnit_Framework_Constraint_IsType extends \MolliePrefix\PHPUnit_Framework_Constraint
{
    ...
    public function __construct($type)
    {
        ...
        if (!isset($this->types[$type])) {
            throw new \MolliePrefix\PHPUnit_Framework_Exception(\sprintf('Type specified for PHPUnit_Framework_Constraint_IsType <%s> ' . 'is not a valid type.', $type));
        }
        $this->type = $type;
    }
    /**
