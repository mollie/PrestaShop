 ...
 */
abstract class PHPUnit_Util_TestDox_ResultPrinter extends \MolliePrefix\PHPUnit_Util_Printer implements \MolliePrefix\PHPUnit_Framework_TestListener
{
    /**
    ...
    public function addError(\MolliePrefix\PHPUnit_Framework_Test $test, \Exception $e, $time)
    {
        ...
        $this->testStatus = \MolliePrefix\PHPUnit_Runner_BaseTestRunner::STATUS_ERROR;
        $this->failed++;
    }
    /**
     * A warning occurred.
    ...
    public function addWarning(\MolliePrefix\PHPUnit_Framework_Test $test, \MolliePrefix\PHPUnit_Framework_Warning $e, $time)
    {
        ...
        $this->testStatus = \MolliePrefix\PHPUnit_Runner_BaseTestRunner::STATUS_WARNING;
        $this->warned++;
    }
    /**
     * A failure occurred.
    ...
    public function addFailure(\MolliePrefix\PHPUnit_Framework_Test $test, \MolliePrefix\PHPUnit_Framework_AssertionFailedError $e, $time)
    {
        ...
        $this->testStatus = \MolliePrefix\PHPUnit_Runner_BaseTestRunner::STATUS_FAILURE;
        $this->failed++;
    }
    /**
     * Incomplete test.
    ...
    public function addIncompleteTest(\MolliePrefix\PHPUnit_Framework_Test $test, \Exception $e, $time)
    {
        ...
        $this->testStatus = \MolliePrefix\PHPUnit_Runner_BaseTestRunner::STATUS_INCOMPLETE;
        $this->incomplete++;
    }
    /**
     * Risky test.
    ...
    public function addRiskyTest(\MolliePrefix\PHPUnit_Framework_Test $test, \Exception $e, $time)
    {
        ...
        $this->testStatus = \MolliePrefix\PHPUnit_Runner_BaseTestRunner::STATUS_RISKY;
        $this->risky++;
    }
    /**
     * Skipped test.
    ...
    public function addSkippedTest(\MolliePrefix\PHPUnit_Framework_Test $test, \Exception $e, $time)
    {
        ...
        $this->testStatus = \MolliePrefix\PHPUnit_Runner_BaseTestRunner::STATUS_SKIPPED;
        $this->skipped++;
    }
    /**
     * A testsuite started.
    ...
    public function startTest(\MolliePrefix\PHPUnit_Framework_Test $test)
    {
        ...
        if ($this->testClass != $class) {
            ...
            $classAnnotations = \MolliePrefix\PHPUnit_Util_Test::parseTestMethodAnnotations($class);
        ...
        if ($test instanceof \MolliePrefix\PHPUnit_Framework_TestCase && $test->usesDataProvider()) {
            $this->currentTestMethodPrettified .= ' ' . $test->dataDescription();
        }
        $this->testStatus = \MolliePrefix\PHPUnit_Runner_BaseTestRunner::STATUS_PASSED;
    }
    /**
     * A test ended.
     *
    ...
    public function endTest(\MolliePrefix\PHPUnit_Framework_Test $test, $time)
    {
        ...
        if (!isset($this->tests[$this->currentTestMethodPrettified])) {
            if ($this->testStatus == \MolliePrefix\PHPUnit_Runner_BaseTestRunner::STATUS_PASSED) {
     ...
     * @return bool
     */
    private function isOfInterest(\MolliePrefix\PHPUnit_Framework_Test $test)
    {
        if (!$test instanceof \MolliePrefix\PHPUnit_Framework_TestCase) {
            return \false;
        }
        if ($test instanceof \MolliePrefix\PHPUnit_Framework_WarningTestCase) {
            return \false;
        }
