 ...
 */
abstract class AbstractFunctionReferenceFixer extends \MolliePrefix\PhpCsFixer\AbstractFixer
{
    /**
     * {@inheritdoc}
     */
     ...
     */
    protected function find($functionNameToSearch, \MolliePrefix\PhpCsFixer\Tokenizer\Tokens $tokens, $start = 0, $end = null)
    {
        ...
        return [$functionName, $openParenthesis, $tokens->findBlockEnd(\MolliePrefix\PhpCsFixer\Tokenizer\Tokens::BLOCK_TYPE_PARENTHESIS_BRACE, $openParenthesis)];
    }
}
