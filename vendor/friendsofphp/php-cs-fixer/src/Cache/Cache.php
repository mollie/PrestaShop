 ...
 * @internal
 */
final class Cache implements \MolliePrefix\PhpCsFixer\Cache\CacheInterface
{
    /**
     ...
     */
    private $hashes = [];
    public function __construct(\MolliePrefix\PhpCsFixer\Cache\SignatureInterface $signature)
    {
    ...
    public static function fromJson($json)
    {
        ...
        $signature = new \MolliePrefix\PhpCsFixer\Cache\Signature($data['php'], $data['version'], $data['indent'], $data['lineEnding'], $data['rules']);
