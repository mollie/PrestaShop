...
final class ReporterFactory
{
    ...
    public function registerBuiltInReporters()
    {
        ...
        if (null === $builtInReporters) {
            ...
            foreach (\MolliePrefix\Symfony\Component\Finder\Finder::create()->files()->name('*Reporter.php')->in(__DIR__) as $file) {
     ...
     * @return $this
     */
    public function registerReporter(\MolliePrefix\PhpCsFixer\Report\ReporterInterface $reporter)
    {
