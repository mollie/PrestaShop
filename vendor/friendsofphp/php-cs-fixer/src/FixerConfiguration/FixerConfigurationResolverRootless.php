 ...
 */
final class FixerConfigurationResolverRootless implements \MolliePrefix\PhpCsFixer\FixerConfiguration\FixerConfigurationResolverInterface
{
    /**
    ...
    {
        $this->resolver = new \MolliePrefix\PhpCsFixer\FixerConfiguration\FixerConfigurationResolver($options);
        $this->fixerName = $fixerName;
        $names = \array_map(static function (\MolliePrefix\PhpCsFixer\FixerConfiguration\FixerOptionInterface $option) {
