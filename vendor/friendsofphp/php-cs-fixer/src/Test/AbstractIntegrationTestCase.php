...
use MolliePrefix\PhpCsFixer\Tests\Test\AbstractIntegrationTestCase as BaseAbstractIntegrationTestCase;
/**
 * @TODO 3.0 While removing, remove loading `tests/Test` from `autoload` section of `composer.json`.
 *
 * @deprecated since v2.4
 */
abstract class AbstractIntegrationTestCase extends \MolliePrefix\PhpCsFixer\Tests\Test\AbstractIntegrationTestCase
{
