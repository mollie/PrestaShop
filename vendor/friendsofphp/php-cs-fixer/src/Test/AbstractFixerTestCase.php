...
use MolliePrefix\PhpCsFixer\Tests\Test\AbstractFixerTestCase as BaseAbstractFixerTestCase;
/**
 * @TODO 3.0 While removing, remove loading `tests/Test` from `autoload` section of `composer.json`.
 *
 * @deprecated since v2.4
 */
abstract class AbstractFixerTestCase extends \MolliePrefix\PhpCsFixer\Tests\Test\AbstractFixerTestCase
{
