...
class Token
{
    ...
    {
        if (\MolliePrefix\PhpCsFixer\Tokenizer\CT::has($id)) {
            return \MolliePrefix\PhpCsFixer\Tokenizer\CT::getName($id);
        }
        $name = \token_name($id);
    ...
    public static function getKeywords()
    {
        ...
        if (null === $keywords) {
            $keywords = self::getTokenKindsForNames(['T_ABSTRACT', 'T_ARRAY', 'T_AS', 'T_BREAK', 'T_CALLABLE', 'T_CASE', 'T_CATCH', 'T_CLASS', 'T_CLONE', 'T_CONST', 'T_CONTINUE', 'T_DECLARE', 'T_DEFAULT', 'T_DO', 'T_ECHO', 'T_ELSE', 'T_ELSEIF', 'T_EMPTY', 'T_ENDDECLARE', 'T_ENDFOR', 'T_ENDFOREACH', 'T_ENDIF', 'T_ENDSWITCH', 'T_ENDWHILE', 'T_EVAL', 'T_EXIT', 'T_EXTENDS', 'T_FINAL', 'T_FINALLY', 'T_FN', 'T_FOR', 'T_FOREACH', 'T_FUNCTION', 'T_GLOBAL', 'T_GOTO', 'T_HALT_COMPILER', 'T_IF', 'T_IMPLEMENTS', 'T_INCLUDE', 'T_INCLUDE_ONCE', 'T_INSTANCEOF', 'T_INSTEADOF', 'T_INTERFACE', 'T_ISSET', 'T_LIST', 'T_LOGICAL_AND', 'T_LOGICAL_OR', 'T_LOGICAL_XOR', 'T_NAMESPACE', 'T_MATCH', 'T_NEW', 'T_PRINT', 'T_PRIVATE', 'T_PROTECTED', 'T_PUBLIC', 'T_REQUIRE', 'T_REQUIRE_ONCE', 'T_RETURN', 'T_STATIC', 'T_SWITCH', 'T_THROW', 'T_TRAIT', 'T_TRY', 'T_UNSET', 'T_USE', 'T_VAR', 'T_WHILE', 'T_YIELD', 'T_YIELD_FROM']) + [\MolliePrefix\PhpCsFixer\Tokenizer\CT::T_ARRAY_TYPEHINT => \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_ARRAY_TYPEHINT, \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_CLASS_CONSTANT => \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_CLASS_CONSTANT, \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_CONST_IMPORT => \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_CONST_IMPORT, \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_CONSTRUCTOR_PROPERTY_PROMOTION_PRIVATE => \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_CONSTRUCTOR_PROPERTY_PROMOTION_PRIVATE, \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_CONSTRUCTOR_PROPERTY_PROMOTION_PROTECTED => \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_CONSTRUCTOR_PROPERTY_PROMOTION_PROTECTED, \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_CONSTRUCTOR_PROPERTY_PROMOTION_PUBLIC => \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_CONSTRUCTOR_PROPERTY_PROMOTION_PUBLIC, \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_FUNCTION_IMPORT => \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_FUNCTION_IMPORT, \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_NAMESPACE_OPERATOR => \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_NAMESPACE_OPERATOR, \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_USE_LAMBDA => \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_USE_LAMBDA, \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_USE_TRAIT => \MolliePrefix\PhpCsFixer\Tokenizer\CT::T_USE_TRAIT];
        }
        return $keywords;
    }
    /**
    ...
    public function toJson(array $options = null)
    {
        ...
        if (null === $options) {
            if (null === $defaultOptions) {
                $defaultOptions = \MolliePrefix\PhpCsFixer\Utils::calculateBitmask(['JSON_PRETTY_PRINT', 'JSON_NUMERIC_CHECK']);
            }
            $options = $defaultOptions;
        } else {
            $options = \MolliePrefix\PhpCsFixer\Utils::calculateBitmask($options);
        }
