 ...
 * @internal
 */
final class ToolInfo implements \MolliePrefix\PhpCsFixer\ToolInfoInterface
{
    ...
    {
        if ($this->isInstalledByComposer()) {
            return \MolliePrefix\PhpCsFixer\Console\Application::VERSION . ':' . $this->getComposerVersion();
        }
        return \MolliePrefix\PhpCsFixer\Console\Application::VERSION;
    }
