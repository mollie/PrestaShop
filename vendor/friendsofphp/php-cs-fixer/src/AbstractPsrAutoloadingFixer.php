 ...
 * @internal
 */
abstract class AbstractPsrAutoloadingFixer extends \MolliePrefix\PhpCsFixer\AbstractFixer
{
    /**
     * {@inheritdoc}
     */
    ...
    public function supports(\SplFileInfo $file)
    {
        ...
        if (!isset($filenameParts[1]) || 'php' !== $filenameParts[1] || 0 === \MolliePrefix\PhpCsFixer\Preg::match('/^[a-zA-Z_\\x7f-\\xff][a-zA-Z0-9_\\x7f-\\xff]*$/', $filenameParts[0])) {
            return \false;
        }
        try {
            $tokens = \MolliePrefix\PhpCsFixer\Tokenizer\Tokens::fromCode(\sprintf('<?php class %s {}', $filenameParts[0]));
