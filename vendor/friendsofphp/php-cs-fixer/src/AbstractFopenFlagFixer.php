 ...
 * @author SpacePossum
 */
abstract class AbstractFopenFlagFixer extends \MolliePrefix\PhpCsFixer\AbstractFunctionReferenceFixer
{
    /**
     * {@inheritdoc}
     */
    ...
    protected abstract function fixFopenFlagToken(\MolliePrefix\PhpCsFixer\Tokenizer\Tokens $tokens, $argumentStartIndex, $argumentEndIndex);
    /**
     * @param string $mode
     *
     * @return bool
