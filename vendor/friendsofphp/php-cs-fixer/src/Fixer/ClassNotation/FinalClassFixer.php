 ...
 */
final class FinalClassFixer extends \MolliePrefix\PhpCsFixer\AbstractProxyFixer
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return new \MolliePrefix\PhpCsFixer\FixerDefinition\FixerDefinition('All classes must be final, except abstract ones and Doctrine entities.', [new \MolliePrefix\PhpCsFixer\FixerDefinition\CodeSample('<?php
class MyApp {}
