...
abstract class AbstractIncrementOperatorFixer extends \MolliePrefix\PhpCsFixer\AbstractFixer
{
    /**
     * @param int $index
     *
     * @return int
     */
    protected final function findStart(\MolliePrefix\PhpCsFixer\Tokenizer\Tokens $tokens, $index)
    {
        do {
