 ...
 */
final class MbStrFunctionsFixer extends \MolliePrefix\PhpCsFixer\AbstractFunctionReferenceFixer
{
    /**
    ...
    {
        return new \MolliePrefix\PhpCsFixer\FixerDefinition\FixerDefinition('Replace non multibyte-safe functions with corresponding mb function.', [new \MolliePrefix\PhpCsFixer\FixerDefinition\CodeSample('<?php
$a = strlen($a);
$a = strpos($a, $b);
$a = strrpos($a, $b);
$a = substr($a, $b);
