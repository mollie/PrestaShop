...
final class NoAliasFunctionsFixer extends \MolliePrefix\PhpCsFixer\AbstractFixer implements \MolliePrefix\PhpCsFixer\Fixer\ConfigurationDefinitionFixerInterface
{
    ...
    {
        return new \MolliePrefix\PhpCsFixer\FixerDefinition\FixerDefinition('Master functions shall be used instead of aliases.', [new \MolliePrefix\PhpCsFixer\FixerDefinition\CodeSample('<?php
$a = chop($b);
close($b);
$a = doubleval($b);
$a = fputs($b, $c);
