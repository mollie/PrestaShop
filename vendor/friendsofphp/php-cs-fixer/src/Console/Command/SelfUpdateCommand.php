...
use MolliePrefix\PhpCsFixer\Console\SelfUpdate\NewVersionCheckerInterface;
use MolliePrefix\PhpCsFixer\PharCheckerInterface;
 ...
 * @internal
 */
final class SelfUpdateCommand extends \MolliePrefix\Symfony\Component\Console\Command\Command
{
     ...
     */
    private $pharChecker;
    public function __construct(\MolliePrefix\PhpCsFixer\Console\SelfUpdate\NewVersionCheckerInterface $versionChecker, \MolliePrefix\PhpCsFixer\ToolInfoInterface $toolInfo, \MolliePrefix\PhpCsFixer\PharCheckerInterface $pharChecker)
    {
        parent::__construct();
    ...
    {
        $this->setAliases(['selfupdate'])->setDefinition([new \MolliePrefix\Symfony\Component\Console\Input\InputOption('--force', '-f', \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Force update to next major version if available.')])->setDescription('Update php-cs-fixer.phar to the latest stable version.')->setHelp(<<<'EOT'
...
EOT
    ...
    protected function execute(\MolliePrefix\Symfony\Component\Console\Input\InputInterface $input, \MolliePrefix\Symfony\Component\Console\Output\OutputInterface $output)
    {
        ...
        \MolliePrefix\PhpCsFixer\Preg::match('/^v?(?<major>\\d+)\\./', $currentVersion, $matches);
