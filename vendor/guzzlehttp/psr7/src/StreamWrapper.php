...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoper5ea00cc67502b\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoper5ea00cc67502b\Psr\Http\Message\StreamInterface $stream)
    {
