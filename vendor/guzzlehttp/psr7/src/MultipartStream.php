 ...
 */
class MultipartStream implements \_PhpScoper5ece82d7231e4\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \_PhpScoper5ece82d7231e4\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\_PhpScoper5ece82d7231e4\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \_PhpScoper5ece82d7231e4\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
