 ...
 */
class LimitStream implements \_PhpScoper5eddef0da618a\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\_PhpScoper5eddef0da618a\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
