...
use _PhpScoper5ea00cc67502b\GuzzleHttp\Psr7\InflateStream;
...
use function _PhpScoper5ea00cc67502b\GuzzleHttp\debug_resource;
use function _PhpScoper5ea00cc67502b\GuzzleHttp\default_ca_bundle;
use function _PhpScoper5ea00cc67502b\GuzzleHttp\headers_from_lines;
use function _PhpScoper5ea00cc67502b\GuzzleHttp\is_host_in_noproxy;
...
use function _PhpScoper5ea00cc67502b\GuzzleHttp\Psr7\copy_to_stream;
use function _PhpScoper5ea00cc67502b\GuzzleHttp\Psr7\stream_for;
...
class StreamHandler
{
    ...
    private function createSink(StreamInterface $stream, array $options)
    {
        ...
        return is_string($sink) ? new LazyOpenStream($sink, 'w+') : stream_for($sink);
    }
        ...
        if (!empty($options['decode_content'])) {
            ...
            if (isset($normalizedKeys['content-encoding'])) {
                ...
                if ($encoding[0] === 'gzip' || $encoding[0] === 'deflate') {
                    $stream = new InflateStream(stream_for($stream));
    ...
    private function drain(StreamInterface $source, StreamInterface $sink, $contentLength)
    {
        ...
        copy_to_stream($source, $sink, strlen($contentLength) > 0 && (int) $contentLength > 0 ? (int) $contentLength : -1);
        $sink->seek(0);
        $source->close();
        return $sink;
    }
