...
class RetryMiddleware
{
     ...
     * @return mixed
     */
    private function onFulfilled(\_PhpScoper5ece82d7231e4\Psr\Http\Message\RequestInterface $req, array $options)
    {
     ...
     * @return callable
     */
    private function onRejected(\_PhpScoper5ece82d7231e4\Psr\Http\Message\RequestInterface $req, array $options)
    {
     ...
     * @return self
     */
    private function doRetry(\_PhpScoper5ece82d7231e4\Psr\Http\Message\RequestInterface $request, array $options, \_PhpScoper5ece82d7231e4\Psr\Http\Message\ResponseInterface $response = null)
    {
