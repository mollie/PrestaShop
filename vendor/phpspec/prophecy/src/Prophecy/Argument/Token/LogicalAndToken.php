 ...
 */
class LogicalAndToken implements \MolliePrefix\Prophecy\Argument\Token\TokenInterface
{
    ...
    public function __construct(array $arguments)
    {
        foreach ($arguments as $argument) {
            if (!$argument instanceof \MolliePrefix\Prophecy\Argument\Token\TokenInterface) {
                $argument = new \MolliePrefix\Prophecy\Argument\Token\ExactValueToken($argument);
            }
