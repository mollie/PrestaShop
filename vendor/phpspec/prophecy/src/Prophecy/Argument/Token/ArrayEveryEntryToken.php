 ...
 */
class ArrayEveryEntryToken implements \MolliePrefix\Prophecy\Argument\Token\TokenInterface
{
    /**
     * @var TokenInterface
     */
    ...
    {
        if (!$value instanceof \MolliePrefix\Prophecy\Argument\Token\TokenInterface) {
            $value = new \MolliePrefix\Prophecy\Argument\Token\ExactValueToken($value);
        }
        $this->value = $value;
    }
    /**
