 ...
 */
class TraversablePatch implements \MolliePrefix\Prophecy\Doubler\ClassPatch\ClassPatchInterface
{
    /**
    ...
    public function apply(\MolliePrefix\Prophecy\Doubler\Generator\Node\ClassNode $node)
    {
        ...
        $node->addMethod(new \MolliePrefix\Prophecy\Doubler\Generator\Node\MethodNode('current'));
        $node->addMethod(new \MolliePrefix\Prophecy\Doubler\Generator\Node\MethodNode('key'));
        $node->addMethod(new \MolliePrefix\Prophecy\Doubler\Generator\Node\MethodNode('next'));
        $node->addMethod(new \MolliePrefix\Prophecy\Doubler\Generator\Node\MethodNode('rewind'));
        $node->addMethod(new \MolliePrefix\Prophecy\Doubler\Generator\Node\MethodNode('valid'));
    }
    /**
