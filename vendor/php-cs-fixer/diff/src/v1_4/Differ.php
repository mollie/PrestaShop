...
use MolliePrefix\PhpCsFixer\Diff\v1_4\LCS\LongestCommonSubsequence;
use MolliePrefix\PhpCsFixer\Diff\v1_4\LCS\TimeEfficientImplementation;
use MolliePrefix\PhpCsFixer\Diff\v1_4\LCS\MemoryEfficientImplementation;
/**
 * Diff implementation.
 */
class Differ
{
     ...
     * @return string
     */
    public function diff($from, $to, \MolliePrefix\PhpCsFixer\Diff\v1_4\LCS\LongestCommonSubsequence $lcs = null)
    {
     ...
     * @return array
     */
    public function diffToArray($from, $to, \MolliePrefix\PhpCsFixer\Diff\v1_4\LCS\LongestCommonSubsequence $lcs = null)
    {
        if (\is_string($from)) {
    ...
    private function selectLcsImplementation(array $from, array $to)
    {
        ...
        if ($this->calculateEstimatedFootprint($from, $to) > $memoryLimit) {
            return new \MolliePrefix\PhpCsFixer\Diff\v1_4\LCS\MemoryEfficientImplementation();
        }
        return new \MolliePrefix\PhpCsFixer\Diff\v1_4\LCS\TimeEfficientImplementation();
    }
    /**
