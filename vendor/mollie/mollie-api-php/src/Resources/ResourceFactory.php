...
class ResourceFactory
{
     ...
     * @return BaseResource
     */
    public static function createFromApiResult($apiResult, \_PhpScoper5eddef0da618a\Mollie\Api\Resources\BaseResource $resource)
    {
     ...
     * @return mixed
     */
    public static function createBaseResourceCollection(\_PhpScoper5eddef0da618a\Mollie\Api\MollieApiClient $client, $resourceClass, $data, $_links = null, $resourceCollectionClass = null)
    {
