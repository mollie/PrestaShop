...
use MolliePrefix\Mollie\Api\Types\SequenceType;
class Payment extends \MolliePrefix\Mollie\Api\Resources\BaseResource
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    public $status = \MolliePrefix\Mollie\Api\Types\PaymentStatus::STATUS_OPEN;
    /**
    ...
    {
        return $this->status === \MolliePrefix\Mollie\Api\Types\PaymentStatus::STATUS_CANCELED;
    }
    /**
    ...
    {
        return $this->status === \MolliePrefix\Mollie\Api\Types\PaymentStatus::STATUS_EXPIRED;
    }
    /**
    ...
    {
        return $this->status === \MolliePrefix\Mollie\Api\Types\PaymentStatus::STATUS_OPEN;
    }
    /**
    ...
    {
        return $this->status === \MolliePrefix\Mollie\Api\Types\PaymentStatus::STATUS_PENDING;
    }
    /**
    ...
    {
        return $this->status === \MolliePrefix\Mollie\Api\Types\PaymentStatus::STATUS_AUTHORIZED;
    }
    /**
    ...
    {
        return $this->status === \MolliePrefix\Mollie\Api\Types\PaymentStatus::STATUS_FAILED;
    }
    /**
    ...
    {
        return $this->sequenceType === \MolliePrefix\Mollie\Api\Types\SequenceType::SEQUENCETYPE_FIRST;
    }
    /**
    ...
    {
        return $this->sequenceType === \MolliePrefix\Mollie\Api\Types\SequenceType::SEQUENCETYPE_RECURRING;
    }
    /**
    ...
    public function refund($data)
    {
        ...
        $result = $this->client->performHttpCall(\MolliePrefix\Mollie\Api\MollieApiClient::HTTP_POST, $resource, $body);
    ...
    public function update()
    {
        ...
        return \MolliePrefix\Mollie\Api\Resources\ResourceFactory::createFromApiResult($result, new \MolliePrefix\Mollie\Api\Resources\Payment($this->client));
    }
    /**
