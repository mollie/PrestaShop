...
class MandateEndpoint extends \_PhpScoper5ea00cc67502b\Mollie\Api\Endpoints\CollectionEndpointAbstract
{
    ...
    {
        return new \_PhpScoper5ea00cc67502b\Mollie\Api\Resources\MandateCollection($this->client, $count, $_links);
    }
    /**
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function getFor(\_PhpScoper5ea00cc67502b\Mollie\Api\Resources\Customer $customer, $mandateId, array $parameters = [])
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public function revokeFor(\_PhpScoper5ea00cc67502b\Mollie\Api\Resources\Customer $customer, $mandateId, $data = [])
    {
