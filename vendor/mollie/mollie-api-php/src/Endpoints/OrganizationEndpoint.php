...
use _PhpScoper5ece82d7231e4\Mollie\Api\Resources\Organization;
use _PhpScoper5ece82d7231e4\Mollie\Api\Resources\OrganizationCollection;
class OrganizationEndpoint extends \_PhpScoper5ece82d7231e4\Mollie\Api\Endpoints\CollectionEndpointAbstract
{
    ...
    {
        return new \_PhpScoper5ece82d7231e4\Mollie\Api\Resources\OrganizationCollection($this->client, $count, $_links);
    }
    /**
    ...
    public function get($organizationId, array $parameters = [])
    {
        if (empty($organizationId)) {
            throw new \_PhpScoper5ece82d7231e4\Mollie\Api\Exceptions\ApiException("Organization ID is empty.");
        }
