...
class MultiplicationTest extends \_PhpScoper5ea00cc67502b\PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testItMultipliesNumbers($number1, $number2, $expectedResult)
    {
        ...
        $operation = new \_PhpScoper5ea00cc67502b\PrestaShop\Decimal\Operation\Multiplication();
