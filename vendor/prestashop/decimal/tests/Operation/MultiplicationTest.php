...
use _PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Multiplication;
class MultiplicationTest extends \_PhpScoper5eddef0da618a\PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testItMultipliesNumbers($number1, $number2, $expectedResult)
    {
        ...
        $operation = new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Multiplication();
