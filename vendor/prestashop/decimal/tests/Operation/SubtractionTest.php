...
use _PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Subtraction;
class SubtractionTest extends \_PhpScoper5eddef0da618a\PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testItSubtractsNumbers($number1, $number2, $expectedResult)
    {
        ...
        $operation = new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Subtraction();
