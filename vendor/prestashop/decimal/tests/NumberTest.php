 ...
 */
namespace _PhpScoper5eddef0da618a\PrestaShop\Decimal\tests\Unit\Core\Decimal;

use _PhpScoper5eddef0da618a\PrestaShop\Decimal\Number;
use _PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding;
class NumberTest extends \_PhpScoper5eddef0da618a\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $decimalNumber = new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number($number);
    ...
    {
        $decimalNumber = new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number($coefficient, $exponent);
    ...
    {
        new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number($number);
    }
    /**
    ...
    {
        new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number($coefficient, $exponent);
    }
    /**
    ...
    public function testIsAbleToTellIfGreaterThan($number1, $number2, $expected)
    {
        ...
        $number1 = new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number($number1);
        $number2 = new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number($number2);
    ...
    {
        $number = (new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number($number))->toNegative();
    ...
    {
        $number = (new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number($number))->toPositive();
        $this->assertSame((string) $number, $expected);
    }
    ...
    {
        return [
            'truncate 0' => ['1.23456789', 0, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1'],
            'truncate 1' => ['1.23456789', 1, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.2'],
            'truncate 2' => ['1.23456789', 2, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.23'],
            'truncate 3' => ['1.23456789', 3, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.234'],
            'truncate 4' => ['1.23456789', 4, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.2345'],
            'truncate 5' => ['1.23456789', 5, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.23456'],
            'truncate 6' => ['1.23456789', 6, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.234567'],
            'truncate 7' => ['1.23456789', 7, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.2345678'],
            'truncate 8' => ['1.23456789', 8, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.23456789'],
            // does not add trailing zeroes
            'truncate 9' => ['1.23456789', 9, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.23456789'],
            'truncate 10' => ['1.23456789', 10, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.23456789'],
            'truncate zeroes 1' => ['1.00000001', 3, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1'],
            'truncate zeroes 2' => ['1.00000001', 9, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.00000001'],
            'ceil 0' => ['1.23456789', 0, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '2'],
            'ceil 1' => ['1.23456789', 1, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.3'],
            'ceil 2' => ['1.23456789', 2, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.24'],
            'ceil 3' => ['1.23456789', 3, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.235'],
            'ceil 4' => ['1.23456789', 4, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.2346'],
            'ceil 5' => ['1.23456789', 5, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.23457'],
            'ceil 6' => ['1.23456789', 6, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.234568'],
            'ceil 7' => ['1.23456789', 7, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.2345679'],
            'ceil 8' => ['1.23456789', 8, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.23456789'],
            // does not add trailing zeroes
            'ceil 9' => ['1.23456789', 9, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.23456789'],
            'ceil 10' => ['1.23456789', 10, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.23456789'],
            'round half up 0' => ['1.23456789', 0, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1'],
            'round half up 1' => ['1.23456789', 1, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.2'],
            'round half up 2' => ['1.23456789', 2, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.23'],
            'round half up 3' => ['1.23456789', 3, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.235'],
            'round half up 4' => ['1.23456789', 4, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.2346'],
            'round half up 5' => ['1.23456789', 5, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.23457'],
            'round half up 6' => ['1.23456789', 6, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.234568'],
            'round half up 7' => ['1.23456789', 7, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.2345679'],
            'round half up 8' => ['1.23456789', 8, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.23456789'],
            // does not add trailing zeroes
            'round half up 9' => ['1.23456789', 9, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.23456789'],
            'round half up 10' => ['1.23456789', 10, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.23456789'],
        ];
    }
    public function providePrecisionTestCases()
    {
        return [
            ...
            'truncate 9' => ['1.23456789', 9, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.234567890'],
            'truncate 10' => ['1.23456789', 10, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.2345678900'],
            // keeps trailing zeroes
            'truncate zeroes 1' => ['1.00000001', 3, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.000'],
            'truncate zeroes 2' => ['1.00000001', 8, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE, '1.00000001'],
            'ceil 0' => ['1.23456789', 0, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '2'],
            'ceil 1' => ['1.23456789', 1, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.3'],
            'ceil 2' => ['1.23456789', 2, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.24'],
            'ceil 3' => ['1.23456789', 3, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.235'],
            ...
            'ceil 7' => ['1.23456789', 7, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.2345679'],
            'ceil 8' => ['1.23456789', 8, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.23456789'],
            'ceil zeroes' => ['1.00000001', 7, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.0000001'],
            // adds trailing zeroes
            'ceil 9' => ['1.23456789', 9, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.234567890'],
            'ceil 10' => ['1.23456789', 10, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_CEIL, '1.2345678900'],
            'round half up 0' => ['1.23456789', 0, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1'],
            'round half up 1' => ['1.23456789', 1, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.2'],
            'round half up 2' => ['1.23456789', 2, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.23'],
            'round half up 3' => ['1.23456789', 3, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.235'],
            ...
            'round half up 8' => ['1.23456789', 8, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.23456789'],
            // adds trailing zeroes
            'round half up 9' => ['1.23456789', 9, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.234567890'],
            'round half up 10' => ['1.23456789', 10, \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_HALF_UP, '1.2345678900'],
        ];
    }
    public function provideEqualityTestCases()
    {
        return [[new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('0'), new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('0', 5), \true], [new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('0.1234'), new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('1234', 4), \true], [new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('1234.01'), new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('123401', 2), \true], [new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('-0'), new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('0'), \true], [new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('-1234.01'), new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('-123401', 2), \true], [new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('-1234.01'), new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('123401', 2), \false], [new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('1234.01'), new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('-123401', 2), \false], [new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('1234.01'), new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Number('-1234.01'), \false]];
    }
