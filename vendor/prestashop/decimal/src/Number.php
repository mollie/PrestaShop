...
class Number
{
    ...
    public function __construct($number, $exponent = null)
    {
        ...
        if (null === $exponent) {
            $decimalNumber = \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Builder::parseNumber($number);
     ...
     * @return string
     */
    public function toPrecision($precision, $roundingMode = \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE)
    {
        ...
        $return = $this;
        if ($precision < $currentPrecision) {
            $return = (new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding())->compute($this, $precision, $roundingMode);
        }
     ...
     * @return string
     */
    public function round($maxDecimals, $roundingMode = \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding::ROUND_TRUNCATE)
    {
        $currentPrecision = $this->getPrecision();
        if ($maxDecimals < $currentPrecision) {
            return (string) (new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Rounding())->compute($this, $maxDecimals, $roundingMode);
        }
        return (string) $this;
    }
    /**
    ...
    {
        return (new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Addition())->compute($this, $addend);
    }
    /**
    ...
    {
        return (new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Subtraction())->compute($this, $subtrahend);
    }
    /**
    ...
    {
        return (new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Multiplication())->compute($this, $factor);
    }
    /**
     ...
     */
    public function dividedBy(self $divisor, $precision = \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Division::DEFAULT_PRECISION)
    {
        return (new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Division())->compute($this, $divisor, $precision);
    }
    /**
    ...
    {
        return 1 === (new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Comparison())->compare($this, $number);
    }
    /**
    ...
    {
        return 0 <= (new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\Comparison())->compare($this, $number);
    }
    /**
    ...
    {
        return (new \_PhpScoper5eddef0da618a\PrestaShop\Decimal\Operation\MagnitudeChange())->compute($this, $exponent);
    }
    /**
