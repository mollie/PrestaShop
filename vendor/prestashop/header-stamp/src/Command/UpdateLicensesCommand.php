...
class UpdateLicensesCommand extends \MolliePrefix\Symfony\Component\Console\Command\Command
{
    ...
    {
        $this->setName('prestashop:licenses:update')->setDescription('Rewrite your file headers to add the license or to make them up-to-date')->addOption('license', null, \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'License file to apply', \realpath(self::DEFAULT_LICENSE_FILE))->addOption('target', null, \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Folder to work in (default: current dir)')->addOption('exclude', null, \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Comma-separated list of folders and files to exclude from the update', \implode(',', self::DEFAULT_FILTERS))->addOption('extensions', null, \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Comma-separated list of file extensions to update', \implode(',', self::DEFAULT_EXTENSIONS))->addOption('display-report', null, \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Whether or not to display a report')->addOption('dry-run', null, \MolliePrefix\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Dry-run mode does not modify files');
    }
