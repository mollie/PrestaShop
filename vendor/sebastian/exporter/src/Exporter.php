...
class Exporter
{
     ...
     * @return string
     */
    public function shortenedRecursiveExport(&$data, \MolliePrefix\SebastianBergmann\RecursionContext\Context $context = null)
    {
        $result = array();
        $exporter = new self();
        if (!$context) {
            $context = new \MolliePrefix\SebastianBergmann\RecursionContext\Context();
        }
        $array = $data;
        $context->add($data);
