 ...
 */
class ChunkTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    /**
     * @var Chunk
     */
    ...
    {
        $this->chunk = new \MolliePrefix\SebastianBergmann\Diff\Chunk();
    }
    public function testCanBeCreatedWithoutArguments()
    {
        $this->assertInstanceOf('MolliePrefix\\SebastianBergmann\\Diff\\Chunk', $this->chunk);
    }
