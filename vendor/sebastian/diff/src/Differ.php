...
use MolliePrefix\SebastianBergmann\Diff\LCS\LongestCommonSubsequence;
...
class Differ
{
     ...
     * @return string
     */
    public function diff($from, $to, \MolliePrefix\SebastianBergmann\Diff\LCS\LongestCommonSubsequence $lcs = null)
    {
     ...
     * @return array
     */
    public function diffToArray($from, $to, \MolliePrefix\SebastianBergmann\Diff\LCS\LongestCommonSubsequence $lcs = null)
    {
        if (\is_string($from)) {
