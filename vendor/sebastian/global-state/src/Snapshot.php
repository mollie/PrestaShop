...
class Snapshot
{
     ...
     */
    public function __construct(\MolliePrefix\SebastianBergmann\GlobalState\Blacklist $blacklist = null, $includeGlobalVariables = \true, $includeStaticAttributes = \true, $includeConstants = \true, $includeFunctions = \true, $includeClasses = \true, $includeInterfaces = \true, $includeTraits = \true, $includeIniSettings = \true, $includeIncludedFiles = \true)
    {
        if ($blacklist === null) {
    ...
    {
        $this->superGlobalArrays = array('_ENV', '_POST', '_GET', '_COOKIE', '_SERVER', '_FILES', '_REQUEST');
        if (\ini_get('register_long_arrays') == '1') {
            $this->superGlobalArrays = \array_merge($this->superGlobalArrays, array('HTTP_ENV_VARS', 'HTTP_POST_VARS', 'HTTP_GET_VARS', 'HTTP_COOKIE_VARS', 'HTTP_SERVER_VARS', 'HTTP_POST_FILES'));
        }
    }
    /**
