...
class Restorer
{
    ...
    {
        if (!\function_exists('\MolliePrefix\MolliePrefix\\uopz_delete')) {
     ...
     * @param Snapshot $snapshot
     */
    public function restoreGlobalVariables(\MolliePrefix\SebastianBergmann\GlobalState\Snapshot $snapshot)
    {
     ...
     * @param Snapshot $snapshot
     */
    public function restoreStaticAttributes(\MolliePrefix\SebastianBergmann\GlobalState\Snapshot $snapshot)
    {
        $current = new \MolliePrefix\SebastianBergmann\GlobalState\Snapshot($snapshot->blacklist(), \false, \false, \false, \false, \true, \false, \false, \false, \false);
     ...
     */
    private function restoreSuperGlobalArray(\MolliePrefix\SebastianBergmann\GlobalState\Snapshot $snapshot, $superGlobalArray)
    {
