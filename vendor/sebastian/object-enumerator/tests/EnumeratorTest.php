...
use MolliePrefix\SebastianBergmann\ObjectEnumerator\Fixtures\ExceptionThrower;
/**
 * @covers SebastianBergmann\ObjectEnumerator\Enumerator
 */
class EnumeratorTest extends \MolliePrefix\PHPUnit_Framework_TestCase
{
    /**
     * @var Enumerator
     */
    ...
    {
        $this->enumerator = new \MolliePrefix\SebastianBergmann\ObjectEnumerator\Enumerator();
    }
    ...
    {
        $thrower = new \MolliePrefix\SebastianBergmann\ObjectEnumerator\Fixtures\ExceptionThrower();
    ...
    {
        $this->setExpectedException(\MolliePrefix\SebastianBergmann\ObjectEnumerator\InvalidArgumentException::class);
