 ...
 *
 */
class ExceptionComparatorTest extends \MolliePrefix\PHPUnit_Framework_TestCase
{
    private $comparator;
    protected function setUp()
    {
        $this->comparator = new \MolliePrefix\SebastianBergmann\Comparator\ExceptionComparator();
