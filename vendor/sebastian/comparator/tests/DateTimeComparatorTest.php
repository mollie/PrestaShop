 ...
 *
 */
class DateTimeComparatorTest extends \MolliePrefix\PHPUnit_Framework_TestCase
{
    private $comparator;
    protected function setUp()
    {
        $this->comparator = new \MolliePrefix\SebastianBergmann\Comparator\DateTimeComparator();
    }
    ...
    {
        $this->setExpectedException('MolliePrefix\\SebastianBergmann\\Comparator\\ComparisonFailure', 'Failed asserting that two DateTime objects are equal.');
        $this->comparator->assertEquals($expected, $actual, $delta);
    }
    /**
     * @requires PHP 5.5
