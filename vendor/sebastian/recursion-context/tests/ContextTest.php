 ...
 */
class ContextTest extends \MolliePrefix\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->context = new \MolliePrefix\SebastianBergmann\RecursionContext\Context();
    }
    public function failsProvider()
    {
        return array(array(\true), array(\false), array(null), array('string'), array(1), array(1.5), array(\fopen('php://memory', 'r')));
    }
    ...
    {
        $this->setExpectedException('MolliePrefix\\SebastianBergmann\\RecursionContext\\Exception', 'Only arrays and objects are supported');
