...
class ConsumerForkCurlTest extends \MolliePrefix\PHPUnit_Framework_TestCase
{
    private $client;
    function setUp()
    {
        \date_default_timezone_set("UTC");
        $this->client = new \MolliePrefix\Segment_Client("oq0vdlg7yi", array("consumer" => "fork_curl", "debug" => \true));
    }
    function testTrack()
    {
...
\class_alias('MolliePrefix\\ConsumerForkCurlTest', 'ConsumerForkCurlTest', \false);
