...
abstract class Segment_QueueConsumer extends \MolliePrefix\Segment_Consumer
{
    ...
    {
        return array("batch" => $batch, "sentAt" => \date("c"));
    }
    /**
...
\class_alias('MolliePrefix\\Segment_QueueConsumer', 'Segment_QueueConsumer', \false);
