...
class Segment_Client
{
    ...
    private function getDefaultContext()
    {
        ...
        return array("library" => array("name" => "analytics-php", "version" => $SEGMENT_VERSION, "consumer" => $this->consumer->getConsumer()));
    }
}
\class_alias('MolliePrefix\\Segment_Client', 'Segment_Client', \false);
