...
class Raven_Serializer
{
     ...
     * @var int
     */
    protected $message_limit = \MolliePrefix\Raven_Client::MESSAGE_LIMIT;
    /**
    ...
    protected function serializeString($value)
    {
        ...
        if ($this->message_limit !== 0 && \MolliePrefix\Raven_Compat::strlen($value) > $this->message_limit) {
            $value = \MolliePrefix\Raven_Compat::substr($value, 0, $this->message_limit - 10) . ' {clipped}';
        }
        return $value;
    }
    /**
 ...
 * @package raven
 */
\class_alias('MolliePrefix\\Raven_Serializer', 'Raven_Serializer', \false);
