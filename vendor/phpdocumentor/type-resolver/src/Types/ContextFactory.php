...
final class ContextFactory
{
    ...
    public function createFromReflector(\Reflector $reflector)
    {
        ...
        return new \MolliePrefix\phpDocumentor\Reflection\Types\Context($namespace, []);
    }
    /**
    ...
    public function createForNamespace($namespace, $fileContents)
    {
        ...
        return new \MolliePrefix\phpDocumentor\Reflection\Types\Context($namespace, $useStatements);
    }
    /**
