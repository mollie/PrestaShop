 ...
 */
final class Example extends \MolliePrefix\phpDocumentor\Reflection\DocBlock\Tags\BaseTag
{
    /**
    ...
    {
        \MolliePrefix\Webmozart\Assert\Assert::notEmpty($filePath);
        \MolliePrefix\Webmozart\Assert\Assert::integer($startingLine);
        \MolliePrefix\Webmozart\Assert\Assert::greaterThanEq($startingLine, 0);
