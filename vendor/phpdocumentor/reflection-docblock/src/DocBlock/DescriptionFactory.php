...
class DescriptionFactory
{
     ...
     */
    public function __construct(\MolliePrefix\phpDocumentor\Reflection\DocBlock\TagFactory $tagFactory)
    {
     ...
     * @return Description
     */
    public function create($contents, \MolliePrefix\phpDocumentor\Reflection\Types\Context $context = null)
    {
        list($text, $tags) = $this->parse($this->lex($contents), $context);
        return new \MolliePrefix\phpDocumentor\Reflection\DocBlock\Description($text, $tags);
    }
    /**
     ...
     * @return string[]|Tag[]
     */
    private function parse($tokens, \MolliePrefix\phpDocumentor\Reflection\Types\Context $context)
    {
        $count = \count($tokens);
        $tagCount = 0;
        $tags = [];
