...
final class DatabaseTableUninstaller implements UninstallerInterface
{
    ...
    private function getCommands(): array
    {
        ...
        $sql[] = 'DROP TABLE IF EXISTS `' . _DB_PREFIX_ . 'mol_payment_method_translations`;';
        $sql[] = 'DROP TABLE IF EXISTS `' . _DB_PREFIX_ . 'mol_payment_method_restricted_customer_groups`;';
