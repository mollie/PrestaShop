...
class FormBuilder
{
    ...
    protected function getAccountSettingsSection($isApiKeyProvided)
    {
        ...
        // Authentication is now handled in separate AdminMollieAuthentication tab
        // No authentication UI needed in settings
        ...
        // Card-specific settings (Mollie Components, One-Click Payments) moved to
        // AdminMolliePaymentMethodsController - see Credit Card payment method settings

        // Payment methods are now handled by separate AdminMolliePaymentMethods controller
        // with modern React UI - see AdminMolliePaymentMethodsController.php
    ...
    protected function getAdvancedSettingsSection()
    {
        ...
        foreach (
            array_filter($statuses, function ($status) use ($statusOptions) {
