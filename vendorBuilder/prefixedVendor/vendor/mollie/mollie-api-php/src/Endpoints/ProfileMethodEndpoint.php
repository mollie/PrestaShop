...
class ProfileMethodEndpoint extends \MolliePrefix\Mollie\Api\Endpoints\CollectionEndpointAbstract
{
    ...
    public function createForId($profileId, $methodId, array $data = [])
    {
        ...
        return \MolliePrefix\Mollie\Api\Resources\ResourceFactory::createFromApiResult($result, new \MolliePrefix\Mollie\Api\Resources\Method($this->client));
    }
    /**
