...
use MolliePrefix\Mollie\Api\Types\SubscriptionStatus;
class Subscription extends \MolliePrefix\Mollie\Api\Resources\BaseResource
{
    /**
     * @var string
     */
    ...
    public function update()
    {
        ...
        return \MolliePrefix\Mollie\Api\Resources\ResourceFactory::createFromApiResult($result, new \MolliePrefix\Mollie\Api\Resources\Subscription($this->client));
    }
    /**
    ...
    {
        return $this->status === \MolliePrefix\Mollie\Api\Types\SubscriptionStatus::STATUS_ACTIVE;
    }
    /**
    ...
    {
        return $this->status === \MolliePrefix\Mollie\Api\Types\SubscriptionStatus::STATUS_PENDING;
    }
    /**
    ...
    {
        return $this->status === \MolliePrefix\Mollie\Api\Types\SubscriptionStatus::STATUS_CANCELED;
    }
    /**
    ...
    {
        return $this->status === \MolliePrefix\Mollie\Api\Types\SubscriptionStatus::STATUS_SUSPENDED;
    }
    /**
    ...
    {
        return $this->status === \MolliePrefix\Mollie\Api\Types\SubscriptionStatus::STATUS_COMPLETED;
    }
    /**
    ...
    public function payments()
    {
        ...
        return \MolliePrefix\Mollie\Api\Resources\ResourceFactory::createCursorResourceCollection($this->client, $result->_embedded->payments, \MolliePrefix\Mollie\Api\Resources\Payment::class, $result->_links);
    }
}
