 ...
 */
function str(\MolliePrefix\Psr\Http\Message\MessageInterface $message)
{
    return \MolliePrefix\GuzzleHttp\Psr7\Message::toString($message);
}
/**
...
{
    return \MolliePrefix\GuzzleHttp\Psr7\Utils::uriFor($uri);
}
/**
...
{
    return \MolliePrefix\GuzzleHttp\Psr7\Utils::streamFor($resource, $options);
}
/**
...
{
    return \MolliePrefix\GuzzleHttp\Psr7\Header::parse($header);
}
/**
...
{
    return \MolliePrefix\GuzzleHttp\Psr7\Header::normalize($header);
}
/**
 ...
 */
function modify_request(\MolliePrefix\Psr\Http\Message\RequestInterface $request, array $changes)
{
    return \MolliePrefix\GuzzleHttp\Psr7\Utils::modifyRequest($request, $changes);
}
/**
 ...
 */
function rewind_body(\MolliePrefix\Psr\Http\Message\MessageInterface $message)
{
    \MolliePrefix\GuzzleHttp\Psr7\Message::rewindBody($message);
}
/**
...
{
    return \MolliePrefix\GuzzleHttp\Psr7\Utils::tryFopen($filename, $mode);
}
/**
 ...
 */
function copy_to_string(\MolliePrefix\Psr\Http\Message\StreamInterface $stream, $maxLen = -1)
{
    return \MolliePrefix\GuzzleHttp\Psr7\Utils::copyToString($stream, $maxLen);
}
/**
 ...
 */
function copy_to_stream(\MolliePrefix\Psr\Http\Message\StreamInterface $source, \MolliePrefix\Psr\Http\Message\StreamInterface $dest, $maxLen = -1)
{
    return \MolliePrefix\GuzzleHttp\Psr7\Utils::copyToStream($source, $dest, $maxLen);
}
/**
 ...
 */
function hash(\MolliePrefix\Psr\Http\Message\StreamInterface $stream, $algo, $rawOutput = \false)
{
    return \MolliePrefix\GuzzleHttp\Psr7\Utils::hash($stream, $algo, $rawOutput);
}
/**
 ...
 */
function readline(\MolliePrefix\Psr\Http\Message\StreamInterface $stream, $maxLength = null)
{
    return \MolliePrefix\GuzzleHttp\Psr7\Utils::readLine($stream, $maxLength);
}
/**
...
{
    return \MolliePrefix\GuzzleHttp\Psr7\Message::parseRequest($message);
}
/**
...
{
    return \MolliePrefix\GuzzleHttp\Psr7\Message::parseResponse($message);
}
/**
...
{
    return \MolliePrefix\GuzzleHttp\Psr7\Query::parse($str, $urlEncoding);
}
/**
...
{
    return \MolliePrefix\GuzzleHttp\Psr7\Query::build($params, $encoding);
}
/**
...
{
    return \MolliePrefix\GuzzleHttp\Psr7\MimeType::fromFilename($filename);
}
/**
...
{
    return \MolliePrefix\GuzzleHttp\Psr7\MimeType::fromExtension($extension);
}
/**
...
{
    return \MolliePrefix\GuzzleHttp\Psr7\Message::parseMessage($message);
}
/**
...
{
    return \MolliePrefix\GuzzleHttp\Psr7\Message::parseRequestUri($path, $headers);
}
/**
 ...
 */
function get_message_body_summary(\MolliePrefix\Psr\Http\Message\MessageInterface $message, $truncateAt = 120)
{
    return \MolliePrefix\GuzzleHttp\Psr7\Message::bodySummary($message, $truncateAt);
}
/**
...
{
    return \MolliePrefix\GuzzleHttp\Psr7\Utils::caselessRemove($keys, $data);
}
