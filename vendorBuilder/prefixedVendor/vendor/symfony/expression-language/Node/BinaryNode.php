 ...
 * @internal
 */
class BinaryNode extends \MolliePrefix\Symfony\Component\ExpressionLanguage\Node\Node
{
    private static $operators = ['~' => '.', 'and' => '&&', 'or' => '||'];
    private static $functions = ['**' => 'pow', '..' => 'range', 'in' => 'in_array', 'not in' => '!in_array'];
    public function __construct($operator, \MolliePrefix\Symfony\Component\ExpressionLanguage\Node\Node $left, \MolliePrefix\Symfony\Component\ExpressionLanguage\Node\Node $right)
    {
