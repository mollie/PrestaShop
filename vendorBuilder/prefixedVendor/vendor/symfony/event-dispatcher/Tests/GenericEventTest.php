...
use MolliePrefix\Symfony\Component\EventDispatcher\GenericEvent;
/**
 * Test class for Event.
 */
class GenericEventTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    /**
     * @var GenericEvent
     */
    ...
    protected function setUp()
    {
        ...
        $this->event = new \MolliePrefix\Symfony\Component\EventDispatcher\GenericEvent($this->subject, ['name' => 'Event']);
    }
    /**
    ...
    {
        $this->assertEquals($this->event, new \MolliePrefix\Symfony\Component\EventDispatcher\GenericEvent($this->subject, ['name' => 'Event']));
    }
    /**
     * Tests Event->getArgs().
     */
