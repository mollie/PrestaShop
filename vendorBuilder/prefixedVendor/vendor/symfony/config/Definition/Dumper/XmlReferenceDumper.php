...
{
    private $reference;
    public function dump(\MolliePrefix\Symfony\Component\Config\Definition\ConfigurationInterface $configuration, $namespace = null)
    {
        return $this->dumpNode($configuration->getConfigTreeBuilder()->buildTree(), $namespace);
    }
    public function dumpNode(\MolliePrefix\Symfony\Component\Config\Definition\NodeInterface $node, $namespace = null)
    {
        $this->reference = '';
     ...
     */
    private function writeNode(\MolliePrefix\Symfony\Component\Config\Definition\NodeInterface $node, $depth = 0, $root = \false, $namespace = null)
    {
        ...
        if ($node instanceof \MolliePrefix\Symfony\Component\Config\Definition\ArrayNode) {
            ...
            if ($node instanceof \MolliePrefix\Symfony\Component\Config\Definition\PrototypedArrayNode) {
                ...
                if ($prototype instanceof \MolliePrefix\Symfony\Component\Config\Definition\PrototypedArrayNode) {
                    $prototype->setName($key);
                    $children = [$key => $prototype];
                } elseif ($prototype instanceof \MolliePrefix\Symfony\Component\Config\Definition\ArrayNode) {
            ...
            foreach ($children as $child) {
                if (!$child instanceof \MolliePrefix\Symfony\Component\Config\Definition\ArrayNode) {
                    // get attributes
                    // metadata
                    ...
                    if ($child instanceof \MolliePrefix\Symfony\Component\Config\Definition\EnumNode) {
