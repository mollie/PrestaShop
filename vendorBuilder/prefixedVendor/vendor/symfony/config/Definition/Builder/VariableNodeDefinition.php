 ...
 */
class VariableNodeDefinition extends \MolliePrefix\Symfony\Component\Config\Definition\Builder\NodeDefinition
{
    /**
     * Instantiate a Node.
     *
    ...
    {
        return new \MolliePrefix\Symfony\Component\Config\Definition\VariableNode($this->name, $this->parent);
    }
    /**
     * {@inheritdoc}
     */
