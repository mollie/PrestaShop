...
class DirectoryResourceTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    protected $directory;
    ...
    {
        $resource = new \MolliePrefix\Symfony\Component\Config\Resource\DirectoryResource($this->directory);
        $this->assertSame(\realpath($this->directory), $resource->getResource(), '->getResource() returns the path to the resource');
    }
    public function testGetPattern()
    {
        $resource = new \MolliePrefix\Symfony\Component\Config\Resource\DirectoryResource($this->directory, 'bar');
    ...
    public function testResourceDoesNotExist()
    {
        ...
        new \MolliePrefix\Symfony\Component\Config\Resource\DirectoryResource('/____foo/foobar' . \mt_rand(1, 999999));
    }
    ...
    {
        $resource = new \MolliePrefix\Symfony\Component\Config\Resource\DirectoryResource($this->directory, '/.xml$/');
    ...
    {
        $resource = new \MolliePrefix\Symfony\Component\Config\Resource\DirectoryResource($this->directory, '/\\.(foo|xml)$/');
    ...
    {
        $resourceA = new \MolliePrefix\Symfony\Component\Config\Resource\DirectoryResource($this->directory, '/.xml$/');
        $resourceB = new \MolliePrefix\Symfony\Component\Config\Resource\DirectoryResource($this->directory, '/.yaml$/');
