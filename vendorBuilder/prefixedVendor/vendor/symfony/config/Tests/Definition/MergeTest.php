...
class MergeTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    public function testForbiddenOverwrite()
    {
        $this->expectException('MolliePrefix\\Symfony\\Component\\Config\\Definition\\Exception\\ForbiddenOverwriteException');
