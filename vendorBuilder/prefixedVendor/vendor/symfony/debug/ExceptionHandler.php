...
use MolliePrefix\Symfony\Component\HttpKernel\Debug\FileLinkFormatter;
/**
...
class ExceptionHandler
{
    ...
    public static function register($debug = \true, $charset = null, $fileLinkFormat = null)
    {
        ...
        if (\is_array($prev) && $prev[0] instanceof \MolliePrefix\Symfony\Component\Debug\ErrorHandler) {
    ...
    {
        if (null === $this->handler || $exception instanceof \MolliePrefix\Symfony\Component\Debug\Exception\OutOfMemoryException) {
    ...
    {
        if (!$exception instanceof \MolliePrefix\Symfony\Component\Debug\Exception\FlattenException) {
            $exception = \MolliePrefix\Symfony\Component\Debug\Exception\FlattenException::create($exception);
        }
        if (!\headers_sent()) {
     ...
     */
    public function getContent(\MolliePrefix\Symfony\Component\Debug\Exception\FlattenException $exception)
    {
...
EOF;
     ...
     */
    public function getStylesheet(\MolliePrefix\Symfony\Component\Debug\Exception\FlattenException $exception)
    {
        if (!$this->debug) {
            return <<<'EOF'
