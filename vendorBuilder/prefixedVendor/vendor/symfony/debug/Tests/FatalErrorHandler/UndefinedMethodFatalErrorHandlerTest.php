...
class UndefinedMethodFatalErrorHandlerTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $handler = new \MolliePrefix\Symfony\Component\Debug\FatalErrorHandler\UndefinedMethodFatalErrorHandler();
        ...
        $this->assertInstanceOf('MolliePrefix\\Symfony\\Component\\Debug\\Exception\\UndefinedMethodException', $exception);
