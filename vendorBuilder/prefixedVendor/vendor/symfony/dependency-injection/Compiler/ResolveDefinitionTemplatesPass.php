...
\class_exists(\MolliePrefix\Symfony\Component\DependencyInjection\Compiler\ResolveChildDefinitionsPass::class);
if (\false) {
    /**
     ...
     */
    class ResolveDefinitionTemplatesPass extends \MolliePrefix\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
    {
    }
}
