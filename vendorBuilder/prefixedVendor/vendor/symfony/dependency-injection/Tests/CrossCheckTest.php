...
class CrossCheckTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    ...
    public function testCrossCheck($fixture, $type)
    {
        ...
        $container1 = new \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder();
        $loader1 = new $loaderClass($container1, new \MolliePrefix\Symfony\Component\Config\FileLocator());
        $loader1->load($tmp);
        $dumper = new $dumperClass($container1);
        \file_put_contents($tmp, $dumper->dump());
        $container2 = new \MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder();
        $loader2 = new $loaderClass($container2, new \MolliePrefix\Symfony\Component\Config\FileLocator());
        $loader2->load($tmp);
        \unlink($tmp);
        ...
        $r = new \ReflectionProperty(\MolliePrefix\Symfony\Component\DependencyInjection\ContainerBuilder::class, 'normalizedIds');
        $r->setAccessible(\true);
