...
class DefinitionTest extends \MolliePrefix\PHPUnit\Framework\TestCase
{
    public function testConstructor()
    {
        ...
        $def = new \MolliePrefix\Symfony\Component\DependencyInjection\Definition('stdClass', ['foo']);
    ...
    public function testTags()
    {
        ...
        $this->assertEquals(['foo' => [[], ['foo' => 'bar']], 'bar' => [['bar' => 'bar']]], $def->getTags(), '->getTags() returns all tags');
    }
    ...
    {
        $def = new \MolliePrefix\Symfony\Component\DependencyInjection\Definition('stdClass', ['fooarg']);
        $def->setAbstract(\true);
        $def->setAutowired(\true);
