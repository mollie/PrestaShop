...
use MolliePrefix\Symfony\Component\Cache\Adapter\NullAdapter;
use MolliePrefix\Symfony\Component\Cache\Adapter\PhpArrayAdapter;
/**
 * @group time-sensitive
 */
class PhpArrayAdapterTest extends \MolliePrefix\Symfony\Component\Cache\Tests\Adapter\AdapterTestCase
{
    ...
    {
        return new \MolliePrefix\Symfony\Component\Cache\Tests\Adapter\PhpArrayAdapterWrapper(self::$file, new \MolliePrefix\Symfony\Component\Cache\Adapter\NullAdapter());
    }
...
class PhpArrayAdapterWrapper extends \MolliePrefix\Symfony\Component\Cache\Adapter\PhpArrayAdapter
{
    public function save(\MolliePrefix\Psr\Cache\CacheItemInterface $item)
    {
        ...
        }, $this, \MolliePrefix\Symfony\Component\Cache\Adapter\PhpArrayAdapter::class));
        return \true;
    }
}
