...
use MolliePrefix\Cache\IntegrationTests\CachePoolTest;
use MolliePrefix\Psr\Cache\CacheItemPoolInterface;
use MolliePrefix\Symfony\Component\Cache\PruneableInterface;
abstract class AdapterTestCase extends \MolliePrefix\Cache\IntegrationTests\CachePoolTest
{
    protected function setUp()
    {
        ...
        if (!\array_key_exists('testPrune', $this->skippedTests) && !$this->createCachePool() instanceof \MolliePrefix\Symfony\Component\Cache\PruneableInterface) {
    ...
    public function testNotUnserializable()
    {
        ...
        $cache->save($item->set(new \MolliePrefix\Symfony\Component\Cache\Tests\Adapter\NotUnserializable()));
        $item = $cache->getItem('foo');
        $this->assertFalse($item->isHit());
