...
abstract class AbstractRedisAdapterTest extends \MolliePrefix\Symfony\Component\Cache\Tests\Adapter\AdapterTestCase
{
    ...
    {
        return new \MolliePrefix\Symfony\Component\Cache\Adapter\RedisAdapter(self::$redis, \str_replace('\\', '.', __CLASS__), $defaultLifetime);
    }
