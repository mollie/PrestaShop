 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Tests\Core\Tokenizer;

use MolliePrefix\PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest;
class BackfillFnTokenTest extends \MolliePrefix\PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest
{
    /**
    ...
    {
        return [['/* testFunctionName */'], ['/* testConstantDeclaration */', 'FN'], ['/* testConstantDeclarationLower */', 'fn'], ['/* testStaticMethodName */'], ['/* testPropertyAssignment */'], ['/* testAnonClassMethodName */', 'fN'], ['/* testNonArrowStaticMethodCall */'], ['/* testNonArrowConstantAccess */', 'FN'], ['/* testNonArrowConstantAccessMixed */', 'Fn'], ['/* testNonArrowObjectMethodCall */'], ['/* testNonArrowObjectMethodCallUpper */', 'FN'], ['/* testNonArrowNamespacedFunctionCall */', 'Fn'], ['/* testNonArrowNamespaceOperatorFunctionCall */'], ['/* testLiveCoding */']];
    }
