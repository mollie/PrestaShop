...
class Notifysend implements \MolliePrefix\PHP_CodeSniffer\Reports\Report
{
    /**
    ...
    {
        $path = \MolliePrefix\PHP_CodeSniffer\Config::getExecutablePath('notifysend');
        if ($path !== null) {
            $this->path = \escapeshellcmd($path);
        }
        $timeout = \MolliePrefix\PHP_CodeSniffer\Config::getConfigData('notifysend_timeout');
        if ($timeout !== null) {
            $this->timeout = (int) $timeout;
        }
        $showOk = \MolliePrefix\PHP_CodeSniffer\Config::getConfigData('notifysend_showok');
        if ($showOk !== null) {
