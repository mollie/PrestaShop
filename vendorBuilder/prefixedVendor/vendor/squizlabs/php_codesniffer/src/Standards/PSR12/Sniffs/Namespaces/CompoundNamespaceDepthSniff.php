 ...
 */
namespace MolliePrefix\PHP_CodeSniffer\Standards\PSR12\Sniffs\Namespaces;

use MolliePrefix\PHP_CodeSniffer\Files\File;
use MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff;
class CompoundNamespaceDepthSniff implements \MolliePrefix\PHP_CodeSniffer\Sniffs\Sniff
{
    /**
